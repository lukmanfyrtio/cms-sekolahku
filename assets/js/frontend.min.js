/*
 ...
 Date: 2016-08-08
*/
(function(l,f){"object"===typeof module&&"object"===typeof module.exports?module.exports=l.document?f(l,!0):function(l){if(!l.document)throw Error("jQuery requires a window with a document");return f(l)}:f(l)})("undefined"!==typeof window?window:this,function(l,f){function v(a,c){c=c||P;var y=c.createElement("script");y.text=a;c.head.appendChild(y).parentNode.removeChild(y)}function w(a){var c=!!a&&"length"in a&&a.length,y=p.type(a);return"function"===y||p.isWindow(a)?!1:"array"===y||0===c||"number"===
typeof c&&0<c&&c-1 in a}function u(a,c){return a.nodeName&&a.nodeName.toLowerCase()===c.toLowerCase()}function n(a,c,e){if(p.isFunction(c))return p.grep(a,function(a,y){return!!c.call(a,y,a)!==e});if(c.nodeType)return p.grep(a,function(a){return a===c!==e});if("string"!==typeof c)return p.grep(a,function(a){return-1<ya.call(c,a)!==e});if(ub.test(c))return p.filter(c,a,e);c=p.filter(c,a);return p.grep(a,function(a){return-1<ya.call(c,a)!==e&&1===a.nodeType})}function k(a,c){for(;(a=a[c])&&1!==a.nodeType;);
return a}function h(a){var c={};p.each(a.match(da)||[],function(a,y){c[y]=!0});return c}function c(a){return a}function d(a){throw a;}function a(a,c,e,d){var y;try{a&&p.isFunction(y=a.promise)?y.call(a).done(c).fail(e):a&&p.isFunction(y=a.then)?y.call(a,c,e):c.apply(void 0,[a].slice(d))}catch(Wa){e.apply(void 0,[Wa])}}function e(){P.removeEventListener("DOMContentLoaded",e);l.removeEventListener("load",e);p.ready()}function m(){this.expando=p.expando+m.uid++}function x(a,c,e){if(void 0===e&&1===a.nodeType)if(e=
"data-"+c.replace(vb,"-$&").toLowerCase(),e=a.getAttribute(e),"string"===typeof e){try{var y=e;e="true"===y?!0:"false"===y?!1:"null"===y?null:y===+y+""?+y:wb.test(y)?JSON.parse(y):y}catch(mc){}aa.set(a,c,e)}else e=void 0;return e}function q(a,c,e,d){var y=1,h=20,m=d?function(){return d.cur()}:function(){return p.css(a,c,"")},t=m(),x=e&&e[3]||(p.cssNumber[c]?"":"px"),k=(p.cssNumber[c]||"px"!==x&&+t)&&oa.exec(p.css(a,c));if(k&&k[3]!==x){x=x||k[3];e=e||[];k=+t||1;do y=y||".5",k/=y,p.style(a,c,k+x);while(y!==
(y=m()/t)&&1!==y&&--h)}if(e){k=+k||+t||0;var l=e[1]?k+(e[1]+1)*e[2]:+e[2];d&&(d.unit=x,d.start=k,d.end=l)}return l}function z(a,c){for(var y,e,d=[],h=0,m=a.length;h<m;h++)if(e=a[h],e.style)if(y=e.style.display,c){if("none"===y&&(d[h]=O.get(e,"display")||null,d[h]||(e.style.display="")),""===e.style.display&&Ea(e)){y=h;var t=e.ownerDocument;e=e.nodeName;var x=Xa[e];x||(t=t.body.appendChild(t.createElement(e)),x=p.css(t,"display"),t.parentNode.removeChild(t),"none"===x&&(x="block"),Xa[e]=x);t=x;d[y]=
t}}else"none"!==y&&(d[h]="none",O.set(e,"display",y));for(h=0;h<m;h++)null!=d[h]&&(a[h].style.display=d[h]);return a}function t(a,c){var y="undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName(c||"*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll(c||"*"):[];return void 0===c||c&&u(a,c)?p.merge([a],y):y}function A(a,c){for(var y=0,e=a.length;y<e;y++)O.set(a[y],"globalEval",!c||O.get(c[y],"globalEval"))}function K(a,c,e,d,h){for(var y,m,x,k=c.createDocumentFragment(),l=[],
q=0,Z=a.length;q<Z;q++)if((y=a[q])||0===y)if("object"===p.type(y))p.merge(l,y.nodeType?[y]:y);else if(zb.test(y)){m=m||k.appendChild(c.createElement("div"));x=(Ya.exec(y)||["",""])[1].toLowerCase();x=ea[x]||ea._default;m.innerHTML=x[1]+p.htmlPrefilter(y)+x[2];for(x=x[0];x--;)m=m.lastChild;p.merge(l,m.childNodes);m=k.firstChild;m.textContent=""}else l.push(c.createTextNode(y));k.textContent="";for(q=0;y=l[q++];)if(d&&-1<p.inArray(y,d))h&&h.push(y);else if(a=p.contains(y.ownerDocument,y),m=t(k.appendChild(y),
"script"),a&&A(m),e)for(x=0;y=m[x++];)Za.test(y.type||"")&&e.push(y);return k}function N(){return!0}function B(){return!1}function I(){try{return P.activeElement}catch(y){}}function G(a,c,e,d,h,m){var y;if("object"===typeof c){"string"!==typeof e&&(d=d||e,e=void 0);for(y in c)G(a,y,e,d,c[y],m);return a}null==d&&null==h?(h=e,d=e=void 0):null==h&&("string"===typeof e?(h=d,d=void 0):(h=d,d=e,e=void 0));if(!1===h)h=B;else if(!h)return a;if(1===m){var x=h;h=function(a){p().off(a);return x.apply(this,arguments)};
h.guid=x.guid||(x.guid=p.guid++)}return a.each(function(){p.event.add(this,c,h,d,e)})}function E(a,c){return u(a,"table")&&u(11!==c.nodeType?c:c.firstChild,"tr")?p(">tbody",a)[0]||a:a}function F(a){a.type=(null!==a.getAttribute("type"))+"/"+a.type;return a}function C(a){var c=Ab.exec(a.type);c?a.type=c[1]:a.removeAttribute("type");return a}function D(a,c){var e;if(1===c.nodeType){if(O.hasData(a)){var y=O.access(a);var d=O.set(c,y);if(y=y.events)for(h in delete d.handle,d.events={},y)for(d=0,e=y[h].length;d<
e;d++)p.event.add(c,h,y[h][d])}if(aa.hasData(a)){var h=aa.access(a);h=p.extend({},h);aa.set(c,h)}}}function J(a,c,e,d){c=$a.apply([],c);var y,h=0,m=a.length,x=m-1,k=c[0],l=p.isFunction(k);if(l||1<m&&"string"===typeof k&&!R.checkClone&&Bb.test(k))return a.each(function(y){var h=a.eq(y);l&&(c[0]=k.call(this,y,h.html()));J(h,c,e,d)});if(m){var q=K(c,a[0].ownerDocument,!1,a,d);var Z=q.firstChild;1===q.childNodes.length&&(q=Z);if(Z||d){Z=p.map(t(q,"script"),F);for(y=Z.length;h<m;h++){var f=q;h!==x&&(f=
p.clone(f,!0,!0),y&&p.merge(Z,t(f,"script")));e.call(a[h],f,h)}if(y)for(q=Z[Z.length-1].ownerDocument,p.map(Z,C),h=0;h<y;h++)f=Z[h],Za.test(f.type||"")&&!O.access(f,"globalEval")&&p.contains(q,f)&&(f.src?p._evalUrl&&p._evalUrl(f.src):v(f.textContent.replace(Cb,""),q))}}return a}function X(a,c,e){for(var y=c?p.filter(c,a):a,d=0;null!=(c=y[d]);d++)e||1!==c.nodeType||p.cleanData(t(c)),c.parentNode&&(e&&p.contains(c.ownerDocument,c)&&A(t(c,"script")),c.parentNode.removeChild(c));return a}function L(a,
c,e){var y=a.style;if(e=e||Fa(a)){var d=e.getPropertyValue(c)||e[c];""!==d||p.contains(a.ownerDocument,a)||(d=p.style(a,c));if(!R.pixelMarginRight()&&Na.test(d)&&ab.test(c)){a=y.width;c=y.minWidth;var h=y.maxWidth;y.minWidth=y.maxWidth=y.width=d;d=e.width;y.width=a;y.minWidth=c;y.maxWidth=h}}return void 0!==d?d+"":d}function M(a,c){return{get:function(){if(a())delete this.get;else return(this.get=c).apply(this,arguments)}}}function T(a){var c=p.cssProps[a];if(!c){var c=p.cssProps;a:{var e=a;if(!(e in
bb)){for(var y=e[0].toUpperCase()+e.slice(1),d=cb.length;d--;)if(e=cb[d]+y,e in bb)break a;e=void 0}}c=c[a]=e||a}return c}function S(a,c,e){return(a=oa.exec(c))?Math.max(0,a[2]-(e||0))+(a[3]||"px"):c}function Y(a,c,e,d,h){var y=0;for(c=e===(d?"border":"content")?4:"width"===c?1:0;4>c;c+=2)"margin"===e&&(y+=p.css(a,e+pa[c],!0,h)),d?("content"===e&&(y-=p.css(a,"padding"+pa[c],!0,h)),"margin"!==e&&(y-=p.css(a,"border"+pa[c]+"Width",!0,h))):(y+=p.css(a,"padding"+pa[c],!0,h),"padding"!==e&&(y+=p.css(a,
"border"+pa[c]+"Width",!0,h)));return y}function W(a,c,e){var y=Fa(a),d=L(a,c,y),h="border-box"===p.css(a,"boxSizing",!1,y);if(Na.test(d))return d;var m=h&&(R.boxSizingReliable()||d===a.style[c]);d=parseFloat(d)||0;return d+Y(a,c,e||(h?"border":"content"),m,y)+"px"}function U(a,c,e,d,h){return new U.prototype.init(a,c,e,d,h)}function fa(){Ga&&(!1===P.hidden&&l.requestAnimationFrame?l.requestAnimationFrame(fa):l.setTimeout(fa,p.fx.interval),p.fx.tick())}function ca(){l.setTimeout(function(){qa=void 0});
return qa=p.now()}function ga(a,c){var e=0,y={height:a};for(c=c?1:0;4>e;e+=2-c){var d=pa[e];y["margin"+d]=y["padding"+d]=a}c&&(y.opacity=y.width=a);return y}function ra(a,c,e){for(var y,d=(ha.tweeners[c]||[]).concat(ha.tweeners["*"]),h=0,m=d.length;h<m;h++)if(y=d[h].call(e,c,a))return y}function ua(a,c){var e,d;for(e in a){var y=p.camelCase(e);var h=c[y];var m=a[e];Array.isArray(m)&&(h=m[1],m=a[e]=m[0]);e!==y&&(a[y]=m,delete a[e]);if((d=p.cssHooks[y])&&"expand"in d)for(e in m=d.expand(m),delete a[y],
m)e in a||(a[e]=m[e],c[e]=h);else c[y]=h}}function ha(a,c,e){var d,y=0,h=ha.prefilters.length,m=p.Deferred().always(function(){delete x.elem}),x=function(){if(d)return!1;for(var c=qa||ca(),c=Math.max(0,t.startTime+t.duration-c),e=1-(c/t.duration||0),y=0,h=t.tweens.length;y<h;y++)t.tweens[y].run(e);m.notifyWith(a,[t,e,c]);if(1>e&&h)return c;h||m.notifyWith(a,[t,1,0]);m.resolveWith(a,[t]);return!1},t=m.promise({elem:a,props:p.extend({},c),opts:p.extend(!0,{specialEasing:{},easing:p.easing._default},
e),originalProperties:c,originalOptions:e,startTime:qa||ca(),duration:e.duration,tweens:[],createTween:function(c,e){var d=p.Tween(a,t.opts,c,e,t.opts.specialEasing[c]||t.opts.easing);t.tweens.push(d);return d},stop:function(c){var e=0,y=c?t.tweens.length:0;if(d)return this;for(d=!0;e<y;e++)t.tweens[e].run(1);c?(m.notifyWith(a,[t,1,0]),m.resolveWith(a,[t,c])):m.rejectWith(a,[t,c]);return this}});e=t.props;for(ua(e,t.opts.specialEasing);y<h;y++)if(c=ha.prefilters[y].call(t,a,e,t.opts))return p.isFunction(c.stop)&&
(p._queueHooks(t.elem,t.opts.queue).stop=p.proxy(c.stop,c)),c;p.map(e,ra,t);p.isFunction(t.opts.start)&&t.opts.start.call(a,t);t.progress(t.opts.progress).done(t.opts.done,t.opts.complete).fail(t.opts.fail).always(t.opts.always);p.fx.timer(p.extend(x,{elem:a,anim:t,queue:t.opts.queue}));return t}function ba(a){return(a.match(da)||[]).join(" ")}function la(a){return a.getAttribute&&a.getAttribute("class")||""}function Da(a,c,e,d){var y;if(Array.isArray(c))p.each(c,function(c,y){e||Db.test(a)?d(a,y):
Da(a+"["+("object"===typeof y&&null!=y?c:"")+"]",y,e,d)});else if(e||"object"!==p.type(c))d(a,c);else for(y in c)Da(a+"["+y+"]",c[y],e,d)}function Ha(a){return function(c,e){"string"!==typeof c&&(e=c,c="*");var d,y=0,h=c.toLowerCase().match(da)||[];if(p.isFunction(e))for(;d=h[y++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(e)):(a[d]=a[d]||[]).push(e)}}function va(a,c,e,d){function y(t){var x;h[t]=!0;p.each(a[t]||[],function(a,t){var k=t(c,e,d);if("string"===typeof k&&!m&&!h[k])return c.dataTypes.unshift(k),
y(k),!1;if(m)return!(x=k)});return x}var h={},m=a===Oa;return y(c.dataTypes[0])||!h["*"]&&y("*")}function Ba(a,c){var e,d,y=p.ajaxSettings.flatOptions||{};for(e in c)void 0!==c[e]&&((y[e]?a:d||(d={}))[e]=c[e]);d&&p.extend(!0,a,d);return a}var ia=[],P=l.document,Eb=Object.getPrototypeOf,ja=ia.slice,$a=ia.concat,Pa=ia.push,ya=ia.indexOf,Ia={},db=Ia.toString,Ja=Ia.hasOwnProperty,eb=Ja.toString,Fb=eb.call(Object),R={},p=function(a,c){return new p.fn.init(a,c)},Gb=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
Hb=/^-ms-/,Ib=/-([a-z])/g,Jb=function(a,c){return c.toUpperCase()};p.fn=p.prototype={jquery:"3.2.0",constructor:p,length:0,toArray:function(){return ja.call(this)},get:function(a){return null==a?ja.call(this):0>a?this[a+this.length]:this[a]},pushStack:function(a){a=p.merge(this.constructor(),a);a.prevObject=this;return a},each:function(a){return p.each(this,a)},map:function(a){return this.pushStack(p.map(this,function(c,e){return a.call(c,e,c)}))},slice:function(){return this.pushStack(ja.apply(this,
arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var c=this.length;a=+a+(0>a?c:0);return this.pushStack(0<=a&&a<c?[this[a]]:[])},end:function(){return this.prevObject||this.constructor()},push:Pa,sort:ia.sort,splice:ia.splice};p.extend=p.fn.extend=function(){var a,c,e,d=arguments[0]||{},h=1,m=arguments.length,t=!1;"boolean"===typeof d&&(t=d,d=arguments[h]||{},h++);"object"===typeof d||p.isFunction(d)||(d={});h===m&&(d=this,h--);for(;h<m;h++)if(null!=
(a=arguments[h]))for(c in a){var x=d[c];var k=a[c];d!==k&&(t&&k&&(p.isPlainObject(k)||(e=Array.isArray(k)))?(e?(e=!1,x=x&&Array.isArray(x)?x:[]):x=x&&p.isPlainObject(x)?x:{},d[c]=p.extend(t,x,k)):void 0!==k&&(d[c]=k))}return d};p.extend({expando:"jQuery"+("3.2.0"+Math.random()).replace(/\D/g,""),isReady:!0,error:function(a){throw Error(a);},noop:function(){},isFunction:function(a){return"function"===p.type(a)},isWindow:function(a){return null!=a&&a===a.window},isNumeric:function(a){var c=p.type(a);
return("number"===c||"string"===c)&&!isNaN(a-parseFloat(a))},isPlainObject:function(a){if(!a||"[object Object]"!==db.call(a))return!1;a=Eb(a);if(!a)return!0;a=Ja.call(a,"constructor")&&a.constructor;return"function"===typeof a&&eb.call(a)===Fb},isEmptyObject:function(a){for(var c in a)return!1;return!0},type:function(a){return null==a?a+"":"object"===typeof a||"function"===typeof a?Ia[db.call(a)]||"object":typeof a},globalEval:function(a){v(a)},camelCase:function(a){return a.replace(Hb,"ms-").replace(Ib,
Jb)},each:function(a,c){var e,d=0;if(w(a))for(e=a.length;d<e&&!1!==c.call(a[d],d,a[d]);d++);else for(d in a)if(!1===c.call(a[d],d,a[d]))break;return a},trim:function(a){return null==a?"":(a+"").replace(Gb,"")},makeArray:function(a,c){var e=c||[];null!=a&&(w(Object(a))?p.merge(e,"string"===typeof a?[a]:a):Pa.call(e,a));return e},inArray:function(a,c,e){return null==c?-1:ya.call(c,a,e)},merge:function(a,c){for(var e=+c.length,d=0,h=a.length;d<e;d++)a[h++]=c[d];a.length=h;return a},grep:function(a,c,
e){for(var d=[],h=0,y=a.length,m=!e;h<y;h++)e=!c(a[h],h),e!==m&&d.push(a[h]);return d},map:function(a,c,e){var d,h=0,y=[];if(w(a))for(d=a.length;h<d;h++){var m=c(a[h],h,e);null!=m&&y.push(m)}else for(h in a)m=c(a[h],h,e),null!=m&&y.push(m);return $a.apply([],y)},guid:1,proxy:function(a,c){if("string"===typeof c){var e=a[c];c=a;a=e}if(p.isFunction(a)){var d=ja.call(arguments,2);e=function(){return a.apply(c||this,d.concat(ja.call(arguments)))};e.guid=a.guid=a.guid||p.guid++;return e}},now:Date.now,
support:R});"function"===typeof Symbol&&(p.fn[Symbol.iterator]=ia[Symbol.iterator]);p.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,c){Ia["[object "+c+"]"]=c.toLowerCase()});var ma=function(a){function c(a,c,e,d){var h,m,y,t,x=c&&c.ownerDocument,k=c?c.nodeType:9;e=e||[];if("string"!==typeof a||!a||1!==k&&9!==k&&11!==k)return e;if(!d&&((c?c.ownerDocument||c:T)!==M&&za(c),c=c||M,C)){if(11!==k&&(t=pa.exec(a)))if(h=t[1])if(9===k)if(m=c.getElementById(h)){if(m.id===
h)return e.push(m),e}else return e;else{if(x&&(m=x.getElementById(h))&&G(c,m)&&m.id===h)return e.push(m),e}else{if(t[2])return ba.apply(e,c.getElementsByTagName(a)),e;if((h=t[3])&&V.getElementsByClassName&&c.getElementsByClassName)return ba.apply(e,c.getElementsByClassName(h)),e}if(!(!V.qsa||Y[a+" "]||D&&D.test(a))){if(1!==k){x=c;var q=a}else if("object"!==c.nodeName.toLowerCase()){(y=c.getAttribute("id"))?y=y.replace(ma,qa):c.setAttribute("id",y=J);m=na(a);for(h=m.length;h--;)m[h]="#"+y+" "+A(m[h]);
q=m.join(",");x=ja.test(a)&&l(c.parentNode)||c}if(q)try{return ba.apply(e,x.querySelectorAll(q)),e}catch(qc){}finally{y===J&&c.removeAttribute("id")}}}return Aa(a.replace(ga,"$1"),c,e,d)}function e(){function a(e,d){c.push(e+" ")>Q.cacheLength&&delete a[c.shift()];return a[e+" "]=d}var c=[];return a}function d(a){a[J]=!0;return a}function h(a){var c=M.createElement("fieldset");try{return!!a(c)}catch(oc){return!1}finally{c.parentNode&&c.parentNode.removeChild(c)}}function m(a,c){for(var e=a.split("|"),
d=e.length;d--;)Q.attrHandle[e[d]]=c}function y(a,c){var e=c&&a,d=e&&1===a.nodeType&&1===c.nodeType&&a.sourceIndex-c.sourceIndex;if(d)return d;if(e)for(;e=e.nextSibling;)if(e===c)return-1;return a?1:-1}function t(a){return function(c){return"input"===c.nodeName.toLowerCase()&&c.type===a}}function x(a){return function(c){var e=c.nodeName.toLowerCase();return("input"===e||"button"===e)&&c.type===a}}function k(a){return function(c){return"form"in c?c.parentNode&&!1===c.disabled?"label"in c?"label"in
c.parentNode?c.parentNode.disabled===a:c.disabled===a:c.isDisabled===a||c.isDisabled!==!a&&wa(c)===a:c.disabled===a:"label"in c?c.disabled===a:!1}}function q(a){return d(function(c){c=+c;return d(function(e,d){for(var h,m=a([],e.length,c),y=m.length;y--;)e[h=m[y]]&&(e[h]=!(d[h]=e[h]))})})}function l(a){return a&&"undefined"!==typeof a.getElementsByTagName&&a}function f(){}function A(a){for(var c=0,e=a.length,d="";c<e;c++)d+=a[c].value;return d}function z(a,c,e){var d=c.dir,h=c.next,m=h||d,y=e&&"parentNode"===
m,t=X++;return c.first?function(c,e,h){for(;c=c[d];)if(1===c.nodeType||y)return a(c,e,h);return!1}:function(c,e,x){var k,q=[S,t];if(x)for(;c=c[d];){if((1===c.nodeType||y)&&a(c,e,x))return!0}else for(;c=c[d];)if(1===c.nodeType||y){var l=c[J]||(c[J]={});l=l[c.uniqueID]||(l[c.uniqueID]={});if(h&&h===c.nodeName.toLowerCase())c=c[d]||c;else{if((k=l[m])&&k[0]===S&&k[1]===t)return q[2]=k[2];l[m]=q;if(q[2]=a(c,e,x))return!0}}return!1}}function n(a){return 1<a.length?function(c,e,d){for(var h=a.length;h--;)if(!a[h](c,
e,d))return!1;return!0}:a[0]}function u(a,c,e,d,h){for(var m,y=[],t=0,x=a.length,k=null!=c;t<x;t++)if(m=a[t])if(!e||e(m,d,h))y.push(m),k&&c.push(t);return y}function p(a,e,h,m,y,t){m&&!m[J]&&(m=p(m));y&&!y[J]&&(y=p(y,t));return d(function(d,t,x,k){var q,l=[],f=[],A=t.length,z;if(!(z=d)){z=e||"*";for(var n=x.nodeType?[x]:x,Z=[],p=0,Ca=n.length;p<Ca;p++)c(z,n[p],Z);z=Z}z=!a||!d&&e?z:u(z,l,a,x,k);n=h?y||(d?a:A||m)?[]:t:z;h&&h(z,n,x,k);if(m){var K=u(n,f);m(K,[],x,k);for(x=K.length;x--;)if(q=K[x])n[f[x]]=
!(z[f[x]]=q)}if(d){if(y||a){if(y){K=[];for(x=n.length;x--;)(q=n[x])&&K.push(z[x]=q);y(null,n=[],K,k)}for(x=n.length;x--;)(q=n[x])&&-1<(K=y?ca(d,q):l[x])&&(d[K]=!(t[K]=q))}}else n=u(n===t?n.splice(A,n.length):n),y?y(null,t,n,k):ba.apply(t,n)})}function K(a){var c,e,d=a.length,h=Q.relative[a[0].type];var m=h||Q.relative[" "];for(var y=h?1:0,t=z(function(a){return a===c},m,!0),x=z(function(a){return-1<ca(c,a)},m,!0),k=[function(a,e,d){a=!h&&(d||e!==F)||((c=e).nodeType?t(a,e,d):x(a,e,d));c=null;return a}];y<
d;y++)if(m=Q.relative[a[y].type])k=[z(n(k),m)];else{m=Q.filter[a[y].type].apply(null,a[y].matches);if(m[J]){for(e=++y;e<d&&!Q.relative[a[e].type];e++);return p(1<y&&n(k),1<y&&A(a.slice(0,y-1).concat({value:" "===a[y-2].type?"*":""})).replace(ga,"$1"),m,y<e&&K(a.slice(y,e)),e<d&&K(a=a.slice(e)),e<d&&A(a))}k.push(m)}return n(k)}function w(a,e){var h=0<e.length,m=0<a.length,y=function(d,y,t,x,k){var q,l,f=0,A="0",n=d&&[],z=[],Z=F,p=d||m&&Q.find.TAG("*",k),Ca=S+=null==Z?1:Math.random()||.1,K=p.length;
for(k&&(F=y===M||y||k);A!==K&&null!=(q=p[A]);A++){if(m&&q){var Ma=0;y||q.ownerDocument===M||(za(q),t=!C);for(;l=a[Ma++];)if(l(q,y||M,t)){x.push(q);break}k&&(S=Ca)}h&&((q=!l&&q)&&f--,d&&n.push(q))}f+=A;if(h&&A!==f){for(Ma=0;l=e[Ma++];)l(n,z,y,t);if(d){if(0<f)for(;A--;)n[A]||z[A]||(z[A]=P.call(x));z=u(z)}ba.apply(x,z);k&&!d&&0<z.length&&1<f+e.length&&c.uniqueSort(x)}k&&(S=Ca,F=Z);return n};return h?d(y):y}var L,F,v,N,M,B,C,D,I,E,G,J="sizzle"+1*new Date,T=a.document,S=0,X=0,ha=e(),U=e(),Y=e(),W=function(a,
c){a===c&&(N=!0);return 0},O={}.hasOwnProperty,fa=[],P=fa.pop,R=fa.push,ba=fa.push,la=fa.slice,ca=function(a,c){for(var e=0,d=a.length;e<d;e++)if(a[e]===c)return e;return-1},aa=RegExp("[\\x20\\t\\r\\n\\f]+","g"),ga=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),da=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,ea=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,ra=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),ua=/:((?:\\.|[\w-]|[^\x00-\xa0])+)(?:\((('((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)")|((?:\\.|[^\\()[\]]|\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\])*)|.*)\)|)/,
...
/^[^{]+\{\s*\[native \w/,pa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ja=/[+~]/,sa=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),ta=function(a,c,e){a="0x"+c-65536;return a!==a||e?c:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},ma=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,qa=function(a,c){return c?"\x00"===a?"\ufffd":a.slice(0,-1)+"\\"+a.charCodeAt(a.length-1).toString(16)+" ":"\\"+a},Ba=function(){za()},wa=z(function(a){return!0===
a.disabled&&("form"in a||"label"in a)},{dir:"parentNode",next:"legend"});try{ba.apply(fa=la.call(T.childNodes),T.childNodes),fa[T.childNodes.length].nodeType}catch(nc){ba={apply:fa.length?function(a,c){R.apply(a,la.call(c))}:function(a,c){for(var e=a.length,d=0;a[e++]=c[d++];);a.length=e-1}}}var V=c.support={};var ya=c.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};var za=c.setDocument=function(a){var c;a=a?a.ownerDocument||a:T;if(a===M||9!==a.nodeType||
!a.documentElement)return M;M=a;B=M.documentElement;C=!ya(M);T!==M&&(c=M.defaultView)&&c.top!==c&&(c.addEventListener?c.addEventListener("unload",Ba,!1):c.attachEvent&&c.attachEvent("onunload",Ba));V.attributes=h(function(a){a.className="i";return!a.getAttribute("className")});V.getElementsByTagName=h(function(a){a.appendChild(M.createComment(""));return!a.getElementsByTagName("*").length});V.getElementsByClassName=va.test(M.getElementsByClassName);V.getById=h(function(a){B.appendChild(a).id=J;return!M.getElementsByName||
!M.getElementsByName(J).length});V.getById?(Q.filter.ID=function(a){var c=a.replace(sa,ta);return function(a){return a.getAttribute("id")===c}},Q.find.ID=function(a,c){if("undefined"!==typeof c.getElementById&&C){var e=c.getElementById(a);return e?[e]:[]}}):(Q.filter.ID=function(a){var c=a.replace(sa,ta);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===c}},Q.find.ID=function(a,c){if("undefined"!==typeof c.getElementById&&C){var e,d,h=c.getElementById(a);
if(h){if((e=h.getAttributeNode("id"))&&e.value===a)return[h];var m=c.getElementsByName(a);for(d=0;h=m[d++];)if((e=h.getAttributeNode("id"))&&e.value===a)return[h]}return[]}});Q.find.TAG=V.getElementsByTagName?function(a,c){if("undefined"!==typeof c.getElementsByTagName)return c.getElementsByTagName(a);if(V.qsa)return c.querySelectorAll(a)}:function(a,c){var e,d=[],h=0,m=c.getElementsByTagName(a);if("*"===a){for(;e=m[h++];)1===e.nodeType&&d.push(e);return d}return m};Q.find.CLASS=V.getElementsByClassName&&
function(a,c){if("undefined"!==typeof c.getElementsByClassName&&C)return c.getElementsByClassName(a)};I=[];D=[];if(V.qsa=va.test(M.querySelectorAll))h(function(a){B.appendChild(a).innerHTML="<a id='"+J+"'></a><select id='"+J+"-\r\\' msallowcapture=''><option selected=''></option></select>";a.querySelectorAll("[msallowcapture^='']").length&&D.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||D.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
a.querySelectorAll("[id~="+J+"-]").length||D.push("~=");a.querySelectorAll(":checked").length||D.push(":checked");a.querySelectorAll("a#"+J+"+*").length||D.push(".#.+[+~]")}),h(function(a){a.innerHTML="<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";var c=M.createElement("input");c.setAttribute("type","hidden");a.appendChild(c).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&D.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");2!==a.querySelectorAll(":enabled").length&&
D.push(":enabled",":disabled");B.appendChild(a).disabled=!0;2!==a.querySelectorAll(":disabled").length&&D.push(":enabled",":disabled");a.querySelectorAll("*,:x");D.push(",.*:")});(V.matchesSelector=va.test(E=B.matches||B.webkitMatchesSelector||B.mozMatchesSelector||B.oMatchesSelector||B.msMatchesSelector))&&h(function(a){V.disconnectedMatch=E.call(a,"*");E.call(a,"[s!='']:x");I.push("!=",":((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")});
D=D.length&&new RegExp(D.join("|"));I=I.length&&new RegExp(I.join("|"));G=(c=va.test(B.compareDocumentPosition))||va.test(B.contains)?function(a,c){var e=9===a.nodeType?a.documentElement:a,d=c&&c.parentNode;return a===d||!!(d&&1===d.nodeType&&(e.contains?e.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&16))}:function(a,c){if(c)for(;c=c.parentNode;)if(c===a)return!0;return!1};W=c?function(a,c){if(a===c)return N=!0,0;var e=!a.compareDocumentPosition-!c.compareDocumentPosition;if(e)return e;
e=(a.ownerDocument||a)===(c.ownerDocument||c)?a.compareDocumentPosition(c):1;return e&1||!V.sortDetached&&c.compareDocumentPosition(a)===e?a===M||a.ownerDocument===T&&G(T,a)?-1:c===M||c.ownerDocument===T&&G(T,c)?1:v?ca(v,a)-ca(v,c):0:e&4?-1:1}:function(a,c){if(a===c)return N=!0,0;var e=0;var d=a.parentNode;var h=c.parentNode,m=[a],t=[c];if(!d||!h)return a===M?-1:c===M?1:d?-1:h?1:v?ca(v,a)-ca(v,c):0;if(d===h)return y(a,c);for(d=a;d=d.parentNode;)m.unshift(d);for(d=c;d=d.parentNode;)t.unshift(d);for(;m[e]===
t[e];)e++;return e?y(m[e],t[e]):m[e]===T?-1:t[e]===T?1:0};return M};c.matches=function(a,e){return c(a,null,null,e)};c.matchesSelector=function(a,e){(a.ownerDocument||a)!==M&&za(a);e=e.replace(ra,"='$1']");if(!(!V.matchesSelector||!C||Y[e+" "]||I&&I.test(e)||D&&D.test(e)))try{var d=E.call(a,e);if(d||V.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(pc){}return 0<c(e,M,null,[a]).length};c.contains=function(a,c){(a.ownerDocument||a)!==M&&za(a);return G(a,c)};c.attr=function(a,
c){(a.ownerDocument||a)!==M&&za(a);var e=Q.attrHandle[c.toLowerCase()],e=e&&O.call(Q.attrHandle,c.toLowerCase())?e(a,c,!C):void 0;return void 0!==e?e:V.attributes||!C?a.getAttribute(c):(e=a.getAttributeNode(c))&&e.specified?e.value:null};c.escape=function(a){return(a+"").replace(ma,qa)};c.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};c.uniqueSort=function(a){var c,e=[],d=0,h=0;N=!V.detectDuplicates;v=!V.sortStable&&a.slice(0);a.sort(W);if(N){for(;c=a[h++];)c===a[h]&&
(d=e.push(h));for(;d--;)a.splice(e[d],1)}v=null;return a};var oa=c.getText=function(a){var c="",e=0;var d=a.nodeType;if(!d)for(;d=a[e++];)c+=oa(d);else if(1===d||9===d||11===d){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=oa(a)}else if(3===d||4===d)return a.nodeValue;return c};var Q=c.selectors={cacheLength:50,createPseudo:d,match:ia,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",
first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){a[1]=a[1].replace(sa,ta);a[3]=(a[3]||a[4]||a[5]||"").replace(sa,ta);"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1].slice(0,3)?(a[3]||c.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&c.error(a[0]);return a},PSEUDO:function(a){var c,e=!a[6]&&a[2];if(ia.CHILD.test(a[0]))return null;a[3]?a[2]=a[4]||a[5]||"":e&&
ua.test(e)&&(c=na(e,!0))&&(c=e.indexOf(")",e.length-c)-e.length)&&(a[0]=a[0].slice(0,c),a[2]=e.slice(0,c));return a.slice(0,3)}},filter:{TAG:function(a){var c=a.replace(sa,ta).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===c}},CLASS:function(a){var c=ha[a+" "];return c||(c=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"),ha(a,function(a){return c.test("string"===typeof a.className&&a.className||"undefined"!==typeof a.getAttribute&&
a.getAttribute("class")||"")}))},ATTR:function(a,e,d){return function(h){h=c.attr(h,a);if(null==h)return"!="===e;if(!e)return!0;h+="";return"="===e?h===d:"!="===e?h!==d:"^="===e?d&&0===h.indexOf(d):"*="===e?d&&-1<h.indexOf(d):"$="===e?d&&h.slice(-d.length)===d:"~="===e?-1<(" "+h.replace(aa," ")+" ").indexOf(d):"|="===e?h===d||h.slice(0,d.length+1)===d+"-":!1}},CHILD:function(a,c,e,d,h){var m="nth"!==a.slice(0,3),y="last"!==a.slice(-4),t="of-type"===c;return 1===d&&0===h?function(a){return!!a.parentNode}:
function(c,e,x){var k,q;e=m!==y?"nextSibling":"previousSibling";var l=c.parentNode,f=t&&c.nodeName.toLowerCase();x=!x&&!t;var A=!1;if(l){if(m){for(;e;){for(k=c;k=k[e];)if(t?k.nodeName.toLowerCase()===f:1===k.nodeType)return!1;var z=e="only"===a&&!z&&"nextSibling"}return!0}z=[y?l.firstChild:l.lastChild];if(y&&x){k=l;var n=k[J]||(k[J]={});n=n[k.uniqueID]||(n[k.uniqueID]={});A=n[a]||[];A=(q=A[0]===S&&A[1])&&A[2];for(k=q&&l.childNodes[q];k=++q&&k&&k[e]||(A=q=0)||z.pop();)if(1===k.nodeType&&++A&&k===c){n[a]=
[S,q,A];break}}else if(x&&(k=c,n=k[J]||(k[J]={}),n=n[k.uniqueID]||(n[k.uniqueID]={}),A=n[a]||[],A=q=A[0]===S&&A[1]),!1===A)for(;(k=++q&&k&&k[e]||(A=q=0)||z.pop())&&((t?k.nodeName.toLowerCase()!==f:1!==k.nodeType)||!++A||(x&&(n=k[J]||(k[J]={}),n=n[k.uniqueID]||(n[k.uniqueID]={}),n[a]=[S,A]),k!==c)););A-=h;return A===d||0===A%d&&0<=A/d}}},PSEUDO:function(a,e){var h=Q.pseudos[a]||Q.setFilters[a.toLowerCase()]||c.error("unsupported pseudo: "+a);if(h[J])return h(e);if(1<h.length){var m=[a,a,"",e];return Q.setFilters.hasOwnProperty(a.toLowerCase())?
d(function(a,c){for(var d,m=h(a,e),y=m.length;y--;)d=ca(a,m[y]),a[d]=!(c[d]=m[y])}):function(a){return h(a,0,m)}}return h}},pseudos:{not:d(function(a){var c=[],e=[],h=xa(a.replace(ga,"$1"));return h[J]?d(function(a,c,e,d){d=h(a,null,d,[]);for(var m=a.length;m--;)if(e=d[m])a[m]=!(c[m]=e)}):function(a,d,m){c[0]=a;h(c,null,m,e);c[0]=null;return!e.pop()}}),has:d(function(a){return function(e){return 0<c(a,e).length}}),contains:d(function(a){a=a.replace(sa,ta);return function(c){return-1<(c.textContent||
c.innerText||oa(c)).indexOf(a)}}),lang:d(function(a){Da.test(a||"")||c.error("unsupported lang: "+a);a=a.replace(sa,ta).toLowerCase();return function(c){var e;do if(e=C?c.lang:c.getAttribute("xml:lang")||c.getAttribute("lang"))return e=e.toLowerCase(),e===a||0===e.indexOf(a+"-");while((c=c.parentNode)&&1===c.nodeType);return!1}}),target:function(c){var e=a.location&&a.location.hash;return e&&e.slice(1)===c.id},root:function(a){return a===B},focus:function(a){return a===M.activeElement&&(!M.hasFocus||
M.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:k(!1),disabled:k(!0),checked:function(a){var c=a.nodeName.toLowerCase();return"input"===c&&!!a.checked||"option"===c&&!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!Q.pseudos.empty(a)},header:function(a){return ka.test(a.nodeName)},input:function(a){return Ha.test(a.nodeName)},
...
0>e?e+c:e;0<=--c;)a.push(c);return a}),gt:q(function(a,c,e){for(e=0>e?e+c:e;++e<c;)a.push(e);return a})}};Q.pseudos.nth=Q.pseudos.eq;for(L in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})Q.pseudos[L]=t(L);for(L in{submit:!0,reset:!0})Q.pseudos[L]=x(L);f.prototype=Q.filters=Q.pseudos;Q.setFilters=new f;var na=c.tokenize=function(a,e){var d,h,m,y,t;if(y=U[a+" "])return e?0:y.slice(0);y=a;var k=[];for(t=Q.preFilter;y;){if(!x||(d=da.exec(y)))d&&(y=y.slice(d[0].length)||y),k.push(h=[]);var x=!1;
if(d=ea.exec(y))x=d.shift(),h.push({value:x,type:d[0].replace(ga," ")}),y=y.slice(x.length);for(m in Q.filter)!(d=ia[m].exec(y))||t[m]&&!(d=t[m](d))||(x=d.shift(),h.push({value:x,type:m,matches:d}),y=y.slice(x.length));if(!x)break}return e?y.length:y?c.error(a):U(a,k).slice(0)};var xa=c.compile=function(a,c){var e,d=[],h=[],m=Y[a+" "];if(!m){c||(c=na(a));for(e=c.length;e--;)m=K(c[e]),m[J]?d.push(m):h.push(m);m=Y(a,w(h,d));m.selector=a}return m};var Aa=c.select=function(a,c,e,d){var h,m,y,t="function"===
typeof a&&a,x=!d&&na(a=t.selector||a);e=e||[];if(1===x.length){var k=x[0]=x[0].slice(0);if(2<k.length&&"ID"===(m=k[0]).type&&9===c.nodeType&&C&&Q.relative[k[1].type]){c=(Q.find.ID(m.matches[0].replace(sa,ta),c)||[])[0];if(!c)return e;t&&(c=c.parentNode);a=a.slice(k.shift().value.length)}for(h=ia.needsContext.test(a)?0:k.length;h--;){m=k[h];if(Q.relative[y=m.type])break;if(y=Q.find[y])if(d=y(m.matches[0].replace(sa,ta),ja.test(k[0].type)&&l(c.parentNode)||c)){k.splice(h,1);a=d.length&&A(k);if(!a)return ba.apply(e,
d),e;break}}}(t||xa(a,x))(d,c,!C,e,!c||ja.test(a)&&l(c.parentNode)||c);return e};V.sortStable=J.split("").sort(W).join("")===J;V.detectDuplicates=!!N;za();V.sortDetached=h(function(a){return a.compareDocumentPosition(M.createElement("fieldset"))&1});h(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||m("type|href|height|width",function(a,c,e){if(!e)return a.getAttribute(c,"type"===c.toLowerCase()?1:2)});V.attributes&&h(function(a){a.innerHTML="<input/>";a.firstChild.setAttribute("value",
"");return""===a.firstChild.getAttribute("value")})||m("value",function(a,c,e){if(!e&&"input"===a.nodeName.toLowerCase())return a.defaultValue});h(function(a){return null==a.getAttribute("disabled")})||m("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(a,c,e){var d;if(!e)return!0===a[c]?c.toLowerCase():(d=a.getAttributeNode(c))&&d.specified?d.value:null});return c}(l);p.find=ma;p.expr=ma.selectors;p.expr[":"]=p.expr.pseudos;
p.uniqueSort=p.unique=ma.uniqueSort;p.text=ma.getText;p.isXMLDoc=ma.isXML;p.contains=ma.contains;p.escapeSelector=ma.escape;var wa=function(a,c,e){for(var d=[],h=void 0!==e;(a=a[c])&&9!==a.nodeType;)if(1===a.nodeType){if(h&&p(a).is(e))break;d.push(a)}return d},gb=function(a,c){for(var e=[];a;a=a.nextSibling)1===a.nodeType&&a!==c&&e.push(a);return e},hb=p.expr.match.needsContext,ib=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,ub=/^.[^:#\[\.,]*$/;p.filter=function(a,c,e){var d=
...
a||[],!0))},is:function(a){return!!n(this,"string"===typeof a&&hb.test(a)?p(a):a||[],!1).length}});var Lb=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(p.fn.init=function(a,c,e){if(!a)return this;e=e||Mb;if("string"===typeof a){var d="<"===a[0]&&">"===a[a.length-1]&&3<=a.length?[null,a,null]:Lb.exec(a);if(!d||!d[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(d[1]){if(c=c instanceof p?c[0]:c,p.merge(this,p.parseHTML(d[1],c&&c.nodeType?c.ownerDocument||c:P,!0)),ib.test(d[1])&&p.isPlainObject(c))for(d in c)if(p.isFunction(this[d]))this[d](c[d]);
else this.attr(d,c[d])}else if(a=P.getElementById(d[2]))this[0]=a,this.length=1;return this}return a.nodeType?(this[0]=a,this.length=1,this):p.isFunction(a)?void 0!==e.ready?e.ready(a):a(p):p.makeArray(a,this)}).prototype=p.fn;var Mb=p(P);var Nb=/^(?:parents|prev(?:Until|All))/,Ob={children:!0,contents:!0,next:!0,prev:!0};p.fn.extend({has:function(a){var c=p(a,this),e=c.length;return this.filter(function(){for(var a=0;a<e;a++)if(p.contains(this,c[a]))return!0})},closest:function(a,c){var e,d=0,h=
this.length,m=[],y="string"!==typeof a&&p(a);if(!hb.test(a))for(;d<h;d++)for(e=this[d];e&&e!==c;e=e.parentNode)if(11>e.nodeType&&(y?-1<y.index(e):1===e.nodeType&&p.find.matchesSelector(e,a))){m.push(e);break}return this.pushStack(1<m.length?p.uniqueSort(m):m)},index:function(a){return a?"string"===typeof a?ya.call(p(a),this[0]):ya.call(this,a.jquery?a[0]:a):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(a,c){return this.pushStack(p.uniqueSort(p.merge(this.get(),p(a,c))))},
addBack:function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))}});p.each({parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},parents:function(a){return wa(a,"parentNode")},parentsUntil:function(a,c,e){return wa(a,"parentNode",e)},next:function(a){return k(a,"nextSibling")},prev:function(a){return k(a,"previousSibling")},nextAll:function(a){return wa(a,"nextSibling")},prevAll:function(a){return wa(a,"previousSibling")},nextUntil:function(a,c,e){return wa(a,"nextSibling",
e)},prevUntil:function(a,c,e){return wa(a,"previousSibling",e)},siblings:function(a){return gb((a.parentNode||{}).firstChild,a)},children:function(a){return gb(a.firstChild)},contents:function(a){if(u(a,"iframe"))return a.contentDocument;u(a,"template")&&(a=a.content||a);return p.merge([],a.childNodes)}},function(a,c){p.fn[a]=function(e,d){var h=p.map(this,c,e);"Until"!==a.slice(-5)&&(d=e);d&&"string"===typeof d&&(h=p.filter(d,h));1<this.length&&(Ob[a]||p.uniqueSort(h),Nb.test(a)&&h.reverse());return this.pushStack(h)}});
var da=/[^\x20\t\r\n\f]+/g;p.Callbacks=function(a){a="string"===typeof a?h(a):p.extend({},a);var c,e,d,m,y=[],t=[],x=-1,k=function(){m=m||a.once;for(d=c=!0;t.length;x=-1)for(e=t.shift();++x<y.length;)!1===y[x].apply(e[0],e[1])&&a.stopOnFalse&&(x=y.length,e=!1);a.memory||(e=!1);c=!1;m&&(y=e?[]:"")},q={add:function(){y&&(e&&!c&&(x=y.length-1,t.push(e)),function yb(c){p.each(c,function(c,e){p.isFunction(e)?a.unique&&q.has(e)||y.push(e):e&&e.length&&"string"!==p.type(e)&&yb(e)})}(arguments),e&&!c&&k());
return this},remove:function(){p.each(arguments,function(a,c){for(var e;-1<(e=p.inArray(c,y,e));)y.splice(e,1),e<=x&&x--});return this},has:function(a){return a?-1<p.inArray(a,y):0<y.length},empty:function(){y&&(y=[]);return this},disable:function(){m=t=[];y=e="";return this},disabled:function(){return!y},lock:function(){m=t=[];e||c||(y=e="");return this},locked:function(){return!!m},fireWith:function(a,e){m||(e=e||[],e=[a,e.slice?e.slice():e],t.push(e),c||k());return this},fire:function(){q.fireWith(this,
...
arguments;return p.Deferred(function(c){p.each(e,function(e,d){var h=p.isFunction(a[d[4]])&&a[d[4]];y[d[1]](function(){var a=h&&h.apply(this,arguments);if(a&&p.isFunction(a.promise))a.promise().progress(c.notify).done(c.resolve).fail(c.reject);else c[d[0]+"With"](this,h?[a]:arguments)})});a=null}).promise()},then:function(a,h,m){function y(a,e,h,m){return function(){var x=this,k=arguments,q=function(){if(!(a<t)){var q=h.apply(x,k);if(q===e.promise())throw new TypeError("Thenable self-resolution");
var l=q&&("object"===typeof q||"function"===typeof q)&&q.then;p.isFunction(l)?m?l.call(q,y(t,e,c,m),y(t,e,d,m)):(t++,l.call(q,y(t,e,c,m),y(t,e,d,m),y(t,e,c,e.notifyWith))):(h!==c&&(x=void 0,k=[q]),(m||e.resolveWith)(x,k))}},f=m?q:function(){try{q()}catch(fb){p.Deferred.exceptionHook&&p.Deferred.exceptionHook(fb,f.stackTrace),a+1>=t&&(h!==d&&(x=void 0,k=[fb]),e.rejectWith(x,k))}};a?f():(p.Deferred.getStackHook&&(f.stackTrace=p.Deferred.getStackHook()),l.setTimeout(f))}}var t=0;return p.Deferred(function(t){e[0][3].add(y(0,
t,p.isFunction(m)?m:c,t.notifyWith));e[1][3].add(y(0,t,p.isFunction(a)?a:c));e[2][3].add(y(0,t,p.isFunction(h)?h:d))}).promise()},promise:function(a){return null!=a?p.extend(a,m):m}},y={};p.each(e,function(a,c){var d=c[2],t=c[5];m[c[1]]=d.add;t&&d.add(function(){h=t},e[3-a][2].disable,e[0][2].lock);d.add(c[3].fire);y[c[0]]=function(){y[c[0]+"With"](this===y?void 0:this,arguments);return this};y[c[0]+"With"]=d.fireWith});m.promise(y);a&&a.call(y,y);return y},when:function(c){var e=arguments.length,
d=e,h=Array(d),m=ja.call(arguments),y=p.Deferred(),t=function(a){return function(c){h[a]=this;m[a]=1<arguments.length?ja.call(arguments):c;--e||y.resolveWith(h,m)}};if(1>=e&&(a(c,y.done(t(d)).resolve,y.reject,!e),"pending"===y.state()||p.isFunction(m[d]&&m[d].then)))return y.then();for(;d--;)a(m[d],t(d),y.reject);return y.promise()}});var Pb=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;p.Deferred.exceptionHook=function(a,c){l.console&&l.console.warn&&a&&Pb.test(a.name)&&l.console.warn("jQuery.Deferred exception: "+
...
e),l.addEventListener("load",e));var ka=function(a,c,e,d,h,m,t){var y=0,x=a.length,k=null==e;if("object"===p.type(e))for(y in h=!0,e)ka(a,c,y,e[y],!0,m,t);else if(void 0!==d&&(h=!0,p.isFunction(d)||(t=!0),k&&(t?(c.call(a,d),c=null):(k=c,c=function(a,c,e){return k.call(p(a),e)})),c))for(;y<x;y++)c(a[y],e,t?d:d.call(a[y],y,c(a[y],e)));return h?a:k?c.call(a):x?c(a[0],e):m},Ka=function(a){return 1===a.nodeType||9===a.nodeType||!+a.nodeType};m.uid=1;m.prototype={cache:function(a){var c=a[this.expando];
...
e){return aa.access(a,c,e)},removeData:function(a,c){aa.remove(a,c)},_data:function(a,c,e){return O.access(a,c,e)},_removeData:function(a,c){O.remove(a,c)}});p.fn.extend({data:function(a,c){var e,d=this[0],h=d&&d.attributes;if(void 0===a){if(this.length){var m=aa.get(d);if(1===d.nodeType&&!O.get(d,"hasDataAttrs")){for(e=h.length;e--;)if(h[e]){var t=h[e].name;0===t.indexOf("data-")&&(t=p.camelCase(t.slice(5)),x(d,t,m[t]))}O.set(d,"hasDataAttrs",!0)}}return m}return"object"===typeof a?this.each(function(){aa.set(this,
a)}):ka(this,function(c){if(d&&void 0===c){var e=aa.get(d,a);if(void 0!==e)return e;e=x(d,a);if(void 0!==e)return e}else this.each(function(){aa.set(this,a,c)})},null,c,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){aa.remove(this,a)})}});p.extend({queue:function(a,c,e){if(a){c=(c||"fx")+"queue";var d=O.get(a,c);e&&(!d||Array.isArray(e)?d=O.access(a,c,p.makeArray(e)):d.push(e));return d||[]}},dequeue:function(a,c){c=c||"fx";var e=p.queue(a,c),d=e.length,h=e.shift(),
m=p._queueHooks(a,c),t=function(){p.dequeue(a,c)};"inprogress"===h&&(h=e.shift(),d--);h&&("fx"===c&&e.unshift("inprogress"),delete m.stop,h.call(a,t,m));!d&&m&&m.empty.fire()},_queueHooks:function(a,c){var e=c+"queueHooks";return O.get(a,e)||O.access(a,e,{empty:p.Callbacks("once memory").add(function(){O.remove(a,[c+"queue",e])})})}});p.fn.extend({queue:function(a,c){var e=2;"string"!==typeof a&&(c=a,a="fx",e--);return arguments.length<e?p.queue(this[0],a):void 0===c?this:this.each(function(){var e=
p.queue(this,a,c);p._queueHooks(this,a);"fx"===a&&"inprogress"!==e[0]&&p.dequeue(this,a)})},dequeue:function(a){return this.each(function(){p.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,c){var e,d=1,h=p.Deferred(),m=this,t=this.length,x=function(){--d||h.resolveWith(m,[m])};"string"!==typeof a&&(c=a,a=void 0);for(a=a||"fx";t--;)(e=O.get(m[t],a+"queueHooks"))&&e.empty&&(d++,e.empty.add(x));x();return h.promise(c)}});var jb=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
...
p.event={global:{},add:function(a,c,e,d,h){var m,t,x,k,y;if(x=O.get(a)){if(e.handler){var q=e;e=q.handler;h=q.selector}h&&p.find.matchesSelector(La,h);e.guid||(e.guid=p.guid++);(t=x.events)||(t=x.events={});(m=x.handle)||(m=x.handle=function(c){return"undefined"!==typeof p&&p.event.triggered!==c.type?p.event.dispatch.apply(a,arguments):void 0});c=(c||"").match(da)||[""];for(x=c.length;x--;){var l=lb.exec(c[x])||[];var f=k=l[1];var A=(l[2]||"").split(".").sort();f&&(l=p.event.special[f]||{},f=(h?l.delegateType:
l.bindType)||f,l=p.event.special[f]||{},k=p.extend({type:f,origType:k,data:d,handler:e,guid:e.guid,selector:h,needsContext:h&&p.expr.match.needsContext.test(h),namespace:A.join(".")},q),(y=t[f])||(y=t[f]=[],y.delegateCount=0,l.setup&&!1!==l.setup.call(a,d,A,m)||a.addEventListener&&a.addEventListener(f,m)),l.add&&(l.add.call(a,k),k.handler.guid||(k.handler.guid=e.guid)),h?y.splice(y.delegateCount++,0,k):y.push(k),p.event.global[f]=!0)}}},remove:function(a,c,e,d,h){var m,t,x,k,y,q=O.hasData(a)&&O.get(a);
if(q&&(x=q.events)){c=(c||"").match(da)||[""];for(k=c.length;k--;){var l=lb.exec(c[k])||[];var f=y=l[1];var A=(l[2]||"").split(".").sort();if(f){var n=p.event.special[f]||{};f=(d?n.delegateType:n.bindType)||f;var z=x[f]||[];l=l[2]&&new RegExp("(^|\\.)"+A.join("\\.(?:.*\\.|)")+"(\\.|$)");for(t=m=z.length;m--;){var u=z[m];!h&&y!==u.origType||e&&e.guid!==u.guid||l&&!l.test(u.namespace)||d&&d!==u.selector&&("**"!==d||!u.selector)||(z.splice(m,1),u.selector&&z.delegateCount--,n.remove&&n.remove.call(a,
u))}t&&!z.length&&(n.teardown&&!1!==n.teardown.call(a,A,q.handle)||p.removeEvent(a,f,q.handle),delete x[f])}else for(f in x)p.event.remove(a,f+c[k],e,d,!0)}p.isEmptyObject(x)&&O.remove(a,"handle events")}},dispatch:function(a){var c=p.event.fix(a),e,d,h,m=Array(arguments.length);var t=(O.get(this,"events")||{})[c.type]||[];var x=p.event.special[c.type]||{};m[0]=c;for(e=1;e<arguments.length;e++)m[e]=arguments[e];c.delegateTarget=this;if(!x.preDispatch||!1!==x.preDispatch.call(this,c)){var k=p.event.handlers.call(this,
c,t);for(e=0;(h=k[e++])&&!c.isPropagationStopped();)for(c.currentTarget=h.elem,t=0;(d=h.handlers[t++])&&!c.isImmediatePropagationStopped();)if(!c.rnamespace||c.rnamespace.test(d.namespace))c.handleObj=d,c.data=d.data,d=((p.event.special[d.origType]||{}).handle||d.handler).apply(h.elem,m),void 0!==d&&!1===(c.result=d)&&(c.preventDefault(),c.stopPropagation());x.postDispatch&&x.postDispatch.call(this,c);return c.result}},handlers:function(a,c){var e,d=[],h=c.delegateCount,m=a.target;if(h&&m.nodeType&&
!("click"===a.type&&1<=a.button))for(;m!==this;m=m.parentNode||this)if(1===m.nodeType&&("click"!==a.type||!0!==m.disabled)){var t=[];var x={};for(e=0;e<h;e++){var k=c[e];var y=k.selector+" ";void 0===x[y]&&(x[y]=k.needsContext?-1<p(y,this).index(m):p.find(y,this,null,[m]).length);x[y]&&t.push(k)}t.length&&d.push({elem:m,handlers:t})}h<c.length&&d.push({elem:this,handlers:c.slice(h)});return d},addProp:function(a,c){Object.defineProperty(p.Event.prototype,a,{enumerable:!0,configurable:!0,get:p.isFunction(c)?
function(){if(this.originalEvent)return c(this.originalEvent)}:function(){if(this.originalEvent)return this.originalEvent[a]},set:function(c){Object.defineProperty(this,a,{enumerable:!0,configurable:!0,writable:!0,value:c})}})},fix:function(a){return a[p.expando]?a:new p.Event(a)},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==I()&&this.focus)return this.focus(),!1},delegateType:"focusin"},blur:{trigger:function(){if(this===I()&&this.blur)return this.blur(),!1},delegateType:"focusout"},
click:{trigger:function(){if(Sa.test(this.type)&&this.click&&u(this,"input"))return this.click(),!1},_default:function(a){return u(a.target,"a")}},beforeunload:{postDispatch:function(a){void 0!==a.result&&a.originalEvent&&(a.originalEvent.returnValue=a.result)}}}};p.removeEvent=function(a,c,e){a.removeEventListener&&a.removeEventListener(c,e)};p.Event=function(a,c){if(!(this instanceof p.Event))return new p.Event(a,c);a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||
...
c,a[d]);return this}if(!1===c||"function"===typeof c)e=c,c=void 0;!1===e&&(e=B);return this.each(function(){p.event.remove(this,a,e,c)})}});var Sb=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,Tb=/<script|<style|<link/i,Bb=/checked\s*(?:[^=]|=\s*.checked.)/i,Ab=/^true\/(.*)/,Cb=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;p.extend({htmlPrefilter:function(a){return a.replace(Sb,"<$1></$2>")},clone:function(a,c,e){var d,h=a.cloneNode(!0),m=p.contains(a.ownerDocument,
a);if(!(R.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||p.isXMLDoc(a))){var x=t(h);var k=t(a);var q=0;for(d=k.length;q<d;q++){var l=k[q],y=x[q],f=y.nodeName.toLowerCase();if("input"===f&&Sa.test(l.type))y.checked=l.checked;else if("input"===f||"textarea"===f)y.defaultValue=l.defaultValue}}if(c)if(e)for(k=k||t(a),x=x||t(h),q=0,d=k.length;q<d;q++)D(k[q],x[q]);else D(a,h);x=t(h,"script");0<x.length&&A(x,!m&&t(a,"script"));return h},cleanData:function(a){for(var c,e,d,h=p.event.special,m=0;void 0!==
(e=a[m]);m++)if(Ka(e)){if(c=e[O.expando]){if(c.events)for(d in c.events)h[d]?p.event.remove(e,d):p.removeEvent(e,d,c.handle);e[O.expando]=void 0}e[aa.expando]&&(e[aa.expando]=void 0)}}});p.fn.extend({detach:function(a){return X(this,a,!0)},remove:function(a){return X(this,a)},text:function(a){return ka(this,function(a){return void 0===a?p.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=a})},null,a,arguments.length)},append:function(){return J(this,
arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||E(this,a).appendChild(a)})},prepend:function(){return J(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var c=E(this,a);c.insertBefore(a,c.firstChild)}})},before:function(){return J(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return J(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},
empty:function(){for(var a,c=0;null!=(a=this[c]);c++)1===a.nodeType&&(p.cleanData(t(a,!1)),a.textContent="");return this},clone:function(a,c){a=null==a?!1:a;c=null==c?a:c;return this.map(function(){return p.clone(this,a,c)})},html:function(a){return ka(this,function(a){var c=this[0]||{},e=0,d=this.length;if(void 0===a&&1===c.nodeType)return c.innerHTML;if("string"===typeof a&&!Tb.test(a)&&!ea[(Ya.exec(a)||["",""])[1].toLowerCase()]){a=p.htmlPrefilter(a);try{for(;e<d;e++)c=this[e]||{},1===c.nodeType&&
(p.cleanData(t(c,!1)),c.innerHTML=a);c=0}catch(Wa){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=[];return J(this,arguments,function(c){var e=this.parentNode;0>p.inArray(this,a)&&(p.cleanData(t(this)),e&&e.replaceChild(c,this))},a)}});p.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,c){p.fn[a]=function(a){for(var e=[],d=p(a),h=d.length-1,m=0;m<=h;m++)a=m===h?this:this.clone(!0),p(d[m])[c](a),
Pa.apply(e,a.get());return this.pushStack(e)}});var ab=/^margin/,Na=new RegExp("^("+jb+")(?!px)[a-z%]+$","i"),Fa=function(a){var c=a.ownerDocument.defaultView;c&&c.opener||(c=l);return c.getComputedStyle(a)};(function(){function a(){if(t){t.style.cssText="box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%";t.innerHTML="";La.appendChild(m);var a=l.getComputedStyle(t);c="1%"!==a.top;h="2px"===a.marginLeft;e="4px"===a.width;t.style.marginRight="50%";
d="4px"===a.marginRight;La.removeChild(m);t=null}}var c,e,d,h,m=P.createElement("div"),t=P.createElement("div");t.style&&(t.style.backgroundClip="content-box",t.cloneNode(!0).style.backgroundClip="",R.clearCloneStyle="content-box"===t.style.backgroundClip,m.style.cssText="border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",m.appendChild(t),p.extend(R,{pixelPosition:function(){a();return c},boxSizingReliable:function(){a();return e},pixelMarginRight:function(){a();
return d},reliableMarginLeft:function(){a();return h}}))})();var Ub=/^(none|table(?!-c[ea]).+)/,mb=/^--/,Vb={position:"absolute",visibility:"hidden",display:"block"},nb={letterSpacing:"0",fontWeight:"400"},cb=["Webkit","Moz","ms"],bb=P.createElement("div").style;p.extend({cssHooks:{opacity:{get:function(a,c){if(c){var e=L(a,"opacity");return""===e?"1":e}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,
orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":"cssFloat"},style:function(a,c,e,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var h,m=p.camelCase(c),t=mb.test(c),x=a.style;t||(c=T(m));var k=p.cssHooks[c]||p.cssHooks[m];if(void 0!==e){var l=typeof e;"string"===l&&(h=oa.exec(e))&&h[1]&&(e=q(a,c,h),l="number");null!=e&&e===e&&("number"===l&&(e+=h&&h[3]||(p.cssNumber[m]?"":"px")),R.clearCloneStyle||""!==e||0!==c.indexOf("background")||(x[c]="inherit"),k&&"set"in k&&void 0===(e=k.set(a,
e,d))||(t?x.setProperty(c,e):x[c]=e))}else return k&&"get"in k&&void 0!==(h=k.get(a,!1,d))?h:x[c]}},css:function(a,c,e,d){var h;var m=p.camelCase(c);mb.test(c)||(c=T(m));(m=p.cssHooks[c]||p.cssHooks[m])&&"get"in m&&(h=m.get(a,!0,e));void 0===h&&(h=L(a,c,d));"normal"===h&&c in nb&&(h=nb[c]);return""===e||e?(a=parseFloat(h),!0===e||isFinite(a)?a||0:h):h}});p.each(["height","width"],function(a,c){p.cssHooks[c]={get:function(a,e,d){if(e)return!Ub.test(p.css(a,"display"))||a.getClientRects().length&&a.getBoundingClientRect().width?
W(a,c,d):kb(a,Vb,function(){return W(a,c,d)})},set:function(a,e,d){var h,m=d&&Fa(a);(d=d&&Y(a,c,d,"border-box"===p.css(a,"boxSizing",!1,m),m))&&(h=oa.exec(e))&&"px"!==(h[3]||"px")&&(a.style[c]=e,e=p.css(a,c));return S(a,e,d)}}});p.cssHooks.marginLeft=M(R.reliableMarginLeft,function(a,c){if(c)return(parseFloat(L(a,"marginLeft"))||a.getBoundingClientRect().left-kb(a,{marginLeft:0},function(){return a.getBoundingClientRect().left}))+"px"});p.each({margin:"",padding:"",border:"Width"},function(a,c){p.cssHooks[a+
c]={expand:function(e){var d=0,h={};for(e="string"===typeof e?e.split(" "):[e];4>d;d++)h[a+pa[d]+c]=e[d]||e[d-2]||e[0];return h}};ab.test(a)||(p.cssHooks[a+c].set=S)});p.fn.extend({css:function(a,c){return ka(this,function(a,c,e){var d,h={},m=0;if(Array.isArray(c)){e=Fa(a);for(d=c.length;m<d;m++)h[c[m]]=p.css(a,c[m],!1,e);return h}return void 0!==e?p.style(a,c,e):p.css(a,c)},a,c,1<arguments.length)}});p.Tween=U;U.prototype={constructor:U,init:function(a,c,e,d,h,m){this.elem=a;this.prop=e;this.easing=
...
{set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};p.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};p.fx=U.prototype.init;p.fx.step={};var qa,Ga,Wb=/^(?:toggle|show|hide)$/,Xb=/queueHooks$/;p.Animation=p.extend(ha,{tweeners:{"*":[function(a,c){var e=this.createTween(a,c);q(e.elem,a,oa.exec(c),e);return e}]},tweener:function(a,c){p.isFunction(a)?(c=a,a=["*"]):a=a.match(da);for(var e,d=0,h=a.length;d<h;d++)e=a[d],ha.tweeners[e]=
ha.tweeners[e]||[],ha.tweeners[e].unshift(c)},prefilters:[function(a,c,e){var d;var h="width"in c||"height"in c;var m=this,t={},x=a.style,k=a.nodeType&&Ea(a),q=O.get(a,"fxshow");if(!e.queue){var l=p._queueHooks(a,"fx");if(null==l.unqueued){l.unqueued=0;var f=l.empty.fire;l.empty.fire=function(){l.unqueued||f()}}l.unqueued++;m.always(function(){m.always(function(){l.unqueued--;p.queue(a,"fx").length||l.empty.fire()})})}for(d in c){var A=c[d];if(Wb.test(A)){delete c[d];var n=n||"toggle"===A;if(A===
(k?"hide":"show"))if("show"===A&&q&&void 0!==q[d])k=!0;else continue;t[d]=q&&q[d]||p.style(a,d)}}if((c=!p.isEmptyObject(c))||!p.isEmptyObject(t)){if(h&&1===a.nodeType){e.overflow=[x.overflow,x.overflowX,x.overflowY];var y=q&&q.display;null==y&&(y=O.get(a,"display"));h=p.css(a,"display");"none"===h&&(y?h=y:(z([a],!0),y=a.style.display||y,h=p.css(a,"display"),z([a])));("inline"===h||"inline-block"===h&&null!=y)&&"none"===p.css(a,"float")&&(c||(m.done(function(){x.display=y}),null==y&&(h=x.display,y=
"none"===h?"":h)),x.display="inline-block")}e.overflow&&(x.overflow="hidden",m.always(function(){x.overflow=e.overflow[0];x.overflowX=e.overflow[1];x.overflowY=e.overflow[2]}));c=!1;for(d in t)c||(q?"hidden"in q&&(k=q.hidden):q=O.access(a,"fxshow",{display:y}),n&&(q.hidden=!k),k&&z([a],!0),m.done(function(){k||z([a]);O.remove(a,"fxshow");for(d in t)p.style(a,d,t[d])})),c=ra(k?q[d]:0,d,m),d in q||(q[d]=c.start,k&&(c.end=c.start,c.start=0))}}],prefilter:function(a,c){c?ha.prefilters.unshift(a):ha.prefilters.push(a)}});
p.speed=function(a,c,e){var d=a&&"object"===typeof a?p.extend({},a):{complete:e||!e&&c||p.isFunction(a)&&a,duration:a,easing:e&&c||c&&!p.isFunction(c)&&c};p.fx.off?d.duration=0:"number"!==typeof d.duration&&(d.duration=d.duration in p.fx.speeds?p.fx.speeds[d.duration]:p.fx.speeds._default);if(null==d.queue||!0===d.queue)d.queue="fx";d.old=d.complete;d.complete=function(){p.isFunction(d.old)&&d.old.call(this);d.queue&&p.dequeue(this,d.queue)};return d};p.fn.extend({fadeTo:function(a,c,e,d){return this.filter(Ea).css("opacity",
0).show().end().animate({opacity:c},a,e,d)},animate:function(a,c,e,d){var h=p.isEmptyObject(a),m=p.speed(c,e,d);c=function(){var c=ha(this,p.extend({},a),m);(h||O.get(this,"finish"))&&c.stop(!0)};c.finish=c;return h||!1===m.queue?this.each(c):this.queue(m.queue,c)},stop:function(a,c,e){var d=function(a){var c=a.stop;delete a.stop;c(e)};"string"!==typeof a&&(e=c,c=a,a=void 0);c&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var c=!0,h=null!=a&&a+"queueHooks",m=p.timers,t=O.get(this);if(h)t[h]&&
t[h].stop&&d(t[h]);else for(h in t)t[h]&&t[h].stop&&Xb.test(h)&&d(t[h]);for(h=m.length;h--;)m[h].elem!==this||null!=a&&m[h].queue!==a||(m[h].anim.stop(e),c=!1,m.splice(h,1));!c&&e||p.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var c=O.get(this),e=c[a+"queue"];var d=c[a+"queueHooks"];var h=p.timers,m=e?e.length:0;c.finish=!0;p.queue(this,a,[]);d&&d.stop&&d.stop.call(this,!0);for(d=h.length;d--;)h[d].elem===this&&h[d].queue===a&&(h[d].anim.stop(!0),h.splice(d,
1));for(d=0;d<m;d++)e[d]&&e[d].finish&&e[d].finish.call(this);delete c.finish})}});p.each(["toggle","show","hide"],function(a,c){var e=p.fn[c];p.fn[c]=function(a,d,h){return null==a||"boolean"===typeof a?e.apply(this,arguments):this.animate(ga(c,!0),a,d,h)}});p.each({slideDown:ga("show"),slideUp:ga("hide"),slideToggle:ga("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,c){p.fn[a]=function(a,e,d){return this.animate(c,a,e,d)}});p.timers=[];p.fx.tick=
function(){var a=0,c=p.timers;for(qa=p.now();a<c.length;a++){var e=c[a];e()||c[a]!==e||c.splice(a--,1)}c.length||p.fx.stop();qa=void 0};p.fx.timer=function(a){p.timers.push(a);p.fx.start()};p.fx.interval=13;p.fx.start=function(){Ga||(Ga=!0,fa())};p.fx.stop=function(){Ga=null};p.fx.speeds={slow:600,fast:200,_default:400};p.fn.delay=function(a,c){a=p.fx?p.fx.speeds[a]||a:a;return this.queue(c||"fx",function(c,e){var d=l.setTimeout(c,a);e.stop=function(){l.clearTimeout(d)}})};(function(){var a=P.createElement("input"),
...
c,e);1===m&&p.isXMLDoc(a)||(h=p.attrHooks[c.toLowerCase()]||(p.expr.match.bool.test(c)?Yb:void 0));if(void 0!==e){if(null===e){p.removeAttr(a,c);return}if(h&&"set"in h&&void 0!==(d=h.set(a,e,c)))return d;a.setAttribute(c,e+"");return e}if(h&&"get"in h&&null!==(d=h.get(a,c)))return d;d=p.find.attr(a,c);return null==d?void 0:d}},attrHooks:{type:{set:function(a,c){if(!R.radioValue&&"radio"===c&&u(a,"input")){var e=a.value;a.setAttribute("type",c);e&&(a.value=e);return c}}}},removeAttr:function(a,c){var e,
d=0,h=c&&c.match(da);if(h&&1===a.nodeType)for(;e=h[d++];)a.removeAttribute(e)}});var Yb={set:function(a,c,e){!1===c?p.removeAttr(a,e):a.setAttribute(e,e);return e}};p.each(p.expr.match.bool.source.match(/\w+/g),function(a,c){var e=na[c]||p.find.attr;na[c]=function(a,c,d){var h=c.toLowerCase();if(!d){var m=na[h];na[h]=t;var t=null!=e(a,c,d)?h:null;na[h]=m}return t}});var Zb=/^(?:input|select|textarea|button)$/i,$b=/^(?:a|area)$/i;p.fn.extend({prop:function(a,c){return ka(this,p.prop,a,c,1<arguments.length)},
...
"class":"className"}});R.optSelected||(p.propHooks.selected={get:function(a){(a=a.parentNode)&&a.parentNode&&a.parentNode.selectedIndex;return null},set:function(a){if(a=a.parentNode)a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex}});p.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){p.propFix[this.toLowerCase()]=this});p.fn.extend({addClass:function(a){var c,e,d,h,m,t=0;if(p.isFunction(a))return this.each(function(c){p(this).addClass(a.call(this,
c,la(this)))});if("string"===typeof a&&a)for(c=a.match(da)||[];e=this[t++];){var x=la(e);if(d=1===e.nodeType&&" "+ba(x)+" "){for(m=0;h=c[m++];)0>d.indexOf(" "+h+" ")&&(d+=h+" ");d=ba(d);x!==d&&e.setAttribute("class",d)}}return this},removeClass:function(a){var c,e,d,h,m,t=0;if(p.isFunction(a))return this.each(function(c){p(this).removeClass(a.call(this,c,la(this)))});if(!arguments.length)return this.attr("class","");if("string"===typeof a&&a)for(c=a.match(da)||[];e=this[t++];){var x=la(e);if(d=1===
e.nodeType&&" "+ba(x)+" "){for(m=0;h=c[m++];)for(;-1<d.indexOf(" "+h+" ");)d=d.replace(" "+h+" "," ");d=ba(d);x!==d&&e.setAttribute("class",d)}}return this},toggleClass:function(a,c){var e=typeof a;return"boolean"===typeof c&&"string"===e?c?this.addClass(a):this.removeClass(a):p.isFunction(a)?this.each(function(e){p(this).toggleClass(a.call(this,e,la(this),c),c)}):this.each(function(){var c,d;if("string"===e){var h=0;var m=p(this);for(d=a.match(da)||[];c=d[h++];)m.hasClass(c)?m.removeClass(c):m.addClass(c)}else if(void 0===
a||"boolean"===e)(c=la(this))&&O.set(this,"__className__",c),this.setAttribute&&this.setAttribute("class",c||!1===a?"":O.get(this,"__className__")||"")})},hasClass:function(a){var c,e=0;for(a=" "+a+" ";c=this[e++];)if(1===c.nodeType&&-1<(" "+ba(la(c))+" ").indexOf(a))return!0;return!1}});var ac=/\r/g;p.fn.extend({val:function(a){var c,e,d=this[0];if(arguments.length){var h=p.isFunction(a);return this.each(function(e){1===this.nodeType&&(e=h?a.call(this,e,p(this).val()):a,null==e?e="":"number"===typeof e?
e+="":Array.isArray(e)&&(e=p.map(e,function(a){return null==a?"":a+""})),c=p.valHooks[this.type]||p.valHooks[this.nodeName.toLowerCase()],c&&"set"in c&&void 0!==c.set(this,e,"value")||(this.value=e))})}if(d){if((c=p.valHooks[d.type]||p.valHooks[d.nodeName.toLowerCase()])&&"get"in c&&void 0!==(e=c.get(d,"value")))return e;e=d.value;return"string"===typeof e?e.replace(ac,""):null==e?"":e}}});p.extend({valHooks:{option:{get:function(a){var c=p.find.attr(a,"value");return null!=c?c:ba(p.text(a))}},select:{get:function(a){var c=
a.options,e=a.selectedIndex,d="select-one"===a.type,h=d?null:[],m=d?e+1:c.length;for(a=0>e?m:d?e:0;a<m;a++){var t=c[a];if(!(!t.selected&&a!==e||t.disabled||t.parentNode.disabled&&u(t.parentNode,"optgroup"))){t=p(t).val();if(d)return t;h.push(t)}}return h},set:function(a,c){for(var e,d,h=a.options,m=p.makeArray(c),t=h.length;t--;)if(d=h[t],d.selected=-1<p.inArray(p.valHooks.option.get(d),m))e=!0;e||(a.selectedIndex=-1);return m}}}});p.each(["radio","checkbox"],function(){p.valHooks[this]={set:function(a,
c){if(Array.isArray(c))return a.checked=-1<p.inArray(p(a).val(),c)}};R.checkOn||(p.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var ob=/^(?:focusinfocus|focusoutblur)$/;p.extend(p.event,{trigger:function(a,c,e,d){var h,m,t=[e||P],x=Ja.call(a,"type")?a.type:a;var k=Ja.call(a,"namespace")?a.namespace.split("."):[];var q=h=e=e||P;if(3!==e.nodeType&&8!==e.nodeType&&!ob.test(x+p.event.triggered)){-1<x.indexOf(".")&&(k=x.split("."),x=k.shift(),k.sort());var f=0>
x.indexOf(":")&&"on"+x;a=a[p.expando]?a:new p.Event(x,"object"===typeof a&&a);a.isTrigger=d?2:3;a.namespace=k.join(".");a.rnamespace=a.namespace?new RegExp("(^|\\.)"+k.join("\\.(?:.*\\.|)")+"(\\.|$)"):null;a.result=void 0;a.target||(a.target=e);c=null==c?[a]:p.makeArray(c,[a]);k=p.event.special[x]||{};if(d||!k.trigger||!1!==k.trigger.apply(e,c)){if(!d&&!k.noBubble&&!p.isWindow(e)){var A=k.delegateType||x;ob.test(A+x)||(q=q.parentNode);for(;q;q=q.parentNode)t.push(q),h=q;h===(e.ownerDocument||P)&&
t.push(h.defaultView||h.parentWindow||l)}for(h=0;(q=t[h++])&&!a.isPropagationStopped();)a.type=1<h?A:k.bindType||x,(m=(O.get(q,"events")||{})[a.type]&&O.get(q,"handle"))&&m.apply(q,c),(m=f&&q[f])&&m.apply&&Ka(q)&&(a.result=m.apply(q,c),!1===a.result&&a.preventDefault());a.type=x;d||a.isDefaultPrevented()||k._default&&!1!==k._default.apply(t.pop(),c)||!Ka(e)||!f||!p.isFunction(e[x])||p.isWindow(e)||((h=e[f])&&(e[f]=null),p.event.triggered=x,e[x](),p.event.triggered=void 0,h&&(e[f]=h));return a.result}}},
...
h=O.access(d,c)-1;h?O.access(d,c,h):(d.removeEventListener(a,e,!0),O.remove(d,c))}}});var xa=l.location,pb=p.now(),Ta=/\?/;p.parseXML=function(a){if(!a||"string"!==typeof a)return null;try{var c=(new l.DOMParser).parseFromString(a,"text/xml")}catch(Ca){c=void 0}c&&!c.getElementsByTagName("parsererror").length||p.error("Invalid XML: "+a);return c};var Db=/\[\]$/,qb=/\r?\n/g,bc=/^(?:submit|button|image|reset|file)$/i,cc=/^(?:input|select|textarea|keygen)/i;p.param=function(a,c){var e,d=[],h=function(a,
...
cc.test(this.nodeName)&&!bc.test(a)&&(this.checked||!Sa.test(a))}).map(function(a,c){var e=p(this).val();return null==e?null:Array.isArray(e)?p.map(e,function(a){return{name:c.name,value:a.replace(qb,"\r\n")}}):{name:c.name,value:e.replace(qb,"\r\n")}}).get()}});var dc=/%20/g,ec=/#.*$/,fc=/([?&])_=[^&]*/,gc=/^(.*?):[ \t]*([^\r\n]*)$/mg,hc=/^(?:GET|HEAD)$/,ic=/^\/\//,rb={},Oa={},sb="*/".concat("*"),Ua=P.createElement("a");Ua.href=xa.href;p.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:xa.href,
...
"text xml":p.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,c){return c?Ba(Ba(a,p.ajaxSettings),c):Ba(p.ajaxSettings,a)},ajaxPrefilter:Ha(rb),ajaxTransport:Ha(Oa),ajax:function(a,c){function e(a,c,e,m){var k=c;if(!M){M=!0;t&&l.clearTimeout(t);d=void 0;h=m||"";w.readyState=0<a?4:0;m=200<=a&&300>a||304===a;if(e){var y=q;for(var K=w,F,L,N,B,C=y.contents,D=y.dataTypes;"*"===D[0];)D.shift(),void 0===F&&(F=y.mimeType||K.getResponseHeader("Content-Type"));if(F)for(L in C)if(C[L]&&C[L].test(F)){D.unshift(L);
break}if(D[0]in e)N=D[0];else{for(L in e){if(!D[0]||y.converters[L+" "+D[0]]){N=L;break}B||(B=L)}N=N||B}N?(N!==D[0]&&D.unshift(N),y=e[N]):y=void 0}a:{e=q;F=y;L=w;N=m;var I,K={},C=e.dataTypes.slice();if(C[1])for(G in e.converters)K[G.toLowerCase()]=e.converters[G];for(B=C.shift();B;){e.responseFields[B]&&(L[e.responseFields[B]]=F);!J&&N&&e.dataFilter&&(F=e.dataFilter(F,e.dataType));var J=B;if(B=C.shift())if("*"===B)B=J;else if("*"!==J&&J!==B){var G=K[J+" "+B]||K["* "+B];if(!G)for(I in K)if(y=I.split(" "),
y[1]===B&&(G=K[J+" "+y[0]]||K["* "+y[0]])){!0===G?G=K[I]:!0!==K[I]&&(B=y[0],C.unshift(y[1]));break}if(!0!==G)if(G&&e["throws"])F=G(F);else try{F=G(F)}catch(Kb){y={state:"parsererror",error:G?Kb:"No conversion from "+J+" to "+B};break a}}}y={state:"success",data:F}}if(m)if(q.ifModified&&((k=w.getResponseHeader("Last-Modified"))&&(p.lastModified[v]=k),(k=w.getResponseHeader("etag"))&&(p.etag[v]=k)),204===a||"HEAD"===q.type)k="nocontent";else if(304===a)k="notmodified";else{k=y.state;var E=y.data;var T=
y.error;m=!T}else if(T=k,a||!k)k="error",0>a&&(a=0);w.status=a;w.statusText=(c||k)+"";m?n.resolveWith(f,[E,k,w]):n.rejectWith(f,[w,k,T]);w.statusCode(u);u=void 0;x&&A.trigger(m?"ajaxSuccess":"ajaxError",[w,q,m?E:T]);z.fireWith(f,[w,k]);x&&(A.trigger("ajaxComplete",[w,q]),--p.active||p.event.trigger("ajaxStop"))}}"object"===typeof a&&(c=a,a=void 0);c=c||{};var d,h,m,t,x,k,q=p.ajaxSetup({},c),f=q.context||q,A=q.context&&(f.nodeType||f.jquery)?p(f):p.event,n=p.Deferred(),z=p.Callbacks("once memory"),
u=q.statusCode||{},y={},K={},L="canceled",w={readyState:0,getResponseHeader:function(a){var c;if(M){if(!m)for(m={};c=gc.exec(h);)m[c[1].toLowerCase()]=c[2];c=m[a.toLowerCase()]}return null==c?null:c},getAllResponseHeaders:function(){return M?h:null},setRequestHeader:function(a,c){null==M&&(a=K[a.toLowerCase()]=K[a.toLowerCase()]||a,y[a]=c);return this},overrideMimeType:function(a){null==M&&(q.mimeType=a);return this},statusCode:function(a){var c;if(a)if(M)w.always(a[w.status]);else for(c in a)u[c]=
[u[c],a[c]];return this},abort:function(a){a=a||L;d&&d.abort(a);e(0,a);return this}};n.promise(w);q.url=((a||q.url||xa.href)+"").replace(ic,xa.protocol+"//");q.type=c.method||c.type||q.method||q.type;q.dataTypes=(q.dataType||"*").toLowerCase().match(da)||[""];if(null==q.crossDomain){var F=P.createElement("a");try{F.href=q.url,F.href=F.href,q.crossDomain=Ua.protocol+"//"+Ua.host!==F.protocol+"//"+F.host}catch(Qa){q.crossDomain=!0}}q.data&&q.processData&&"string"!==typeof q.data&&(q.data=p.param(q.data,
q.traditional));va(rb,q,c,w);if(M)return w;(x=p.event&&q.global)&&0===p.active++&&p.event.trigger("ajaxStart");q.type=q.type.toUpperCase();q.hasContent=!hc.test(q.type);var v=q.url.replace(ec,"");q.hasContent?q.data&&q.processData&&0===(q.contentType||"").indexOf("application/x-www-form-urlencoded")&&(q.data=q.data.replace(dc,"+")):(F=q.url.slice(v.length),q.data&&(v+=(Ta.test(v)?"&":"?")+q.data,delete q.data),!1===q.cache&&(v=v.replace(fc,"$1"),F=(Ta.test(v)?"&":"?")+"_="+pb++ +F),q.url=v+F);q.ifModified&&
(p.lastModified[v]&&w.setRequestHeader("If-Modified-Since",p.lastModified[v]),p.etag[v]&&w.setRequestHeader("If-None-Match",p.etag[v]));(q.data&&q.hasContent&&!1!==q.contentType||c.contentType)&&w.setRequestHeader("Content-Type",q.contentType);w.setRequestHeader("Accept",q.dataTypes[0]&&q.accepts[q.dataTypes[0]]?q.accepts[q.dataTypes[0]]+("*"!==q.dataTypes[0]?", "+sb+"; q=0.01":""):q.accepts["*"]);for(k in q.headers)w.setRequestHeader(k,q.headers[k]);if(q.beforeSend&&(!1===q.beforeSend.call(f,w,q)||
M))return w.abort();L="abort";z.add(q.complete);w.done(q.success);w.fail(q.error);if(d=va(Oa,q,c,w)){w.readyState=1;x&&A.trigger("ajaxSend",[w,q]);if(M)return w;q.async&&0<q.timeout&&(t=l.setTimeout(function(){w.abort("timeout")},q.timeout));try{var M=!1;d.send(y,e)}catch(Qa){if(M)throw Qa;e(-1,Qa)}}else e(-1,"No Transport");return w},getJSON:function(a,c,e){return p.get(a,c,e,"json")},getScript:function(a,c){return p.get(a,void 0,c,"script")}});p.each(["get","post"],function(a,c){p[c]=function(a,
...
function(a){return!!(a.offsetWidth||a.offsetHeight||a.getClientRects().length)};p.ajaxSettings.xhr=function(){try{return new l.XMLHttpRequest}catch(y){}};var jc={0:200,1223:204},Aa=p.ajaxSettings.xhr();R.cors=!!Aa&&"withCredentials"in Aa;R.ajax=Aa=!!Aa;p.ajaxTransport(function(a){var c,e;if(R.cors||Aa&&!a.crossDomain)return{send:function(d,h){var m,t=a.xhr();t.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(m in a.xhrFields)t[m]=a.xhrFields[m];a.mimeType&&t.overrideMimeType&&t.overrideMimeType(a.mimeType);
a.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");for(m in d)t.setRequestHeader(m,d[m]);c=function(a){return function(){c&&(c=e=t.onload=t.onerror=t.onabort=t.onreadystatechange=null,"abort"===a?t.abort():"error"===a?"number"!==typeof t.status?h(0,"error"):h(t.status,t.statusText):h(jc[t.status]||t.status,t.statusText,"text"!==(t.responseType||"text")||"string"!==typeof t.responseText?{binary:t.response}:{text:t.responseText},t.getAllResponseHeaders()))}};t.onload=c();
e=t.onerror=c("error");void 0!==t.onabort?t.onabort=e:t.onreadystatechange=function(){4===t.readyState&&l.setTimeout(function(){c&&e()})};c=c("abort");try{t.send(a.hasContent&&a.data||null)}catch(xb){if(c)throw xb;}},abort:function(){c&&c()}}});p.ajaxPrefilter(function(a){a.crossDomain&&(a.contents.script=!1)});p.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(a){p.globalEval(a);
return a}}});p.ajaxPrefilter("script",function(a){void 0===a.cache&&(a.cache=!1);a.crossDomain&&(a.type="GET")});p.ajaxTransport("script",function(a){if(a.crossDomain){var c,e;return{send:function(d,h){c=p("<script>").prop({charset:a.scriptCharset,src:a.url}).on("load error",e=function(a){c.remove();e=null;a&&h("error"===a.type?404:200,a.type)});P.head.appendChild(c[0])},abort:function(){e&&e()}}}});var tb=[],Va=/(=)\?(?=&|$)|\?\?/;p.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=tb.pop()||
...
p.error(m+" was not called");return d[0]};a.dataTypes[0]="json";var t=l[m];l[m]=function(){d=arguments};e.always(function(){void 0===t?p(l).removeProp(m):l[m]=t;a[m]&&(a.jsonpCallback=c.jsonpCallback,tb.push(m));d&&p.isFunction(t)&&t(d[0]);d=t=void 0});return"script"}});R.createHTMLDocument=function(){var a=P.implementation.createHTMLDocument("").body;a.innerHTML="<form></form><form></form>";return 2===a.childNodes.length}();p.parseHTML=function(a,c,e){if("string"!==typeof a)return[];"boolean"===
typeof c&&(e=c,c=!1);if(!c)if(R.createHTMLDocument){c=P.implementation.createHTMLDocument("");var d=c.createElement("base");d.href=P.location.href;c.head.appendChild(d)}else c=P;d=ib.exec(a);e=!e&&[];if(d)return[c.createElement(d[1])];d=K([a],c,e);e&&e.length&&p(e).remove();return p.merge([],d.childNodes)};p.fn.load=function(a,c,e){var d,h,m=this,t=a.indexOf(" ");if(-1<t){var x=ba(a.slice(t));a=a.slice(0,t)}p.isFunction(c)?(e=c,c=void 0):c&&"object"===typeof c&&(d="POST");0<m.length&&p.ajax({url:a,
type:d||"GET",dataType:"html",data:c}).done(function(a){h=arguments;m.html(x?p("<div>").append(p.parseHTML(a)).find(x):a)}).always(e&&function(a,c){m.each(function(){e.apply(this,h||[a.responseText,c,a])})});return this};p.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,c){p.fn[c]=function(a){return this.on(c,a)}});p.expr.pseudos.animated=function(a){return p.grep(p.timers,function(c){return a===c.elem}).length};p.offset={setOffset:function(a,c,e){var d=
p.css(a,"position"),h=p(a),m={};"static"===d&&(a.style.position="relative");var t=h.offset();var x=p.css(a,"top");var k=p.css(a,"left");("absolute"===d||"fixed"===d)&&-1<(x+k).indexOf("auto")?(k=h.position(),x=k.top,k=k.left):(x=parseFloat(x)||0,k=parseFloat(k)||0);p.isFunction(c)&&(c=c.call(a,e,p.extend({},t)));null!=c.top&&(m.top=c.top-t.top+x);null!=c.left&&(m.left=c.left-t.left+k);"using"in c?c.using.call(a,m):h.css(m)}};p.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:
...
+function(l){var f=function(f){l(f).on("click",'[data-dismiss="alert"]',this.close)};f.VERSION="3.3.7";f.TRANSITION_DURATION=150;f.prototype.close=function(w){function u(){h.detach().trigger("closed.bs.alert").remove()}var n=l(this),k=n.attr("data-target");k||(k=(k=n.attr("href"))&&k.replace(/.*(?=#[^\s]*$)/,""));var h=l("#"===k?[]:k);w&&w.preventDefault();h.length||(h=n.closest(".alert"));h.trigger(w=l.Event("close.bs.alert"));w.isDefaultPrevented()||(h.removeClass("in"),l.support.transition&&h.hasClass("fade")?
h.one("bsTransitionEnd",u).emulateTransitionEnd(f.TRANSITION_DURATION):u())};var v=l.fn.alert;l.fn.alert=function(w){return this.each(function(){var u=l(this),n=u.data("bs.alert");n||u.data("bs.alert",n=new f(this));"string"==typeof w&&n[w].call(u)})};l.fn.alert.Constructor=f;l.fn.alert.noConflict=function(){l.fn.alert=v;return this};l(document).on("click.bs.alert.data-api",'[data-dismiss="alert"]',f.prototype.close)}(jQuery);
+function(l){function f(f){return this.each(function(){var n=l(this),k=n.data("bs.button"),h="object"==typeof f&&f;k||n.data("bs.button",k=new v(this,h));"toggle"==f?k.toggle():f&&k.setState(f)})}var v=function(f,n){this.$element=l(f);this.options=l.extend({},v.DEFAULTS,n);this.isLoading=!1};v.VERSION="3.3.7";v.DEFAULTS={loadingText:"loading..."};v.prototype.setState=function(f){var n=this.$element,k=n.is("input")?"val":"html",h=n.data();f+="Text";null==h.resetText&&n.data("resetText",n[k]());setTimeout(l.proxy(function(){n[k](null==
h[f]?this.options[f]:h[f]);"loadingText"==f?(this.isLoading=!0,n.addClass("disabled").attr("disabled","disabled").prop("disabled",!0)):this.isLoading&&(this.isLoading=!1,n.removeClass("disabled").removeAttr("disabled").prop("disabled",!1))},this),0)};v.prototype.toggle=function(){var l=!0,f=this.$element.closest('[data-toggle="buttons"]');if(f.length){var k=this.$element.find("input");"radio"==k.prop("type")?(k.prop("checked")&&(l=!1),f.find(".active").removeClass("active"),this.$element.addClass("active")):
"checkbox"==k.prop("type")&&(k.prop("checked")!==this.$element.hasClass("active")&&(l=!1),this.$element.toggleClass("active"));k.prop("checked",this.$element.hasClass("active"));l&&k.trigger("change")}else this.$element.attr("aria-pressed",!this.$element.hasClass("active")),this.$element.toggleClass("active")};var w=l.fn.button;l.fn.button=f;l.fn.button.Constructor=v;l.fn.button.noConflict=function(){l.fn.button=w;return this};l(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(u){var n=
...
+function(l){function f(f){return this.each(function(){var k=l(this),h=k.data("bs.carousel"),c=l.extend({},v.DEFAULTS,k.data(),"object"==typeof f&&f),d="string"==typeof f?f:c.slide;h||k.data("bs.carousel",h=new v(this,c));if("number"==typeof f)h.to(f);else if(d)h[d]();else c.interval&&h.pause().cycle()})}var v=function(f,k){this.$element=l(f);this.$indicators=this.$element.find(".carousel-indicators");this.options=k;this.$items=this.$active=this.interval=this.sliding=this.paused=null;this.options.keyboard&&
this.$element.on("keydown.bs.carousel",l.proxy(this.keydown,this));"hover"!=this.options.pause||"ontouchstart"in document.documentElement||this.$element.on("mouseenter.bs.carousel",l.proxy(this.pause,this)).on("mouseleave.bs.carousel",l.proxy(this.cycle,this))};v.VERSION="3.3.7";v.TRANSITION_DURATION=600;v.DEFAULTS={interval:5E3,pause:"hover",wrap:!0,keyboard:!0};v.prototype.keydown=function(l){if(!/input|textarea/i.test(l.target.tagName)){switch(l.which){case 37:this.prev();break;case 39:this.next();
break;default:return}l.preventDefault()}};v.prototype.cycle=function(f){f||(this.paused=!1);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(l.proxy(this.next,this),this.options.interval));return this};v.prototype.getItemIndex=function(l){this.$items=l.parent().children(".item");return this.$items.index(l||this.$active)};v.prototype.getItemForDirection=function(l,k){var h=this.getItemIndex(k);return("prev"==l&&0===h||"next"==l&&h==this.$items.length-
1)&&!this.options.wrap?k:this.$items.eq((h+("prev"==l?-1:1))%this.$items.length)};v.prototype.to=function(l){var k=this,h=this.getItemIndex(this.$active=this.$element.find(".item.active"));if(!(l>this.$items.length-1||0>l))return this.sliding?this.$element.one("slid.bs.carousel",function(){k.to(l)}):h==l?this.pause().cycle():this.slide(l>h?"next":"prev",this.$items.eq(l))};v.prototype.pause=function(f){f||(this.paused=!0);this.$element.find(".next, .prev").length&&l.support.transition&&(this.$element.trigger(l.support.transition.end),
this.cycle(!0));this.interval=clearInterval(this.interval);return this};v.prototype.next=function(){if(!this.sliding)return this.slide("next")};v.prototype.prev=function(){if(!this.sliding)return this.slide("prev")};v.prototype.slide=function(f,k){var h=this.$element.find(".item.active"),c=k||this.getItemForDirection(f,h),d=this.interval,a="next"==f?"left":"right",e=this;if(c.hasClass("active"))return this.sliding=!1;var m=c[0],x=l.Event("slide.bs.carousel",{relatedTarget:m,direction:a});this.$element.trigger(x);
if(!x.isDefaultPrevented()){this.sliding=!0;d&&this.pause();this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),(x=l(this.$indicators.children()[this.getItemIndex(c)]))&&x.addClass("active"));var q=l.Event("slid.bs.carousel",{relatedTarget:m,direction:a});l.support.transition&&this.$element.hasClass("slide")?(c.addClass(f),c[0].offsetWidth,h.addClass(a),c.addClass(a),h.one("bsTransitionEnd",function(){c.removeClass([f,a].join(" ")).addClass("active");h.removeClass(["active",
a].join(" "));e.sliding=!1;setTimeout(function(){e.$element.trigger(q)},0)}).emulateTransitionEnd(v.TRANSITION_DURATION)):(h.removeClass("active"),c.addClass("active"),this.sliding=!1,this.$element.trigger(q));d&&this.cycle();return this}};var w=l.fn.carousel;l.fn.carousel=f;l.fn.carousel.Constructor=v;l.fn.carousel.noConflict=function(){l.fn.carousel=w;return this};var u=function(n){var k,h=l(this),c=l(h.attr("data-target")||(k=h.attr("href"))&&k.replace(/.*(?=#[^\s]+$)/,""));if(c.hasClass("carousel")){k=
...
if(k&&k.length&&(f=k.data("bs.collapse"))&&f.transitioning)return;var h=l.Event("show.bs.collapse");this.$element.trigger(h);if(!h.isDefaultPrevented()){k&&k.length&&(v.call(k,"hide"),f||k.data("bs.collapse",null));var c=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[c](0).attr("aria-expanded",!0);this.$trigger.removeClass("collapsed").attr("aria-expanded",!0);this.transitioning=1;f=function(){this.$element.removeClass("collapsing").addClass("collapse in")[c]("");this.transitioning=
...
this.options.parent+'"]').each(l.proxy(function(n,k){var h=l(k);this.addAriaAndCollapsedClass(f(h),h)},this)).end()};w.prototype.addAriaAndCollapsedClass=function(l,k){var h=l.hasClass("in");l.attr("aria-expanded",h);k.toggleClass("collapsed",!h).attr("aria-expanded",h)};var u=l.fn.collapse;l.fn.collapse=v;l.fn.collapse.Constructor=w;l.fn.collapse.noConflict=function(){l.fn.collapse=u;return this};l(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(n){var k=l(this);k.attr("data-target")||
n.preventDefault();n=f(k);k=n.data("bs.collapse")?"toggle":k.data();v.call(n,k)})}(jQuery);
+function(l){function f(f){var k=f.attr("data-target");k||(k=(k=f.attr("href"))&&/#[A-Za-z]/.test(k)&&k.replace(/.*(?=#[^\s]*$)/,""));return(k=k&&l(k))&&k.length?k:f.parent()}function v(n){n&&3===n.which||(l(".dropdown-backdrop").remove(),l('[data-toggle="dropdown"]').each(function(){var k=l(this),h=f(k),c={relatedTarget:this};!h.hasClass("open")||n&&"click"==n.type&&/input|textarea/i.test(n.target.tagName)&&l.contains(h[0],n.target)||(h.trigger(n=l.Event("hide.bs.dropdown",c)),n.isDefaultPrevented()||
(k.attr("aria-expanded","false"),h.removeClass("open").trigger(l.Event("hidden.bs.dropdown",c))))}))}var w=function(f){l(f).on("click.bs.dropdown",this.toggle)};w.VERSION="3.3.7";w.prototype.toggle=function(n){var k=l(this);if(!k.is(".disabled, :disabled")){var h=f(k);n=h.hasClass("open");v();if(!n){if("ontouchstart"in document.documentElement&&!h.closest(".navbar-nav").length)l(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(l(this)).on("click",v);var c={relatedTarget:this};
...
k.trigger("click");k=h.find(".dropdown-menu li:not(.disabled):visible a");k.length&&(h=k.index(n.target),38==n.which&&0<h&&h--,40==n.which&&h<k.length-1&&h++,~h||(h=0),k.eq(h).trigger("focus"))}}};var u=l.fn.dropdown;l.fn.dropdown=function(f){return this.each(function(){var k=l(this),h=k.data("bs.dropdown");h||k.data("bs.dropdown",h=new w(this));"string"==typeof f&&h[f].call(k)})};l.fn.dropdown.Constructor=w;l.fn.dropdown.noConflict=function(){l.fn.dropdown=u;return this};l(document).on("click.bs.dropdown.data-api",
v).on("click.bs.dropdown.data-api",".dropdown form",function(l){l.stopPropagation()}).on("click.bs.dropdown.data-api",'[data-toggle="dropdown"]',w.prototype.toggle).on("keydown.bs.dropdown.data-api",'[data-toggle="dropdown"]',w.prototype.keydown).on("keydown.bs.dropdown.data-api",".dropdown-menu",w.prototype.keydown)}(jQuery);
+function(l){function f(f,n){return this.each(function(){var k=l(this),h=k.data("bs.modal"),c=l.extend({},v.DEFAULTS,k.data(),"object"==typeof f&&f);h||k.data("bs.modal",h=new v(this,c));if("string"==typeof f)h[f](n);else c.show&&h.show(n)})}var v=function(f,n){this.options=n;this.$body=l(document.body);this.$element=l(f);this.$dialog=this.$element.find(".modal-dialog");this.originalBodyPad=this.isShown=this.$backdrop=null;this.scrollbarWidth=0;this.ignoreBackdropClick=!1;this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,
l.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};v.VERSION="3.3.7";v.TRANSITION_DURATION=300;v.BACKDROP_TRANSITION_DURATION=150;v.DEFAULTS={backdrop:!0,keyboard:!0,show:!0};v.prototype.toggle=function(f){return this.isShown?this.hide():this.show(f)};v.prototype.show=function(f){var n=this,k=l.Event("show.bs.modal",{relatedTarget:f});this.$element.trigger(k);this.isShown||k.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.setScrollbar(),this.$body.addClass("modal-open"),
...
function(){var w=l.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(w);var u=l.contains(this.$element[0].ownerDocument.documentElement,this.$element[0]);if(!w.isDefaultPrevented()&&u){var n=this,w=this.tip(),u=this.getUID(this.type);this.setContent();w.attr("id",u);this.$element.attr("aria-describedby",u);this.options.animation&&w.addClass("fade");var u="function"==typeof this.options.placement?this.options.placement.call(this,w[0],this.$element[0]):this.options.placement,
k=/\s?auto?\s?/i,h=k.test(u);h&&(u=u.replace(k,"")||"top");w.detach().css({top:0,left:0,display:"block"}).addClass(u).data("bs."+this.type,this);this.options.container?w.appendTo(this.options.container):w.insertAfter(this.$element);this.$element.trigger("inserted.bs."+this.type);var k=this.getPosition(),c=w[0].offsetWidth,d=w[0].offsetHeight;if(h){var h=u,a=this.getPosition(this.$viewport),u="bottom"==u&&k.bottom+d>a.bottom?"top":"top"==u&&k.top-d<a.top?"bottom":"right"==u&&k.right+c>a.width?"left":
"left"==u&&k.left-c<a.left?"right":u;w.removeClass(h).addClass(u)}k=this.getCalculatedOffset(u,k,c,d);this.applyPlacement(k,u);u=function(){var a=n.hoverState;n.$element.trigger("shown.bs."+n.type);n.hoverState=null;"out"==a&&n.leave(n)};l.support.transition&&this.$tip.hasClass("fade")?w.one("bsTransitionEnd",u).emulateTransitionEnd(f.TRANSITION_DURATION):u()}}};f.prototype.applyPlacement=function(f,u){var n=this.tip(),k=n[0].offsetWidth,h=n[0].offsetHeight,c=parseInt(n.css("margin-top"),10),d=parseInt(n.css("margin-left"),
10);isNaN(c)&&(c=0);isNaN(d)&&(d=0);f.top+=c;f.left+=d;l.offset.setOffset(n[0],l.extend({using:function(a){n.css({top:Math.round(a.top),left:Math.round(a.left)})}},f),0);n.addClass("in");var d=n[0].offsetWidth,a=n[0].offsetHeight;"top"==u&&a!=h&&(f.top=f.top+h-a);var e=this.getViewportAdjustedDelta(u,f,d,a);e.left?f.left+=e.left:f.top+=e.top;k=(c=/top|bottom/.test(u))?2*e.left-k+d:2*e.top-h+a;h=c?"offsetWidth":"offsetHeight";n.offset(f);this.replaceArrow(k,n[0][h],c)};f.prototype.replaceArrow=function(f,
l,n){this.arrow().css(n?"left":"top",50*(1-f/l)+"%").css(n?"top":"left","")};f.prototype.setContent=function(){var f=this.tip(),l=this.getTitle();f.find(".tooltip-inner")[this.options.html?"html":"text"](l);f.removeClass("fade in top bottom left right")};f.prototype.hide=function(v){function u(){"in"!=n.hoverState&&k.detach();n.$element&&n.$element.removeAttr("aria-describedby").trigger("hidden.bs."+n.type);v&&v()}var n=this,k=l(this.$tip),h=l.Event("hide.bs."+this.type);this.$element.trigger(h);
if(!h.isDefaultPrevented())return k.removeClass("in"),l.support.transition&&k.hasClass("fade")?k.one("bsTransitionEnd",u).emulateTransitionEnd(f.TRANSITION_DURATION):u(),this.hoverState=null,this};f.prototype.fixTitle=function(){var f=this.$element;(f.attr("title")||"string"!=typeof f.attr("data-original-title"))&&f.attr("data-original-title",f.attr("title")||"").attr("title","")};f.prototype.hasContent=function(){return this.getTitle()};f.prototype.getPosition=function(f){f=f||this.$element;var u=
f[0],n="BODY"==u.tagName,k=u.getBoundingClientRect();null==k.width&&(k=l.extend({},k,{width:k.right-k.left,height:k.bottom-k.top}));u=window.SVGElement&&u instanceof window.SVGElement;u=n?{top:0,left:0}:u?null:f.offset();f={scroll:n?document.documentElement.scrollTop||document.body.scrollTop:f.scrollTop()};n=n?{width:l(window).width(),height:l(window).height()}:null;return l.extend({},k,f,n,u)};f.prototype.getCalculatedOffset=function(f,l,n,k){return"bottom"==f?{top:l.top+l.height,left:l.left+l.width/
2-n/2}:"top"==f?{top:l.top-k,left:l.left+l.width/2-n/2}:"left"==f?{top:l.top+l.height/2-k/2,left:l.left-n}:{top:l.top+l.height/2-k/2,left:l.left+l.width}};f.prototype.getViewportAdjustedDelta=function(f,l,n,k){var h={top:0,left:0};if(!this.$viewport)return h;var c=this.options.viewport&&this.options.viewport.padding||0,d=this.getPosition(this.$viewport);/right|left/.test(f)?(n=l.top-c-d.scroll,l=l.top+c-d.scroll+k,n<d.top?h.top=d.top-n:l>d.top+d.height&&(h.top=d.top+d.height-l)):(k=l.left-c,l=l.left+
c+n,k<d.left?h.left=d.left-k:l>d.right&&(h.left=d.left+d.width-l));return h};f.prototype.getTitle=function(){var f=this.$element,l=this.options;return f.attr("data-original-title")||("function"==typeof l.title?l.title.call(f[0]):l.title)};f.prototype.getUID=function(f){do f+=~~(1E6*Math.random());while(document.getElementById(f));return f};f.prototype.tip=function(){if(!this.$tip&&(this.$tip=l(this.options.template),1!=this.$tip.length))throw Error(this.type+" `template` option must consist of exactly 1 top-level element!");
return this.$tip};f.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")};f.prototype.enable=function(){this.enabled=!0};f.prototype.disable=function(){this.enabled=!1};f.prototype.toggleEnabled=function(){this.enabled=!this.enabled};f.prototype.toggle=function(f){var u=this;f&&(u=l(f.currentTarget).data("bs."+this.type),u||(u=new this.constructor(f.currentTarget,this.getDelegateOptions()),l(f.currentTarget).data("bs."+this.type,u)));f?(u.inState.click=!u.inState.click,
u.isInStateTrue()?u.enter(u):u.leave(u)):u.tip().hasClass("in")?u.leave(u):u.enter(u)};f.prototype.destroy=function(){var f=this;clearTimeout(this.timeout);this.hide(function(){f.$element.off("."+f.type).removeData("bs."+f.type);f.$tip&&f.$tip.detach();f.$tip=null;f.$arrow=null;f.$viewport=null;f.$element=null})};var v=l.fn.tooltip;l.fn.tooltip=function(v){return this.each(function(){var u=l(this),n=u.data("bs.tooltip"),k="object"==typeof v&&v;if(n||!/destroy|hide/.test(v))if(n||u.data("bs.tooltip",
n=new f(this,k)),"string"==typeof v)n[v]()})};l.fn.tooltip.Constructor=f;l.fn.tooltip.noConflict=function(){l.fn.tooltip=v;return this}}(jQuery);
...
l=this.options;return f.attr("data-content")||("function"==typeof l.content?l.content.call(f[0]):l.content)};f.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};var v=l.fn.popover;l.fn.popover=function(v){return this.each(function(){var u=l(this),n=u.data("bs.popover"),k="object"==typeof v&&v;if(n||!/destroy|hide/.test(v))if(n||u.data("bs.popover",n=new f(this,k)),"string"==typeof v)n[v]()})};l.fn.popover.Constructor=f;l.fn.popover.noConflict=function(){l.fn.popover=
v;return this}}(jQuery);
+function(l){function f(u,n){this.$body=l(document.body);this.$scrollElement=l(u).is(document.body)?l(window):l(u);this.options=l.extend({},f.DEFAULTS,n);this.selector=(this.options.target||"")+" .nav li > a";this.offsets=[];this.targets=[];this.activeTarget=null;this.scrollHeight=0;this.$scrollElement.on("scroll.bs.scrollspy",l.proxy(this.process,this));this.refresh();this.process()}function v(u){return this.each(function(){var n=l(this),k=n.data("bs.scrollspy"),h="object"==typeof u&&u;k||n.data("bs.scrollspy",
...
l(this),h=h.data("target")||h.attr("href"),c=/^#./.test(h)&&l(h);return c&&c.length&&c.is(":visible")&&[[c[n]().top+k,h]]||null}).sort(function(h,c){return h[0]-c[0]}).each(function(){f.offsets.push(this[0]);f.targets.push(this[1])})};f.prototype.process=function(){var f=this.$scrollElement.scrollTop()+this.options.offset,l=this.getScrollHeight(),k=this.options.offset+l-this.$scrollElement.height(),h=this.offsets,c=this.targets,d=this.activeTarget,a;this.scrollHeight!=l&&this.refresh();if(f>=k)return d!=
(a=c[c.length-1])&&this.activate(a);if(d&&f<h[0])return this.activeTarget=null,this.clear();for(a=h.length;a--;)d!=c[a]&&f>=h[a]&&(void 0===h[a+1]||f<h[a+1])&&this.activate(c[a])};f.prototype.activate=function(f){this.activeTarget=f;this.clear();f=l(this.selector+'[data-target="'+f+'"],'+this.selector+'[href="'+f+'"]').parents("li").addClass("active");f.parent(".dropdown-menu").length&&(f=f.closest("li.dropdown").addClass("active"));f.trigger("activate.bs.scrollspy")};f.prototype.clear=function(){l(this.selector).parentsUntil(this.options.target,
".active").removeClass("active")};var w=l.fn.scrollspy;l.fn.scrollspy=v;l.fn.scrollspy.Constructor=f;l.fn.scrollspy.noConflict=function(){l.fn.scrollspy=w;return this};l(window).on("load.bs.scrollspy.data-api",function(){l('[data-spy="scroll"]').each(function(){var f=l(this);v.call(f,f.data())})})}(jQuery);
+function(l){function f(f){return this.each(function(){var k=l(this),h=k.data("bs.tab");h||k.data("bs.tab",h=new v(this));if("string"==typeof f)h[f]()})}var v=function(f){this.element=l(f)};v.VERSION="3.3.7";v.TRANSITION_DURATION=150;v.prototype.show=function(){var f=this.element,k=f.closest("ul:not(.dropdown-menu)"),h=f.data("target");h||(h=(h=f.attr("href"))&&h.replace(/.*(?=#[^\s]*$)/,""));if(!f.parent("li").hasClass("active")){var c=k.find(".active:last a"),d=l.Event("hide.bs.tab",{relatedTarget:f[0]}),
a=l.Event("show.bs.tab",{relatedTarget:c[0]});c.trigger(d);f.trigger(a);a.isDefaultPrevented()||d.isDefaultPrevented()||(h=l(h),this.activate(f.closest("li"),k),this.activate(h,h.parent(),function(){c.trigger({type:"hidden.bs.tab",relatedTarget:f[0]});f.trigger({type:"shown.bs.tab",relatedTarget:c[0]})}))}};v.prototype.activate=function(f,k,h){function c(){d.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1);f.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",
!0);a?(f[0].offsetWidth,f.addClass("in")):f.removeClass("fade");f.parent(".dropdown-menu").length&&f.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0);h&&h()}var d=k.find("> .active"),a=h&&l.support.transition&&(d.length&&d.hasClass("fade")||!!k.find("> .fade").length);d.length&&a?d.one("bsTransitionEnd",c).emulateTransitionEnd(v.TRANSITION_DURATION):c();d.removeClass("in")};var w=l.fn.tab;l.fn.tab=f;l.fn.tab.Constructor=v;l.fn.tab.noConflict=function(){l.fn.tab=
w;return this};var u=function(n){n.preventDefault();f.call(l(this),"show")};l(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',u).on("click.bs.tab.data-api",'[data-toggle="pill"]',u)}(jQuery);
+function(l){function f(f){return this.each(function(){var n=l(this),k=n.data("bs.affix"),h="object"==typeof f&&f;k||n.data("bs.affix",k=new v(this,h));if("string"==typeof f)k[f]()})}var v=function(f,n){this.options=l.extend({},v.DEFAULTS,n);this.$target=l(this.options.target).on("scroll.bs.affix.data-api",l.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",l.proxy(this.checkPositionWithEventLoop,this));this.$element=l(f);this.pinnedOffset=this.unpin=this.affixed=null;this.checkPosition()};
v.VERSION="3.3.7";v.RESET="affix affix-top affix-bottom";v.DEFAULTS={offset:0,target:window};v.prototype.getState=function(f,l,k,h){var c=this.$target.scrollTop(),d=this.$element.offset(),a=this.$target.height();if(null!=k&&"top"==this.affixed)return c<k?"top":!1;if("bottom"==this.affixed)return null!=k?c+this.unpin<=d.top?!1:"bottom":c+a<=f-h?!1:"bottom";var e=null==this.affixed,d=e?c:d.top;return null!=k&&c<=k?"top":null!=h&&d+(e?a:l)>=f-h?"bottom":!1};v.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;
this.$element.removeClass(v.RESET).addClass("affix");var f=this.$target.scrollTop();return this.pinnedOffset=this.$element.offset().top-f};v.prototype.checkPositionWithEventLoop=function(){setTimeout(l.proxy(this.checkPosition,this),1)};v.prototype.checkPosition=function(){if(this.$element.is(":visible")){var f=this.$element.height(),n=this.options.offset,k=n.top,h=n.bottom,c=Math.max(l(document).height(),l(document.body).height());"object"!=typeof n&&(h=k=n);"function"==typeof k&&(k=n.top(this.$element));
"function"==typeof h&&(h=n.bottom(this.$element));n=this.getState(c,f,k,h);if(this.affixed!=n){null!=this.unpin&&this.$element.css("top","");var k="affix"+(n?"-"+n:""),d=l.Event(k+".bs.affix");this.$element.trigger(d);if(d.isDefaultPrevented())return;this.affixed=n;this.unpin="bottom"==n?this.getPinnedOffset():null;this.$element.removeClass(v.RESET).addClass(k).trigger(k.replace("affix","affixed")+".bs.affix")}"bottom"==n&&this.$element.offset({top:c-f-h})}};var w=l.fn.affix;l.fn.affix=f;l.fn.affix.Constructor=
v;l.fn.affix.noConflict=function(){l.fn.affix=w;return this};l(window).on("load",function(){l('[data-spy="affix"]').each(function(){var u=l(this),n=u.data();n.offset=n.offset||{};null!=n.offsetBottom&&(n.offset.bottom=n.offsetBottom);null!=n.offsetTop&&(n.offset.top=n.offsetTop);f.call(u,n)})})}(jQuery);(function(l){l(["jquery"],function(f){return function(){function l(a,c){a||(a=n());h=f("#"+a.containerId);if(h.length)return h;if(c){var e=a;h=f("<div/>").attr("id",e.containerId).addClass(e.positionClass).attr("aria-live","polite").attr("role","alert");h.appendTo(f(e.target))}return h}function w(a,c,e){e=e&&e.force?e.force:!1;return a&&(e||0===f(":focus",a).length)?(a[c.hideMethod]({duration:c.hideDuration,easing:c.hideEasing,complete:function(){k(a)}}),!0):!1}function u(a){function m(a){if(!f(":focus",
w).length||a)return clearTimeout(C.intervalId),w[A.hideMethod]({duration:A.hideDuration,easing:A.hideEasing,complete:function(){k(w);if(A.onHidden&&"hidden"!==D.state)A.onHidden();D.state="hidden";D.endTime=new Date;c&&c(D)}})}function q(){if(0<A.timeOut||0<A.extendedTimeOut)B=setTimeout(m,A.extendedTimeOut),C.maxHideTime=parseFloat(A.extendedTimeOut),C.hideEta=(new Date).getTime()+C.maxHideTime}function z(){clearTimeout(B);C.hideEta=0;w.stop(!0,!0)[A.showMethod]({duration:A.showDuration,easing:A.showEasing})}
function t(){var a=(C.hideEta-(new Date).getTime())/C.maxHideTime*100;E.width(a+"%")}var A=n(),u=a.iconClass||A.iconClass;"undefined"!==typeof a.optionsOverride&&(A=f.extend(A,a.optionsOverride),u=a.optionsOverride.iconClass||u);a:{if(A.preventDuplicates)if(a.message===e){var v=!0;break a}else e=a.message;v=!1}if(!v){d++;h=l(A,!0);var B=null,w=f("<div/>");v=f("<div/>");var G=f("<div/>"),E=f("<div/>"),F=f(A.closeHtml),C={intervalId:null,hideEta:null,maxHideTime:null},D={toastId:d,state:"visible",startTime:new Date,
options:A,map:a};a.iconClass&&w.addClass(A.toastClass).addClass(u);a.title&&(v.append(a.title).addClass(A.titleClass),w.append(v));a.message&&(G.append(a.message).addClass(A.messageClass),w.append(G));A.closeButton&&(F.addClass("toast-close-button").attr("role","button"),w.prepend(F));A.progressBar&&(E.addClass("toast-progress"),w.prepend(E));A.newestOnTop?h.prepend(w):h.append(w);w.hide();w[A.showMethod]({duration:A.showDuration,easing:A.showEasing,complete:A.onShown});0<A.timeOut&&(B=setTimeout(m,
A.timeOut),C.maxHideTime=parseFloat(A.timeOut),C.hideEta=(new Date).getTime()+C.maxHideTime,A.progressBar&&(C.intervalId=setInterval(t,10)));(function(){w.hover(z,q);!A.onclick&&A.tapToDismiss&&w.click(m);A.closeButton&&F&&F.click(function(a){a.stopPropagation?a.stopPropagation():void 0!==a.cancelBubble&&!0!==a.cancelBubble&&(a.cancelBubble=!0);m(!0)});A.onclick&&w.click(function(){A.onclick();m()})})();c&&c(D);A.debug&&console&&console.log(D);return w}}function n(){return f.extend({},{tapToDismiss:!0,
...
f){"undefined"!==typeof module&&module.exports?module.exports=f(require("jquery")):window.toastr=f(window.jQuery)});/*
 ...
 Licensed MIT
*/
(function(l){"function"===typeof define&&define.amd?define(["jquery"],l):"object"===typeof module&&"object"===typeof module.exports?module.exports=l(require("jquery")):l(jQuery)})(function(l){function f(a){if(h||a)h&&a&&(l(document).unbind(".smartmenus_mouse"),h=!1);else{var c=!0,d=null;l(document).bind(v([["mousemove",function(a){var e={x:a.pageX,y:a.pageY,timeStamp:(new Date).getTime()};if(d){var h=Math.abs(d.x-e.x),m=Math.abs(d.y-e.y);if((0<h||0<m)&&2>=h&&2>=m&&300>=e.timeStamp-d.timeStamp&&(n=
!0,c)){var f=l(a.target).closest("a");f.is("a")&&l.each(w,function(){if(l.contains(this.$root[0],f[0]))return this.itemEnter({currentTarget:f[0]}),!1});c=!1}}d=e}],[k?"touchstart":"pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut",function(a){/^(4|mouse)$/.test(a.originalEvent.pointerType)||(n=!1)}]],".smartmenus_mouse"));h=!0}}function v(a,c){c||(c="");var e={};l.each(a,function(a,d){e[d[0].split(" ").join(c+" ")+c]=d[1]});return e}var w=[],u=!!window.createPopup,n=!1,
...
!0),a=".smartmenus",this.$root.data("smartmenus",this).attr("data-smartmenus-id",this.rootId).dataSM("level",1).bind(v([["mouseover focusin",l.proxy(this.rootOver,this)],["mouseout focusout",l.proxy(this.rootOut,this)],["keydown",l.proxy(this.rootKeyDown,this)]],a)).delegate("a",v([["mouseenter",l.proxy(this.itemEnter,this)],["mouseleave",l.proxy(this.itemLeave,this)],["mousedown",l.proxy(this.itemDown,this)],["focus",l.proxy(this.itemFocus,this)],["blur",l.proxy(this.itemBlur,this)],["click",l.proxy(this.itemClick,
this)]],a)),a+=this.rootId,this.opts.hideOnClick&&l(document).bind(v([["touchstart",l.proxy(this.docTouchStart,this)],["touchmove",l.proxy(this.docTouchMove,this)],["touchend",l.proxy(this.docTouchEnd,this)],["click",l.proxy(this.docClick,this)]],a)),l(window).bind(v([["resize orientationchange",l.proxy(this.winResize,this)]],a)),this.opts.subIndicators&&(this.$subArrow=l("<span/>").addClass("sub-arrow"),this.opts.subIndicatorsText&&this.$subArrow.html(this.opts.subIndicatorsText)),f());this.$firstSub=
...
this.$root[0];)c++;d=a.prevAll("a").eq(-1);d.length||(d=a.prevAll().find("a").eq(-1));d.addClass("has-submenu").dataSM("sub",a);a.dataSM("parent-a",d).dataSM("level",c).parent().dataSM("sub",a);var c=d.attr("id")||this.accessIdPrefix+ ++this.idInc,h=a.attr("id")||this.accessIdPrefix+ ++this.idInc;d.attr({id:c,"aria-haspopup":"true","aria-controls":h,"aria-expanded":"false"});a.attr({id:h,role:"group","aria-hidden":"true","aria-labelledby":c,"aria-expanded":"false"});if(this.opts.subIndicators)d[this.opts.subIndicatorsPos](this.$subArrow.clone())}},
menuPosition:function(a){var c=a.dataSM("parent-a"),d=c.closest("li"),h=d.parent(),f=a.dataSM("level"),z=this.getWidth(a),t=this.getHeight(a),A=c.offset(),n=A.left,u=A.top,A=this.getWidth(c),c=this.getHeight(c),B=l(window),w=B.scrollLeft(),B=B.scrollTop(),G=this.getViewportWidth(),E=this.getViewportHeight(),h=h.parent().is("[data-sm-horizontal-sub]")||2==f&&!h.hasClass("sm-vertical"),d=this.opts.rightToLeftSubMenus&&!d.is("[data-sm-reverse]")||!this.opts.rightToLeftSubMenus&&d.is("[data-sm-reverse]"),
F=2==f?this.opts.mainMenuSubOffsetX:this.opts.subMenusSubOffsetX,C=2==f?this.opts.mainMenuSubOffsetY:this.opts.subMenusSubOffsetY;h?(f=d?A-z-F:F,C=this.opts.bottomToTopSubMenus?-t-C:c+C):(f=d?F-z:A-F,C=this.opts.bottomToTopSubMenus?c-C-t:C);if(this.opts.keepInViewport){n+=f;u+=C;d&&n<w?f=h?w-n+f:A-F:!d&&n+z>w+G&&(f=h?w+G-z-n+f:F-z);if(!h)if(t<E&&u+t>B+E)C+=B+E-t-u;else if(t>=E||u<B)C+=B-u;if(h&&(u+t>B+E+.49||u<B)||!h&&t>E+.49){var D=this;a.dataSM("scroll-arrows")||a.dataSM("scroll-arrows",l([l('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0],
l('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0]]).bind({mouseenter:function(){a.dataSM("scroll").up=l(this).hasClass("scroll-up");D.menuScroll(a)},mouseleave:function(c){D.menuScrollStop(a);D.menuScrollOut(a,c)},"mousewheel DOMMouseScroll":function(a){a.preventDefault()}}).insertAfter(a));a.dataSM("scroll",{y:this.cssTransforms3d?0:C-c,step:1,itemH:c,subH:t,arrowDownH:this.getHeight(a.dataSM("scroll-arrows").eq(1))}).bind(v([["mouseover",function(c){D.menuScrollOver(a,
c)}],["mouseout",function(c){D.menuScrollOut(a,c)}],["mousewheel DOMMouseScroll",function(c){D.menuScrollMousewheel(a,c)}]],".smartmenus_scroll")).dataSM("scroll-arrows").css({top:"auto",left:"0",marginLeft:f+(parseInt(a.css("border-left-width"))||0),width:z-(parseInt(a.css("border-left-width"))||0)-(parseInt(a.css("border-right-width"))||0),zIndex:a.css("z-index")}).eq(h&&this.opts.bottomToTopSubMenus?0:1).show();this.isFixed()&&a.css({"touch-action":"none","-ms-touch-action":"none"}).bind(v([[k?
"touchstart touchmove touchend":"pointerdown pointermove pointerup MSPointerDown MSPointerMove MSPointerUp",function(c){D.menuScrollTouch(a,c)}]],".smartmenus_scroll"))}}a.css({top:"auto",left:"0",marginLeft:f,marginTop:C-c});this.menuIframeShim(a);a.dataSM("ie-shim")&&a.dataSM("ie-shim").css({zIndex:a.css("z-index"),width:z,height:t,marginLeft:f,marginTop:C-c})},menuScroll:function(a,e,d){var h=a.dataSM("scroll"),m=a.dataSM("scroll-arrows"),f=h.up?h.upEnd:h.downEnd;if(!e&&h.momentum){if(h.momentum*=
.92,d=h.momentum,.5>d){this.menuScrollStop(a);return}}else d=d||(e||!this.opts.scrollAccelerate?this.opts.scrollStep:Math.floor(h.step));var t=a.dataSM("level");this.activatedItems[t-1]&&this.activatedItems[t-1].dataSM("sub")&&this.activatedItems[t-1].dataSM("sub").is(":visible")&&this.menuHideSubMenus(t-1);h.y=h.up&&f<=h.y||!h.up&&f>=h.y?h.y:Math.abs(f-h.y)>d?h.y+(h.up?d:-d):f;a.add(a.dataSM("ie-shim")).css(this.cssTransforms3d?{"-webkit-transform":"translate3d(0, "+h.y+"px, 0)",transform:"translate3d(0, "+
h.y+"px, 0)"}:{marginTop:h.y});n&&(h.up&&h.y>h.downEnd||!h.up&&h.y<h.upEnd)&&m.eq(h.up?1:0).show();if(h.y==f)n&&m.eq(h.up?0:1).hide(),this.menuScrollStop(a);else if(!e){this.opts.scrollAccelerate&&h.step<this.opts.scrollStep&&(h.step+=.2);var k=this;this.scrollTimeout=c(function(){k.menuScroll(a)})}},menuScrollMousewheel:function(a,c){if(this.getClosestMenu(c.target)==a[0]){c=c.originalEvent;var e=0<(c.wheelDelta||-c.detail);a.dataSM("scroll-arrows").eq(e?0:1).is(":visible")&&(a.dataSM("scroll").up=
...
showTimeout:250,hideTimeout:500,showDuration:0,showFunction:null,hideDuration:0,hideFunction:function(a,c){a.fadeOut(200,c)},collapsibleShowDuration:0,collapsibleShowFunction:function(a,c){a.slideDown(200,c)},collapsibleHideDuration:0,collapsibleHideFunction:function(a,c){a.slideUp(200,c)},showOnClick:!1,hideOnClick:!0,noMouseOver:!1,keepInViewport:!0,keepHighlighted:!0,markCurrentItem:!1,markCurrentTree:!0,rightToLeftSubMenus:!1,bottomToTopSubMenus:!1,overlapControlsInIE:!0};return l});/*
 ...
 Licensed MIT
*/
(function(l){"function"===typeof define&&define.amd?define(["jquery","jquery.smartmenus"],l):"object"===typeof module&&"object"===typeof module.exports?module.exports=l(require("jquery")):l(jQuery)})(function(l){l.extend(l.SmartMenus.Bootstrap={},{keydownFix:!1,init:function(){var f=l("ul.navbar-nav:not([data-sm-skip])");f.each(function(){var f=l(this),w=f.data("smartmenus");if(!w){var u=function(c){var d=w.getViewportWidth();if(d!=h||c)c=f.find(".caret"),w.isCollapsible()?(f.addClass("sm-collapsible"),
...
d){var a=l(d),e=a.dataSM("scroll-arrows");e&&e.css("background-color",l(document.body).css("background-color"));a.parent().addClass("open")},"hide.smapi":function(c,d){l(d).parent().removeClass("open")}});k();w=f.data("smartmenus");w.isCollapsible=function(){return!/^(left|right)$/.test(this.$firstLink.parent().css("float"))};w.refresh=function(){l.SmartMenus.prototype.refresh.call(this);k();u(!0)};w.destroy=function(c){n();l.SmartMenus.prototype.destroy.call(this,c)};f.is("[data-sm-skip-collapsible-behavior]")&&
f.bind({"click.smapi":function(c,d){if(w.isCollapsible()){var a=l(d),e=a.parent().dataSM("sub");if(e&&e.dataSM("shown-before")&&e.is(":visible"))return w.itemActivate(a),w.menuHide(e),!1}}});var h;u();l(window).bind("resize.smartmenus"+w.rootId,u)}});if(f.length&&!l.SmartMenus.Bootstrap.keydownFix){l(document).off("keydown.bs.dropdown.data-api",".dropdown-menu");if(l.fn.dropdown&&l.fn.dropdown.Constructor)l(document).on("keydown.bs.dropdown.data-api",'.dropdown-menu:not([id^="sm-"])',l.fn.dropdown.Constructor.prototype.keydown);
l.SmartMenus.Bootstrap.keydownFix=!0}}});l(l.SmartMenus.Bootstrap.init);return l});/*
 ...
 Rev:  1.0.01
*/
(function(l){l.marquee={version:"1.0.01"};l.fn.marquee=function(f){var v="string"==typeof arguments[0]&&arguments[0],w=v&&Array.prototype.slice.call(arguments,1)||arguments,u=0==this.length?null:l.data(this[0],"marquee");if(u&&v&&this.length){if("object"==v.toLowerCase())return u;if(u[v]){var n;this.each(function(f){var h=l.data(this,"marquee")[v].apply(u,w);if(0==f&&h)if(h.jquery)n=l([]).add(h);else return n=h,!1;else h&&h.jquery&&(n=n.add(h))});return n||this}return this}return this.each(function(){new l.Marquee(this,
f)})};l.Marquee=function(f,v){function w(c){if(0<e.filter("."+v.cssShowing).length)return!1;var h=e.eq(c);l.isFunction(v.beforeshow)&&v.beforeshow.apply(d,[a,h]);c={top:("top"==v.yScroll?"-":"+")+h.outerHeight()+"px",left:0};a.data("marquee.showing",!0);h.addClass(v.cssShowing);h.css(c).animate({top:"0px"},v.showSpeed,v.fxEasingShow,function(){l.isFunction(v.show)&&v.show.apply(d,[a,h]);a.data("marquee.showing",!1);u(h)})}function u(c,d){if(1==q)return!1;d=d||v.pauseSpeed;c.outerWidth()>a.innerWidth()?
setTimeout(function(){if(1==q)return!1;var a=c.outerWidth(),e=-1*a,d=parseInt(c.css("left"),10);c.animate({left:e+"px"},(a+d)*v.scrollSpeed,v.fxEasingScroll,function(){n(c)})},d):1<e.length&&setTimeout(function(){if(1==q)return!1;c.animate({top:("top"==v.yScroll?"+":"-")+a.innerHeight()+"px"},v.showSpeed,v.fxEasingScroll);n(c)},d)}function n(e){l.isFunction(v.aftershow)&&v.aftershow.apply(d,[a,e]);e.removeClass(v.cssShowing);c()}function k(){q=!0;1!=a.data("marquee.showing")&&e.filter("."+v.cssShowing).dequeue().stop()}
function h(){q=!1;1!=a.data("marquee.showing")&&u(e.filter("."+v.cssShowing),1)}function c(){m++;if(m>=e.length){if(!isNaN(v.loop)&&0<v.loop&&++z>=v.loop)return!1;m=0}w(m)}v=l.extend({},l.Marquee.defaults,v);var d=this,a=l(f),e=a.find("> li"),m=-1,x=!1,q=!1,z=0;l.data(a[0],"marquee",d);this.pause=function(){x=!0;k()};this.resume=function(){x=!1;h()};this.update=function(){var c=e.length;e=a.find("> li");1>=c&&h()};v.pauseOnHover&&a.hover(function(){if(x)return!1;k()},function(){if(x)return!1;h()});
l.isFunction(v.init)&&v.init.apply(d,[a,v]);c()};l.Marquee.defaults={yScroll:"top",showSpeed:850,scrollSpeed:12,pauseSpeed:5E3,pauseOnHover:!0,loop:-1,fxEasingShow:"swing",fxEasingScroll:"linear",cssShowing:"marquee-showing",init:null,beforeshow:null,show:null,aftershow:null}})(jQuery);/*
 Magnific Popup - v1.1.0 - 2016-02-20
 http://dimsemenov.com/plugins/magnific-popup/
 Copyright (c) 2016 Dmitry Semenov; */
(function(l){"function"===typeof define&&define.amd?define(["jquery"],l):"object"===typeof exports?l(require("jquery")):l(window.jQuery||window.Zepto)})(function(l){var f,v=function(){},w=!!window.jQuery,u,n=l(window),k,h,c,d,a=function(a,c){f.ev.on("mfp"+a+".mfp",c)},e=function(a,c,e,d){var h=document.createElement("div");h.className="mfp-"+a;e&&(h.innerHTML=e);d?c&&c.appendChild(h):(h=l(h),c&&h.appendTo(c));return h},m=function(a,c){f.ev.triggerHandler("mfp"+a,c);f.st.callbacks&&(a=a.charAt(0).toLowerCase()+
a.slice(1),f.st.callbacks[a]&&f.st.callbacks[a].apply(f,l.isArray(c)?c:[c]))},x=function(a){a===d&&f.currTemplate.closeBtn||(f.currTemplate.closeBtn=l(f.st.closeMarkup.replace("%title%",f.st.tClose)),d=a);return f.currTemplate.closeBtn},q=function(){l.magnificPopup.instance||(f=new v,f.init(),l.magnificPopup.instance=f)},z=function(){var a=document.createElement("p").style,c=["ms","O","Moz","Webkit"];if(void 0!==a.transition)return!0;for(;c.length;)if(c.pop()+"Transition"in a)return!0;return!1};v.prototype=
{constructor:v,init:function(){var a=navigator.appVersion;f.isLowIE=f.isIE8=document.all&&!document.addEventListener;f.isAndroid=/android/gi.test(a);f.isIOS=/iphone|ipad|ipod/gi.test(a);f.supportsTransition=z();f.probablyMobile=f.isAndroid||f.isIOS||/(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent);k=l(document);f.popupsCache={}},open:function(d){var h;if(!1===d.isObj){f.items=d.items.toArray();f.index=0;var t=d.items;for(h=0;h<t.length;h++){var q=
t[h];q.parsed&&(q=q.el[0]);if(q===d.el[0]){f.index=h;break}}}else f.items=l.isArray(d.items)?d.items:[d.items],f.index=d.index||0;if(f.isOpen)f.updateItemHTML();else{f.types=[];c="";f.ev=d.mainEl&&d.mainEl.length?d.mainEl.eq(0):k;d.key?(f.popupsCache[d.key]||(f.popupsCache[d.key]={}),f.currTemplate=f.popupsCache[d.key]):f.currTemplate={};f.st=l.extend(!0,{},l.magnificPopup.defaults,d);f.fixedContentPos="auto"===f.st.fixedContentPos?!f.probablyMobile:f.st.fixedContentPos;f.st.modal&&(f.st.closeOnContentClick=
!1,f.st.closeOnBgClick=!1,f.st.showCloseBtn=!1,f.st.enableEscapeKey=!1);f.bgOverlay||(f.bgOverlay=e("bg").on("click.mfp",function(){f.close()}),f.wrap=e("wrap").attr("tabindex",-1).on("click.mfp",function(a){f._checkIfClose(a.target)&&f.close()}),f.container=e("container",f.wrap));f.contentContainer=e("content");f.st.preloader&&(f.preloader=e("preloader",f.container,f.st.tLoading));t=l.magnificPopup.modules;for(h=0;h<t.length;h++)q=t[h],q=q.charAt(0).toUpperCase()+q.slice(1),f["init"+q].call(f);m("BeforeOpen");
f.st.showCloseBtn&&(f.st.closeBtnInside?(a("MarkupParse",function(a,c,e,d){e.close_replaceWith=x(d.type)}),c+=" mfp-close-btn-in"):f.wrap.append(x()));f.st.alignTop&&(c+=" mfp-align-top");f.fixedContentPos?f.wrap.css({overflow:f.st.overflowY,overflowX:"hidden",overflowY:f.st.overflowY}):f.wrap.css({top:n.scrollTop(),position:"absolute"});(!1===f.st.fixedBgPos||"auto"===f.st.fixedBgPos&&!f.fixedContentPos)&&f.bgOverlay.css({height:k.height(),position:"absolute"});if(f.st.enableEscapeKey)k.on("keyup.mfp",
function(a){27===a.keyCode&&f.close()});n.on("resize.mfp",function(){f.updateSize()});f.st.closeOnContentClick||(c+=" mfp-auto-cursor");c&&f.wrap.addClass(c);h=f.wH=n.height();t={};f.fixedContentPos&&f._hasScrollBar(h)&&(q=f._getScrollbarSize())&&(t.marginRight=q);f.fixedContentPos&&(f.isIE7?l("body, html").css("overflow","hidden"):t.overflow="hidden");q=f.st.mainClass;f.isIE7&&(q+=" mfp-ie7");q&&f._addClassToMFP(q);f.updateItemHTML();m("BuildControls");l("html").css(t);f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo||
...
a){var e=w?c.data("magnificPopup"):c[0].magnificPopup,d=parseInt(arguments[1],10)||0;if(e.items)var h=e.items[d];else h=c,e.delegate&&(h=h.find(e.delegate)),h=h.eq(d);f._openClick({mfpEl:h},c,e)}else f.isOpen&&f[a].apply(f,Array.prototype.slice.call(arguments,1));else a=l.extend(!0,{},a),w?c.data("magnificPopup",a):c[0].magnificPopup=a,f.addGroup(c,a);return c};var t,A,K,N=function(){K&&(A.after(K.addClass(t)).detach(),K=null)};l.magnificPopup.registerModule("inline",{options:{hiddenClass:"hide",
markup:"",tNotFound:"Content not found"},proto:{initInline:function(){f.types.push("inline");a("Close.inline",function(){N()})},getInline:function(a,c){N();if(a.src){var d=f.st.inline,h=l(a.src);if(h.length){var m=h[0].parentNode;m&&m.tagName&&(A||(t=d.hiddenClass,A=e(t),t="mfp-"+t),K=h.after(A).detach().removeClass(t));f.updateStatus("ready")}else f.updateStatus("error",d.tNotFound),h=l("<div>");return a.inlineElement=h}f.updateStatus("ready");f._parseMarkup(c,{},a);return c}}});var B,I=function(){B&&
l(document.body).removeClass(B)},G=function(){I();f.req&&f.req.abort()};l.magnificPopup.registerModule("ajax",{options:{settings:null,cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){f.types.push("ajax");B=f.st.ajax.cursor;a("Close.ajax",G);a("BeforeChange.ajax",G)},getAjax:function(a){B&&l(document.body).addClass(B);f.updateStatus("loading");var c=l.extend({url:a.src,success:function(c,e,d){c={data:c,xhr:d};m("ParseAjax",c);f.appendContent(l(c.data),
"ajax");a.finished=!0;I();f._setFocus();setTimeout(function(){f.wrap.addClass("mfp-ready")},16);f.updateStatus("ready");m("AjaxContentAdded")},error:function(){I();a.finished=a.loadError=!0;f.updateStatus("error",f.st.ajax.tError.replace("%url%",a.src))}},f.st.ajax.settings);f.req=l.ajax(c);return""}}});var E,F=function(a){if(a.data&&void 0!==a.data.title)return a.data.title;var c=f.st.image.titleSrc;if(c){if(l.isFunction(c))return c.call(f,a);if(a.el)return a.el.attr(c)||""}return""};l.magnificPopup.registerModule("image",
...
a("Close.image",function(){c.cursor&&l(document.body).removeClass(c.cursor);n.off("resize.mfp")});a("Resize.image",f.resizeImage);f.isLowIE&&a("AfterChange",f.resizeImage)},resizeImage:function(){var a=f.currItem;if(a&&a.img&&f.st.image.verticalFit){var c=0;f.isLowIE&&(c=parseInt(a.img.css("padding-top"),10)+parseInt(a.img.css("padding-bottom"),10));a.img.css("max-height",f.wH-c)}},_onImageHasSize:function(a){a.img&&(a.hasSize=!0,E&&clearInterval(E),a.isCheckingImgSize=!1,m("ImageHasSize",a),a.imgHidden&&
(f.content&&f.content.removeClass("mfp-loading"),a.imgHidden=!1))},findImageSize:function(a){var c=0,e=a.img[0],d=function(h){E&&clearInterval(E);E=setInterval(function(){0<e.naturalWidth?f._onImageHasSize(a):(200<c&&clearInterval(E),c++,3===c?d(10):40===c?d(50):100===c&&d(500))},h)};d(1)},getImage:function(a,c){var e=0,d=function(){a&&(a.img[0].complete?(a.img.off(".mfploader"),a===f.currItem&&(f._onImageHasSize(a),f.updateStatus("ready")),a.hasSize=!0,a.loaded=!0,m("ImageLoadComplete")):(e++,200>
e?setTimeout(d,100):h()))},h=function(){a&&(a.img.off(".mfploader"),a===f.currItem&&(f._onImageHasSize(a),f.updateStatus("error",t.tError.replace("%url%",a.src))),a.hasSize=!0,a.loaded=!0,a.loadError=!0)},t=f.st.image,k=c.find(".mfp-img");if(k.length){var q=document.createElement("img");q.className="mfp-img";a.el&&a.el.find("img").length&&(q.alt=a.el.find("img").attr("alt"));a.img=l(q).on("load.mfploader",d).on("error.mfploader",h);q.src=a.src;k.is("img")&&(a.img=a.img.clone());q=a.img[0];0<q.naturalWidth?
a.hasSize=!0:q.width||(a.hasSize=!1)}f._parseMarkup(c,{title:F(a),img_replaceWith:a.img},a);f.resizeImage();if(a.hasSize)return E&&clearInterval(E),a.loadError?(c.addClass("mfp-loading"),f.updateStatus("error",t.tError.replace("%url%",a.src))):(c.removeClass("mfp-loading"),f.updateStatus("ready")),c;f.updateStatus("loading");a.loading=!0;a.hasSize||(a.imgHidden=!0,c.addClass("mfp-loading"),f.findImageSize(a));return c}}});var C;l.magnificPopup.registerModule("zoom",{options:{enabled:!1,easing:"ease-in-out",
duration:300,opener:function(a){return a.is("img")?a:a.find("img")}},proto:{initZoom:function(){var c=f.st.zoom,e;if(c.enabled&&f.supportsTransition){var d=c.duration,h=function(a){a=a.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image");var e={position:"fixed",zIndex:9999,left:0,top:0,"-webkit-backface-visibility":"hidden"};e["-webkit-transition"]=e["-moz-transition"]=e["-o-transition"]=e.transition="all "+c.duration/1E3+"s "+c.easing;a.css(e);return a},t=function(){f.content.css("visibility",
"visible")},k,l;a("BuildControls.zoom",function(){f._allowZoom()&&(clearTimeout(k),f.content.css("visibility","hidden"),(e=f._getItemToZoom())?(l=h(e),l.css(f._getOffset()),f.wrap.append(l),k=setTimeout(function(){l.css(f._getOffset(!0));k=setTimeout(function(){t();setTimeout(function(){l.remove();e=l=null;m("ZoomAnimationEnded")},16)},d)},16)):t())});a("BeforeClose.zoom",function(){if(f._allowZoom()){clearTimeout(k);f.st.removalDelay=d;if(!e){e=f._getItemToZoom();if(!e)return;l=h(e)}l.css(f._getOffset(!0));
f.wrap.append(l);f.content.css("visibility","hidden");setTimeout(function(){l.css(f._getOffset())},16)}});a("Close.zoom",function(){f._allowZoom()&&(t(),l&&l.remove(),e=null)})}},_allowZoom:function(){return"image"===f.currItem.type},_getItemToZoom:function(){return f.currItem.hasSize?f.currItem.img:!1},_getOffset:function(a){var c=a?f.currItem.img:f.st.zoom.opener(f.currItem.el||f.currItem);a=c.offset();var e=parseInt(c.css("padding-top"),10),d=parseInt(c.css("padding-bottom"),10);a.top-=l(window).scrollTop()-
e;c={width:c.width(),height:(w?c.innerHeight():c[0].offsetHeight)-d-e};void 0===C&&(C=void 0!==document.createElement("p").style.MozTransform);C?c["-moz-transform"]=c.transform="translate("+a.left+"px,"+a.top+"px)":(c.left=a.left,c.top=a.top);return c}}});var D=function(a){if(f.currTemplate.iframe){var c=f.currTemplate.iframe.find("iframe");c.length&&(a||(c[0].src="//about:blank"),f.isIE8&&c.css("display",a?"block":"none"))}};l.magnificPopup.registerModule("iframe",{options:{markup:'<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',
srcAction:"iframe_src",patterns:{youtube:{index:"youtube.com",id:"v=",src:"//www.youtube.com/embed/%id%?autoplay=1"},vimeo:{index:"vimeo.com/",id:"/",src:"//player.vimeo.com/video/%id%?autoplay=1"},gmaps:{index:"//maps.google.",src:"%id%&output=embed"}}},proto:{initIframe:function(){f.types.push("iframe");a("BeforeChange",function(a,c,e){c!==e&&("iframe"===c?D():"iframe"===e&&D(!0))});a("Close.iframe",function(){D()})},getIframe:function(a,c){var e=a.src,d=f.st.iframe;l.each(d.patterns,function(){if(-1<
e.indexOf(this.index))return this.id&&(e="string"===typeof this.id?e.substr(e.lastIndexOf(this.id)+this.id.length,e.length):this.id.call(this,e)),e=this.src.replace("%id%",e),!1});var h={};d.srcAction&&(h[d.srcAction]=e);f._parseMarkup(c,h,a);f.updateStatus("ready");return c}}});var J=function(a){var c=f.items.length;return a>c-1?a-c:0>a?c+a:a},X=function(a,c,e){return a.replace(/%curr%/gi,c+1).replace(/%total%/gi,e)};l.magnificPopup.registerModule("gallery",{options:{enabled:!1,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',
...
setDatesDisabled:function(a){this._process_options({datesDisabled:a});this.update();this.updateNavArrows()},place:function(){if(this.isInline)return this;var a=this.picker.outerWidth(),c=this.picker.outerHeight(),e=l(this.o.container),d=e.width(),h="body"===this.o.container?l(document).scrollTop():e.scrollTop(),m=e.offset(),f=[];this.element.parents().each(function(){var a=l(this).css("z-index");"auto"!==a&&0!==a&&f.push(parseInt(a))});var e=Math.max.apply(Math,f)+this.o.zIndexOffset,k=this.component?
this.component.parent().offset():this.element.offset(),q=this.component?this.component.outerHeight(!0):this.element.outerHeight(!1),x=this.component?this.component.outerWidth(!0):this.element.outerWidth(!1),z=k.left-m.left,m=k.top-m.top;"body"!==this.o.container&&(m+=h);this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left");"auto"!==this.o.orientation.x?(this.picker.addClass("datepicker-orient-"+this.o.orientation.x),"right"===this.o.orientation.x&&
(z-=a-x)):0>k.left?(this.picker.addClass("datepicker-orient-left"),z-=k.left-10):z+a>d?(this.picker.addClass("datepicker-orient-right"),z+=x-a):this.picker.addClass("datepicker-orient-left");a=this.o.orientation.y;"auto"===a&&(a=0>-h+m-c?"bottom":"top");this.picker.addClass("datepicker-orient-"+a);m="top"===a?m-(c+parseInt(this.picker.css("padding-top"))):m+q;this.o.rtl?this.picker.css({top:m,right:d-(z+x),zIndex:e}):this.picker.css({top:m,left:z,zIndex:e});return this},_allow_update:!0,update:function(){if(!this._allow_update)return this;
...
a.valueOf()===this.range[this.range.length-1]&&c.push("range-end"));return c},_fill_yearsView:function(a,c,e,d,h,m,k,q){var t;var x="";a=this.picker.find(a);h=parseInt(h/e,10)*e;m=parseInt(m/d,10)*d;e=parseInt(k/d,10)*d;k=l.map(this.dates,function(a){return parseInt(a.getUTCFullYear()/d,10)*d});a.find(".datepicker-switch").text(h+"-"+(h+9*d));h-=d;for(t=-1;11>t;t+=1){var z=[c];var n=null;-1===t?z.push("old"):10===t&&z.push("new");-1!==l.inArray(h,k)&&z.push("active");(h<m||h>e)&&z.push("disabled");
h===this.viewDate.getFullYear()&&z.push("focused");if(q!==l.noop){var A=q(new Date(h,0,1));A===f?A={}:"boolean"===typeof A?A={enabled:A}:"string"===typeof A&&(A={classes:A});!1===A.enabled&&z.push("disabled");A.classes&&(z=z.concat(A.classes.split(/\s+/)));A.tooltip&&(n=A.tooltip)}x+='<span class="'+z.join(" ")+'"'+(n?' title="'+n+'"':"")+">"+h+"</span>";h+=d}a.find("td").html(x)},fill:function(){var a=new Date(this.viewDate),c=a.getUTCFullYear(),e=a.getUTCMonth(),d=-Infinity!==this.o.startDate?this.o.startDate.getUTCFullYear():
-Infinity,h=-Infinity!==this.o.startDate?this.o.startDate.getUTCMonth():-Infinity,m=Infinity!==this.o.endDate?this.o.endDate.getUTCFullYear():Infinity,k=Infinity!==this.o.endDate?this.o.endDate.getUTCMonth():Infinity,x=q[this.o.language].today||q.en.today||"",n=q[this.o.language].clear||q.en.clear||"",u=q[this.o.language].titleFormat||q.en.titleFormat;if(!isNaN(c)&&!isNaN(e)){this.picker.find(".datepicker-days .datepicker-switch").text(z.formatDate(a,u,this.o.language));this.picker.find("tfoot .today").text(x).toggle(!1!==
this.o.todayBtn);this.picker.find("tfoot .clear").text(n).toggle(!1!==this.o.clearBtn);this.picker.find("thead .datepicker-title").text(this.o.title).toggle(""!==this.o.title);this.updateNavArrows();this.fillMonths();a=v(c,e-1,28);e=z.getDaysInMonth(a.getUTCFullYear(),a.getUTCMonth());a.setUTCDate(e);a.setUTCDate(e-(a.getUTCDay()-this.o.weekStart+7)%7);e=new Date(a);100>a.getUTCFullYear()&&e.setUTCFullYear(a.getUTCFullYear());e.setUTCDate(e.getUTCDate()+42);e=e.valueOf();for(x=[];a.valueOf()<e;){if(a.getUTCDay()===
this.o.weekStart&&(x.push("<tr>"),this.o.calendarWeeks)){var n=new Date(+a+(this.o.weekStart-a.getUTCDay()-7)%7*864E5),n=new Date(Number(n)+(11-n.getUTCDay())%7*864E5),w=new Date(Number(w=v(n.getUTCFullYear(),0,1))+(11-w.getUTCDay())%7*864E5);x.push('<td class="cw">'+((n-w)/864E5/7+1)+"</td>")}u=this.getClassNames(a);u.push("day");if(this.o.beforeShowDay!==l.noop&&(n=this.o.beforeShowDay(this._utc_to_local(a)),n===f?n={}:"boolean"===typeof n?n={enabled:n}:"string"===typeof n&&(n={classes:n}),!1===
n.enabled&&u.push("disabled"),n.classes&&(u=u.concat(n.classes.split(/\s+/))),n.tooltip))var J=n.tooltip;u=l.isFunction(l.uniqueSort)?l.uniqueSort(u):l.unique(u);x.push('<td class="'+u.join(" ")+'"'+(J?' title="'+J+'"':"")+">"+a.getUTCDate()+"</td>");J=null;a.getUTCDay()===this.o.weekEnd&&x.push("</tr>");a.setUTCDate(a.getUTCDate()+1)}this.picker.find(".datepicker-days tbody").empty().append(x.join(""));J=q[this.o.language].monthsTitle||q.en.monthsTitle||"Months";var X=this.picker.find(".datepicker-months").find(".datepicker-switch").text(2>
this.o.maxViewMode?J:c).end().find("span").removeClass("active");l.each(this.dates,function(a,e){e.getUTCFullYear()===c&&X.eq(e.getUTCMonth()).addClass("active")});(c<d||c>m)&&X.addClass("disabled");c===d&&X.slice(0,h).addClass("disabled");c===m&&X.slice(k+1).addClass("disabled");if(this.o.beforeShowMonth!==l.noop){var L=this;l.each(X,function(a,e){var d=L.o.beforeShowMonth(new Date(c,a,1));d===f?d={}:"boolean"===typeof d?d={enabled:d}:"string"===typeof d&&(d={classes:d});!1!==d.enabled||l(e).hasClass("disabled")||
...
var h=this.viewDate.getUTCMonth();if(a.hasClass("old"))if(0===h){h=11;--d;var m=c=!0}else--h,c=!0;a.hasClass("new")&&(11===h?(h=0,d+=1,m=c=!0):(h+=1,c=!0));this._setDate(v(d,h,e));m&&this._trigger("changeYear",this.viewDate);c&&this._trigger("changeMonth",this.viewDate)}a.hasClass("month")&&(this.viewDate.setUTCDate(1),e=1,h=a.parent().find("span").index(a),d=this.viewDate.getUTCFullYear(),this.viewDate.setUTCMonth(h),this._trigger("changeMonth",this.viewDate),1===this.o.minViewMode?(this._setDate(v(d,
h,e)),this.showMode()):this.showMode(-1),this.fill());if(a.hasClass("year")||a.hasClass("decade")||a.hasClass("century"))this.viewDate.setUTCDate(1),e=1,h=0,d=parseInt(a.text(),10)||0,this.viewDate.setUTCFullYear(d),a.hasClass("year")&&(this._trigger("changeYear",this.viewDate),2===this.o.minViewMode&&this._setDate(v(d,h,e))),a.hasClass("decade")&&(this._trigger("changeDecade",this.viewDate),3===this.o.minViewMode&&this._setDate(v(d,h,e))),a.hasClass("century")&&(this._trigger("changeCentury",this.viewDate),
4===this.o.minViewMode&&this._setDate(v(d,h,e))),this.showMode(-1),this.fill()}this.picker.is(":visible")&&this._focused_from&&l(this._focused_from).focus();delete this._focused_from},_toggle_multidate:function(a){var c=this.dates.contains(a);a||this.dates.clear();-1!==c?(!0===this.o.multidate||1<this.o.multidate||this.o.toggleActive)&&this.dates.remove(c):(!1===this.o.multidate&&this.dates.clear(),this.dates.push(a));if("number"===typeof this.o.multidate)for(;this.dates.length>this.o.multidate;)this.dates.remove(0)},
...
var c=a.replace(this.validParts,"\x00").split("\x00");a=a.match(this.validParts);if(!c||!c.length||!a||0===a.length)throw Error("Invalid date format.");return{separators:c,parts:a}},parseDate:function(a,e,d,h){function m(a,c){!0===c&&(c=10);100>a&&(a+=2E3,a>(new Date).getFullYear()+c&&(a-=100));return a}function k(){var a=this.slice(0,t[A].length),c=t[A].slice(0,a.length);return a.toLowerCase()===c.toLowerCase()}if(!a)return f;if(a instanceof Date)return a;"string"===typeof e&&(e=z.parseFormat(e));
if(e.toValue)return e.toValue(a,e,d);var x=/([\-+]\d+)([dmwy])/,t=a.match(/([\-+]\d+)([dmwy])/g),n={d:"moveDay",m:"moveMonth",w:"moveWeek",y:"moveYear"},u={yesterday:"-1d",today:"+0d",tomorrow:"+1d"},A;if(/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(a)){a=new Date;for(A=0;A<t.length;A++)e=x.exec(t[A]),d=parseInt(e[1]),e=n[e[2]],a=c.prototype[e](a,d);return v(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate())}if("undefined"!==typeof u[a]&&(a=u[a],t=a.match(/([\-+]\d+)([dmwy])/g),/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(a))){a=
new Date;for(A=0;A<t.length;A++)e=x.exec(t[A]),d=parseInt(e[1]),e=n[e[2]],a=c.prototype[e](a,d);return v(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate())}t=a&&a.match(this.nonpunctuation)||[];a=new Date;var x={},K="yyyy yy M MM m mm d dd".split(" "),n={yyyy:function(a,c){return a.setUTCFullYear(h?m(c,h):c)},yy:function(a,c){return a.setUTCFullYear(h?m(c,h):c)},m:function(a,c){if(isNaN(a))return a;for(--c;0>c;)c+=12;c%=12;for(a.setUTCMonth(c);a.getUTCMonth()!==c;)a.setUTCDate(a.getUTCDate()-1);return a},
d:function(a,c){return a.setUTCDate(c)}};n.M=n.MM=n.mm=n.m;n.dd=n.d;a=w();u=e.parts.slice();t.length!==u.length&&(u=l(u).filter(function(a,c){return-1!==l.inArray(c,K)}).toArray());if(t.length===u.length){var N;A=0;for(N=u.length;A<N;A++){var L=parseInt(t[A],10);e=u[A];if(isNaN(L))switch(e){case "MM":L=l(q[d].months).filter(k);L=l.inArray(L[0],q[d].months)+1;break;case "M":L=l(q[d].monthsShort).filter(k),L=l.inArray(L[0],q[d].monthsShort)+1}x[e]=L}for(A=0;A<K.length;A++)e=K[A],e in x&&!isNaN(x[e])&&
(d=new Date(a),n[e](d,x[e]),isNaN(d)||(a=d))}return a},formatDate:function(a,c,e){if(!a)return"";"string"===typeof c&&(c=z.parseFormat(c));if(c.toDisplay)return c.toDisplay(a,c,e);e={d:a.getUTCDate(),D:q[e].daysShort[a.getUTCDay()],DD:q[e].days[a.getUTCDay()],m:a.getUTCMonth()+1,M:q[e].monthsShort[a.getUTCMonth()],MM:q[e].months[a.getUTCMonth()],yy:a.getUTCFullYear().toString().substring(2),yyyy:a.getUTCFullYear()};e.dd=(10>e.d?"0":"")+e.d;e.mm=(10>e.m?"0":"")+e.m;a=[];for(var d=l.extend([],c.separators),
...
*/
(function(l){"object"===typeof exports&&"undefined"!==typeof module?module.exports=l():"function"===typeof define&&define.amd?define([],l):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).Chart=l()})(function(){return function f(v,w,u){function n(c,d){if(!w[c]){if(!v[c]){var a="function"==typeof require&&require;if(!d&&a)return a(c,!0);if(k)return k(c,!0);a=Error("Cannot find module '"+c+"'");throw a.code="MODULE_NOT_FOUND",a;}a=w[c]={exports:{}};
v[c][0].call(a.exports,function(a){var e=v[c][1][a];return n(e?e:a)},a,a.exports,f,v,w,u)}return w[c].exports}for(var k="function"==typeof require&&require,h=0;h<u.length;h++)n(u[h]);return n}({1:[function(f,v,w){},{}],2:[function(f,v,w){function u(c){if(c){var e=/^#([a-fA-F0-9]{6})$/,d=/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/,h=/^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/,f=/(\w+)/,k=[0,
0,0],q=1,x=c.match(/^#([a-fA-F0-9]{3})$/);if(x)for(x=x[1],c=0;c<k.length;c++)k[c]=parseInt(x[c]+x[c],16);else if(x=c.match(e))for(x=x[1],c=0;c<k.length;c++)k[c]=parseInt(x.slice(2*c,2*c+2),16);else if(x=c.match(d)){for(c=0;c<k.length;c++)k[c]=parseInt(x[c+1]);q=parseFloat(x[4])}else if(x=c.match(h)){for(c=0;c<k.length;c++)k[c]=Math.round(2.55*parseFloat(x[c+1]));q=parseFloat(x[4])}else if(x=c.match(f)){if("transparent"==x[1])return[0,0,0,0];k=m[x[1]];if(!k)return}for(c=0;c<k.length;c++)k[c]=a(k[c],
0,255);q=q||0==q?a(q,0,1):1;k[3]=q;return k}}function n(c){if(c){var e=c.match(/^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/);if(e){var d=parseFloat(e[4]);c=a(parseInt(e[1]),0,360);var h=a(parseFloat(e[2]),0,100),e=a(parseFloat(e[3]),0,100),d=a(isNaN(d)?1:d,0,1);return[c,h,e,d]}}}function k(c){if(c){var e=c.match(/^hwb\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/);if(e){var d=parseFloat(e[4]);
...
hwb2rgb:x,hwb2hsl:function(a){return u(x(a))},hwb2hsv:function(a){return n(x(a))},hwb2cmyk:function(a){return h(x(a))},hwb2keyword:function(a){return c(x(a))},cmyk2rgb:q,cmyk2hsl:function(a){return u(q(a))},cmyk2hsv:function(a){return n(q(a))},cmyk2hwb:function(a){return k(q(a))},cmyk2keyword:function(a){return c(q(a))},keyword2rgb:function(a){return I[a]},keyword2hsl:function(a){return u(I[a])},keyword2hsv:function(a){return n(I[a])},keyword2hwb:function(a){return k(I[a])},keyword2cmyk:function(a){return h(I[a])},
keyword2lab:function(c){return a(I[c])},keyword2xyz:function(a){return d(I[a])},xyz2rgb:z,xyz2lab:t,xyz2lch:function(a){return K(t(a))},lab2xyz:A,lab2rgb:N,lab2lch:K,lch2lab:B,lch2xyz:function(a){return A(B(a))},lch2rgb:function(a){return N(B(a))}};var I={aliceblue:[240,248,255],antiquewhite:[250,235,215],aqua:[0,255,255],aquamarine:[127,255,212],azure:[240,255,255],beige:[245,245,220],bisque:[255,228,196],black:[0,0,0],blanchedalmond:[255,235,205],blue:[0,0,255],blueviolet:[138,43,226],brown:[165,
...
130,238],wheat:[245,222,179],white:[255,255,255],whitesmoke:[245,245,245],yellow:[255,255,0],yellowgreen:[154,205,50]},G={},E;for(E in I)G[JSON.stringify(I[E])]=E},{}],5:[function(f,v,w){var u=f(4),n=function(){return new h},k;for(k in u)n[k+"Raw"]=function(c){return function(d){"number"==typeof d&&(d=Array.prototype.slice.call(arguments));return u[c](d)}}(k),w=/(\w+)2(\w+)/.exec(k),f=w[1],w=w[2],n[f]=n[f]||{},n[f][w]=n[k]=function(c){return function(d){"number"==typeof d&&(d=Array.prototype.slice.call(arguments));
...
this.convs[c]=d);return d};["rgb","hsl","hsv","cmyk","keyword"].forEach(function(c){h.prototype[c]=function(d){return this.routeSpace(c,arguments)}});v.exports=n},{4:4}],6:[function(f,v,w){v.exports={aliceblue:[240,248,255],antiquewhite:[250,235,215],aqua:[0,255,255],aquamarine:[127,255,212],azure:[240,255,255],beige:[245,245,220],bisque:[255,228,196],black:[0,0,0],blanchedalmond:[255,235,205],blue:[0,0,255],blueviolet:[138,43,226],brown:[165,42,42],burlywood:[222,184,135],cadetblue:[95,158,160],
...
whitesmoke:[245,245,245],yellow:[255,255,0],yellowgreen:[154,205,50]}},{}],7:[function(f,v,w){w=f(28)();f(26)(w);f(42)(w);f(22)(w);f(31)(w);f(25)(w);f(21)(w);f(23)(w);f(24)(w);f(29)(w);f(33)(w);f(34)(w);f(32)(w);f(35)(w);f(30)(w);f(27)(w);f(36)(w);f(37)(w);f(38)(w);f(39)(w);f(40)(w);f(45)(w);f(43)(w);f(44)(w);f(46)(w);f(47)(w);f(48)(w);f(15)(w);f(16)(w);f(17)(w);f(18)(w);f(19)(w);f(20)(w);f(8)(w);f(9)(w);f(10)(w);f(11)(w);f(12)(w);f(13)(w);f(14)(w);window.Chart=v.exports=w},{10:10,11:11,12:12,13:13,
14:14,15:15,16:16,17:17,18:18,19:19,20:20,21:21,22:22,23:23,24:24,25:25,26:26,27:27,28:28,29:29,30:30,31:31,32:32,33:33,34:34,35:35,36:36,37:37,38:38,39:39,40:40,42:42,43:43,44:44,45:45,46:46,47:47,48:48,8:8,9:9}],8:[function(f,v,w){v.exports=function(f){f.Bar=function(n,k){k.type="bar";return new f(n,k)}}},{}],9:[function(f,v,w){v.exports=function(f){f.Bubble=function(n,k){k.type="bubble";return new f(n,k)}}},{}],10:[function(f,v,w){v.exports=function(f){f.Doughnut=function(n,k){k.type="doughnut";
return new f(n,k)}}},{}],11:[function(f,v,w){v.exports=function(f){f.Line=function(n,k){k.type="line";return new f(n,k)}}},{}],12:[function(f,v,w){v.exports=function(f){f.PolarArea=function(n,k){k.type="polarArea";return new f(n,k)}}},{}],13:[function(f,v,w){v.exports=function(f){f.Radar=function(n,k){k.type="radar";return new f(n,k)}}},{}],14:[function(f,v,w){v.exports=function(f){f.defaults.scatter={hover:{mode:"single"},scales:{xAxes:[{type:"linear",position:"bottom",id:"x-axis-1"}],yAxes:[{type:"linear",
position:"left",id:"y-axis-1"}]},tooltips:{callbacks:{title:function(){return""},label:function(f){return"("+f.xLabel+", "+f.yLabel+")"}}}};f.controllers.scatter=f.controllers.line;f.Scatter=function(n,k){k.type="scatter";return new f(n,k)}}},{}],15:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.defaults.bar={hover:{mode:"label"},scales:{xAxes:[{type:"category",categoryPercentage:.8,barPercentage:.9,gridLines:{offsetGridLines:!0}}],yAxes:[{type:"linear"}]}};f.controllers.bar=f.DatasetController.extend({dataElementType:f.elements.Rectangle,
...
h.bar&&f.chart.isDatasetVisible(e)&&(!1===c.options.stacked||!0===c.options.stacked&&-1===d.indexOf(h.stack)||void 0===c.options.stacked&&(void 0===h.stack||-1===d.indexOf(h.stack)))&&d.push(h.stack)},f);return d.length},updateElement:function(f,h,c){var d=this.getMeta(),a=this.getScaleForId(d.xAxisID),e=this.getScaleForId(d.yAxisID),d=a.getBasePixel(),m=f.custom||{},k=this.getDataset(),q=this.chart.options.elements.rectangle;f._xScale=a;f._yScale=e;f._datasetIndex=this.index;f._index=h;a=this.getRuler(h);
...
Math.max(t,e))}return d.getPixelForValue(a)}return d.getBasePixel()},getRuler:function(){var f=this.getMeta(),f=this.getScaleForId(f.yAxisID),h=this.getStackCount(),c=f.height/f.ticks.length,d=c*f.options.categoryPercentage,a=d/h;return{stackCount:h,tickHeight:c,categoryHeight:d,categorySpacing:(c-c*f.options.categoryPercentage)/2,fullBarHeight:a,barHeight:a*f.options.barPercentage,barSpacing:a-a*f.options.barPercentage}},calculateBarHeight:function(f){var h=this.getMeta(),h=this.getScaleForId(h.yAxisID);
...
(d=d.slice(),d[0]+=a):d+=a;return d}}}};k.pie=n.clone(k.doughnut);n.extend(k.pie,{cutoutPercentage:0});f.controllers.doughnut=f.controllers.pie=f.DatasetController.extend({dataElementType:f.elements.Arc,linkScales:n.noop,getRingIndex:function(h){for(var c=0,d=0;d<h;++d)this.chart.isDatasetVisible(d)&&++c;return c},update:function(h){var c=this,d=c.chart,a=d.chartArea,e=d.options,f=e.elements.arc,k=a.right-a.left-f.borderWidth,a=a.bottom-a.top-f.borderWidth,q=Math.min(k,a),z=0,t=0,f=c.getMeta(),u=
e.cutoutPercentage,v=e.circumference;if(v<2*Math.PI)var q=e.rotation%(2*Math.PI),q=q+2*Math.PI*(q>=Math.PI?-1:q<-Math.PI?1:0),v=q+v,w=Math.cos(q),t=Math.sin(q),B=Math.cos(v),I=Math.sin(v),G=u/100,z=q<=-Math.PI&&-Math.PI<=v||q<=Math.PI&&Math.PI<=v?-1:Math.min(w*(0>w?1:G),B*(0>B?1:G)),e=q<=.5*-Math.PI&&.5*-Math.PI<=v||q<=1.5*Math.PI&&1.5*Math.PI<=v?-1:Math.min(t*(0>t?1:G),I*(0>I?1:G)),w=0>=q&&0<=v||q<=2*Math.PI&&2*Math.PI<=v?1:Math.max(w*(0<w?1:G),B*(0<B?1:G)),v=q<=.5*Math.PI&&.5*Math.PI<=v||q<=2.5*
Math.PI&&2.5*Math.PI<=v?1:Math.max(t*(0<t?1:G),I*(0<I?1:G)),q=Math.min(k/(.5*(w-z)),a/(.5*(v-e))),z=-.5*(w+z),t=-.5*(v+e);d.borderWidth=c.getMaxBorderWidth(f.data);d.outerRadius=Math.max((q-d.borderWidth)/2,0);d.innerRadius=Math.max(u?d.outerRadius/100*u:0,0);d.radiusLength=(d.outerRadius-d.innerRadius)/d.getVisibleDatasetCount();d.offsetX=z*d.outerRadius;d.offsetY=t*d.outerRadius;f.total=c.calculateTotal();c.outerRadius=d.outerRadius-d.radiusLength*c.getRingIndex(c.index);c.innerRadius=Math.max(c.outerRadius-
d.radiusLength,0);n.each(f.data,function(a,e){c.updateElement(a,e,h)})},updateElement:function(h,c,d){var a=this.chart,e=a.chartArea,f=a.options,k=f.animation,q=(e.left+e.right)/2,e=(e.top+e.bottom)/2,z=f.rotation,t=f.rotation,u=this.getDataset(),v=d&&k.animateRotate?0:h.hidden?0:this.calculateCircumference(u.data[c])*(f.circumference/(2*Math.PI)),w=n.getValueAtIndexOrDefault;n.extend(h,{_datasetIndex:this.index,_index:c,_model:{x:q+a.offsetX,y:e+a.offsetY,startAngle:z,endAngle:t,circumference:v,
outerRadius:d&&k.animateScale?0:this.outerRadius,innerRadius:d&&k.animateScale?0:this.innerRadius,label:w(u.label,c,a.data.labels[c])}});a=h._model;this.removeHoverStyle(h);d&&k.animateRotate||(a.startAngle=0===c?f.rotation:this.getMeta().data[c-1]._model.endAngle,a.endAngle=a.startAngle+a.circumference);h.pivot()},removeHoverStyle:function(h){f.DatasetController.prototype.removeHoverStyle.call(this,h,this.chart.options.elements.arc)},calculateTotal:function(){var h=this.getDataset(),c=this.getMeta(),
d=0,a;n.each(c.data,function(c,f){a=h.data[f];isNaN(a)||c.hidden||(d+=Math.abs(a))});return d},calculateCircumference:function(h){var c=this.getMeta().total;return 0<c&&!isNaN(h)?h/c*Math.PI*2:0},getMaxBorderWidth:function(h){for(var c=0,d=this.index,a=h.length,e,f,k=0;k<a;k++)e=h[k]._model?h[k]._model.borderWidth:0,f=h[k]._chart?h[k]._chart.config.data.datasets[d].hoverBorderWidth:0,c=e>c?e:c,c=f>c?f:c;return c}})}},{}],18:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.defaults.line={showLines:!0,
spanGaps:!1,hover:{mode:"label"},scales:{xAxes:[{type:"category",id:"x-axis-0"}],yAxes:[{type:"linear",id:"y-axis-0"}]}};f.controllers.line=f.DatasetController.extend({datasetElementType:f.elements.Line,dataElementType:f.elements.Point,update:function(f){var h=this.getMeta(),c=h.dataset,d=h.data||[],a=this.chart.options,e=a.elements.line,m=this.getScaleForId(h.yAxisID),k=this.getDataset();if(h=n.getValueOrDefault(k.showLine,a.showLines)){var q=c.custom||{};void 0!==k.tension&&void 0===k.lineTension&&
...
borderDash:q.borderDash?q.borderDash:k.borderDash||e.borderDash,borderDashOffset:q.borderDashOffset?q.borderDashOffset:k.borderDashOffset||e.borderDashOffset,borderJoinStyle:q.borderJoinStyle?q.borderJoinStyle:k.borderJoinStyle||e.borderJoinStyle,fill:q.fill?q.fill:void 0!==k.fill?k.fill:e.fill,steppedLine:q.steppedLine?q.steppedLine:n.getValueOrDefault(k.steppedLine,e.stepped),cubicInterpolationMode:q.cubicInterpolationMode?q.cubicInterpolationMode:n.getValueOrDefault(k.cubicInterpolationMode,e.cubicInterpolationMode),
scaleTop:m.top,scaleBottom:m.bottom,scaleZero:m.getBasePixel()};c.pivot()}a=0;for(e=d.length;a<e;++a)this.updateElement(d[a],a,f);h&&0!==c._model.tension&&this.updateBezierControlPoints();a=0;for(e=d.length;a<e;++a)d[a].pivot()},getPointBackgroundColor:function(f,h){var c=this.chart.options.elements.point.backgroundColor,d=this.getDataset(),a=f.custom||{};a.backgroundColor?c=a.backgroundColor:d.pointBackgroundColor?c=n.getValueAtIndexOrDefault(d.pointBackgroundColor,h,c):d.backgroundColor&&(c=d.backgroundColor);
return c},getPointBorderColor:function(f,h){var c=this.chart.options.elements.point.borderColor,d=this.getDataset(),a=f.custom||{};a.borderColor?c=a.borderColor:d.pointBorderColor?c=n.getValueAtIndexOrDefault(d.pointBorderColor,h,c):d.borderColor&&(c=d.borderColor);return c},getPointBorderWidth:function(f,h){var c=this.chart.options.elements.point.borderWidth,d=this.getDataset(),a=f.custom||{};isNaN(a.borderWidth)?isNaN(d.pointBorderWidth)?isNaN(d.borderWidth)||(c=d.borderWidth):c=n.getValueAtIndexOrDefault(d.pointBorderWidth,
h,c):c=a.borderWidth;return c},updateElement:function(f,h,c){var d=this.getMeta(),a=f.custom||{},e=this.getDataset(),m=this.index,k=e.data[h],q=this.getScaleForId(d.yAxisID),z=this.getScaleForId(d.xAxisID),t=this.chart.options.elements.point;var u=1===(this.chart.data.labels||[]).length||1===e.data.length||this.chart.isCombo;void 0!==e.radius&&void 0===e.pointRadius&&(e.pointRadius=e.radius);void 0!==e.hitRadius&&void 0===e.pointHitRadius&&(e.pointHitRadius=e.hitRadius);u=z.getPixelForValue("object"===
typeof k?k:NaN,h,m,u);c=c?q.getBasePixel():this.calculatePointY(k,h,m);f._xScale=z;f._yScale=q;f._datasetIndex=m;f._index=h;f._model={x:u,y:c,skip:a.skip||isNaN(u)||isNaN(c),radius:a.radius||n.getValueAtIndexOrDefault(e.pointRadius,h,t.radius),pointStyle:a.pointStyle||n.getValueAtIndexOrDefault(e.pointStyle,h,t.pointStyle),backgroundColor:this.getPointBackgroundColor(f,h),borderColor:this.getPointBorderColor(f,h),borderWidth:this.getPointBorderWidth(f,h),tension:d.dataset._model?d.dataset._model.tension:
0,steppedLine:d.dataset._model?d.dataset._model.steppedLine:!1,hitRadius:a.hitRadius||n.getValueAtIndexOrDefault(e.pointHitRadius,h,t.hitRadius)}},calculatePointY:function(f,h,c){var d=this.chart,a=this.getMeta(),a=this.getScaleForId(a.yAxisID),e=0,m=0,k;if(a.options.stacked){for(k=0;k<c;k++){var q=d.data.datasets[k];var n=d.getDatasetMeta(k);"line"===n.type&&n.yAxisID===a.id&&d.isDatasetVisible(k)&&(q=Number(a.getRightValue(q.data[h])),0>q?m+=q||0:e+=q||0)}f=Number(a.getRightValue(f));return 0>f?
a.getPixelForValue(m+f):a.getPixelForValue(e+f)}return a.getPixelForValue(f)},updateBezierControlPoints:function(){var f=this.getMeta(),h=this.chart.chartArea,c=f.data||[],d;f.dataset._model.spanGaps&&(c=c.filter(function(a){return!a._model.skip}));if("monotone"===f.dataset._model.cubicInterpolationMode)n.splineCurveMonotone(c);else{var a=0;for(d=c.length;a<d;++a){var e=c[a];e=e._model;var m=n.splineCurve(n.previousItem(c,a)._model,e,n.nextItem(c,a)._model,f.dataset._model.tension);e.controlPointPreviousX=
m.previous.x;e.controlPointPreviousY=m.previous.y;e.controlPointNextX=m.next.x;e.controlPointNextY=m.next.y}}if(this.chart.options.elements.line.capBezierPoints)for(a=0,d=c.length;a<d;++a)e=c[a]._model,e.controlPointPreviousX=Math.max(Math.min(e.controlPointPreviousX,h.right),h.left),e.controlPointPreviousY=Math.max(Math.min(e.controlPointPreviousY,h.bottom),h.top),e.controlPointNextX=Math.max(Math.min(e.controlPointNextX,h.right),h.left),e.controlPointNextY=Math.max(Math.min(e.controlPointNextY,
h.bottom),h.top)},draw:function(k){var h=this.getMeta(),c=h.data||[];k=k||1;var d;var a=0;for(d=c.length;a<d;++a)c[a].transition(k);f.canvasHelpers.clipArea(this.chart.chart.ctx,this.chart.chartArea);a=this.getDataset();n.getValueOrDefault(a.showLine,this.chart.options.showLines)&&h.dataset.transition(k).draw();f.canvasHelpers.unclipArea(this.chart.chart.ctx);a=0;for(d=c.length;a<d;++a)c[a].draw(this.chart.chartArea)},setHoverStyle:function(f){var h=this.chart.data.datasets[f._datasetIndex],c=f._index,
d=f.custom||{};f=f._model;f.radius=d.hoverRadius||n.getValueAtIndexOrDefault(h.pointHoverRadius,c,this.chart.options.elements.point.hoverRadius);f.backgroundColor=d.hoverBackgroundColor||n.getValueAtIndexOrDefault(h.pointHoverBackgroundColor,c,n.getHoverColor(f.backgroundColor));f.borderColor=d.hoverBorderColor||n.getValueAtIndexOrDefault(h.pointHoverBorderColor,c,n.getHoverColor(f.borderColor));f.borderWidth=d.hoverBorderWidth||n.getValueAtIndexOrDefault(h.pointHoverBorderWidth,c,f.borderWidth)},
removeHoverStyle:function(f){var h=this.chart.data.datasets[f._datasetIndex],c=f._index,d=f.custom||{},a=f._model;void 0!==h.radius&&void 0===h.pointRadius&&(h.pointRadius=h.radius);a.radius=d.radius||n.getValueAtIndexOrDefault(h.pointRadius,c,this.chart.options.elements.point.radius);a.backgroundColor=this.getPointBackgroundColor(f,c);a.borderColor=this.getPointBorderColor(f,c);a.borderWidth=this.getPointBorderWidth(f,c)}})}},{}],19:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.defaults.polarArea=
{scale:{type:"radialLinear",lineArc:!0,ticks:{beginAtZero:!0}},animation:{animateRotate:!0,animateScale:!0},startAngle:-.5*Math.PI,aspectRatio:1,legendCallback:function(f){var h=[];h.push('<ul class="'+f.id+'-legend">');var c=f.data;f=c.datasets;c=c.labels;if(f.length)for(var d=0;d<f[0].data.length;++d)h.push('<li><span style="background-color:'+f[0].backgroundColor[d]+'"></span>'),c[d]&&h.push(c[d]),h.push("</li>");h.push("</ul>");return h.join("")},legend:{labels:{generateLabels:function(f){var h=
f.data;return h.labels.length&&h.datasets.length?h.labels.map(function(c,d){var a=f.getDatasetMeta(0),e=h.datasets[0],m=a.data[d].custom||{},k=n.getValueAtIndexOrDefault,q=f.options.elements.arc,z=m.backgroundColor?m.backgroundColor:k(e.backgroundColor,d,q.backgroundColor),t=m.borderColor?m.borderColor:k(e.borderColor,d,q.borderColor),m=m.borderWidth?m.borderWidth:k(e.borderWidth,d,q.borderWidth);return{text:c,fillStyle:z,strokeStyle:t,lineWidth:m,hidden:isNaN(e.data[d])||a.data[d].hidden,index:d}}):
...
d.left,d.bottom-d.top)-e.elements.arc.borderWidth/2)/2,0);c.innerRadius=Math.max(e.cutoutPercentage?c.outerRadius/100*e.cutoutPercentage:1,0);c.radiusLength=(c.outerRadius-c.innerRadius)/c.getVisibleDatasetCount();h.outerRadius=c.outerRadius-c.radiusLength*h.index;h.innerRadius=h.outerRadius-c.radiusLength;a.count=h.countVisibleElements();n.each(a.data,function(a,c){h.updateElement(a,c,f)})},updateElement:function(f,h,c){for(var d=this.chart,a=this.getDataset(),e=d.options,m=e.animation,k=d.scale,
q=n.getValueAtIndexOrDefault,d=d.data.labels,z=this.calculateCircumference(a.data[h]),t=k.xCenter,u=k.yCenter,v=0,w=this.getMeta(),B=0;B<h;++B)isNaN(a.data[B])||w.data[B].hidden||++v;e=e.startAngle;w=f.hidden?0:k.getDistanceFromCenterForValue(a.data[h]);v=e+z*v;z=v+(f.hidden?0:z);a=m.animateScale?0:k.getDistanceFromCenterForValue(a.data[h]);n.extend(f,{_datasetIndex:this.index,_index:h,_scale:k,_model:{x:t,y:u,innerRadius:0,outerRadius:c?a:w,startAngle:c&&m.animateRotate?e:v,endAngle:c&&m.animateRotate?
e:z,label:q(d,h,d[h])}});this.removeHoverStyle(f);f.pivot()},removeHoverStyle:function(k){f.DatasetController.prototype.removeHoverStyle.call(this,k,this.chart.options.elements.arc)},countVisibleElements:function(){var f=this.getDataset(),h=this.getMeta(),c=0;n.each(h.data,function(d,a){isNaN(f.data[a])||d.hidden||c++});return c},calculateCircumference:function(f){var h=this.getMeta().count;return 0<h&&!isNaN(f)?2*Math.PI/h:0}})}},{}],20:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.defaults.radar=
{aspectRatio:1,scale:{type:"radialLinear"},elements:{line:{tension:0}}};f.controllers.radar=f.DatasetController.extend({datasetElementType:f.elements.Line,dataElementType:f.elements.Point,linkScales:n.noop,update:function(f){var h=this,c=h.getMeta(),d=c.data,a=c.dataset.custom||{},e=h.getDataset(),m=h.chart.options.elements.line,k=h.chart.scale;void 0!==e.tension&&void 0===e.lineTension&&(e.lineTension=e.tension);n.extend(c.dataset,{_datasetIndex:h.index,_children:d,_loop:!0,_model:{tension:a.tension?
a.tension:n.getValueOrDefault(e.lineTension,m.tension),backgroundColor:a.backgroundColor?a.backgroundColor:e.backgroundColor||m.backgroundColor,borderWidth:a.borderWidth?a.borderWidth:e.borderWidth||m.borderWidth,borderColor:a.borderColor?a.borderColor:e.borderColor||m.borderColor,fill:a.fill?a.fill:void 0!==e.fill?e.fill:m.fill,borderCapStyle:a.borderCapStyle?a.borderCapStyle:e.borderCapStyle||m.borderCapStyle,borderDash:a.borderDash?a.borderDash:e.borderDash||m.borderDash,borderDashOffset:a.borderDashOffset?
...
this.animations[c].animationObject.onAnimationComplete.call(this.animations[c].chartInstance,this.animations[c]),this.animations[c].chartInstance.animating=!1,this.animations.splice(c,1)):++c;f=(Date.now()-f)/this.frameDuration;this.dropFrames+=f;0<this.animations.length&&this.requestAnimationFrame()}}}},{}],22:[function(f,v,w){v.exports=function(f){var n=f.canvasHelpers={};n.drawPoint=function(k,h,c,d,a){if("object"===typeof h){var e=h.toString();if("[object HTMLImageElement]"===e||"[object HTMLCanvasElement]"===
...
c}else"number"===typeof c?(a=void 0!==h._start[d]&&!1===isNaN(h._start[d])?h._start[d]:0,h._view[d]=(h._model[d]-a)*f+a):h._view[d]=c},h);return h},tooltipPosition:function(){return{x:this._model.x,y:this._model.y}},hasValue:function(){return n.isNumber(this._model.x)&&n.isNumber(this._model.y)}});f.Element.extend=n.inherits}},{}],26:[function(f,v,w){var u=f(3);v.exports=function(f){function k(a,c,d){if("string"===typeof a){var e=parseInt(a,10);-1!==a.indexOf("%")&&(e=e/100*c.parentNode[d])}else e=
a;return e}function h(a,c,d){var e=document.defaultView,h=a.parentNode,f=e.getComputedStyle(a)[c];c=e.getComputedStyle(h)[c];var e=void 0!==f&&null!==f&&"none"!==f,m=void 0!==c&&null!==c&&"none"!==c,n=Number.POSITIVE_INFINITY;return e||m?Math.min(e?k(f,a,d):n,m?k(c,h,d):n):"none"}var c=f.helpers={};c.each=function(a,e,d,h){if(c.isArray(a)){var f=a.length;if(h)for(h=f-1;0<=h;h--)e.call(d,a[h],h);else for(h=0;h<f;h++)e.call(d,a[h],h)}else if("object"===typeof a){var m=Object.keys(a);f=m.length;for(h=
...
function(a){return 0===a%2?0:.5};c.splineCurve=function(a,c,d,h){a=a.skip?c:a;d=d.skip?c:d;var e=Math.sqrt(Math.pow(c.x-a.x,2)+Math.pow(c.y-a.y,2)),f=Math.sqrt(Math.pow(d.x-c.x,2)+Math.pow(d.y-c.y,2)),m=e/(e+f),e=f/(e+f),m=isNaN(m)?0:m,e=isNaN(e)?0:e,m=h*m;h*=e;return{previous:{x:c.x-m*(d.x-a.x),y:c.y-m*(d.y-a.y)},next:{x:c.x+h*(d.x-a.x),y:c.y+h*(d.y-a.y)}}};c.EPSILON=Number.EPSILON||1E-14;c.splineCurveMonotone=function(a){a=(a||[]).map(function(a){return{model:a._model,deltaK:0,mK:0}});var e=a.length,
...
window.msRequestAnimationFrame||function(a){return window.setTimeout(a,1E3/60)}}();c.getRelativePosition=function(a,e){var d=a.originalEvent||a;var h=a.currentTarget||a.srcElement,f=h.getBoundingClientRect(),k=d.touches;if(k&&0<k.length){var n=k[0].clientX;d=k[0].clientY}else n=d.clientX,d=d.clientY;var k=parseFloat(c.getStyle(h,"padding-left")),u=parseFloat(c.getStyle(h,"padding-top")),v=parseFloat(c.getStyle(h,"padding-right")),w=parseFloat(c.getStyle(h,"padding-bottom")),w=f.bottom-f.top-u-w;n=
Math.round((n-f.left-k)/(f.right-f.left-k-v)*h.width/e.currentDevicePixelRatio);d=Math.round((d-f.top-u)/w*h.height/e.currentDevicePixelRatio);return{x:n,y:d}};c.addEvent=function(a,c,d){a.addEventListener?a.addEventListener(c,d):a.attachEvent?a.attachEvent("on"+c,d):a["on"+c]=d};c.removeEvent=function(a,e,d){a.removeEventListener?a.removeEventListener(e,d,!1):a.detachEvent?a.detachEvent("on"+e,d):a["on"+e]=c.noop};c.getConstraintWidth=function(a){return h(a,"max-width","clientWidth")};c.getConstraintHeight=
...
h.data||{},m=h.garbageCollect=h.garbageCollect||[];h.font!==e&&(f=h.data={},m=h.garbageCollect=[],h.font=e);a.font=e;var k=0;c.each(d,function(e){void 0!==e&&null!==e&&!0!==c.isArray(e)?k=c.measureText(a,f,m,k,e):c.isArray(e)&&c.each(e,function(e){void 0===e||null===e||c.isArray(e)||(k=c.measureText(a,f,m,k,e))})});e=m.length/2;if(e>d.length){for(d=0;d<e;d++)delete f[m[d]];m.splice(0,e)}return k};c.measureText=function(a,c,d,h,f){var e=c[f];e||(e=c[f]=a.measureText(f).width,d.push(f));e>h&&(h=e);
...
for(var h=0;h<f.data.datasets.length;h++)k.push('<li><span style="background-color:'+f.data.datasets[h].backgroundColor+'"></span>'),f.data.datasets[h].label&&k.push(f.data.datasets[h].label),k.push("</li>");k.push("</ul>");return k.join("")}}};return f.Chart=f}},{}],29:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.layoutService={defaults:{},addBox:function(f,h){f.boxes||(f.boxes=[]);f.boxes.push(h)},removeBox:function(f,h){f.boxes&&f.boxes.splice(f.boxes.indexOf(h),1)},update:function(f,
h,c){function d(a){var c=n.findNextWhere(J,function(c){return c.box===a});c&&(a.isHorizontal()?a.update(a.options.fullWidth?B:C,I/2,{left:Math.max(S,X),right:Math.max(Y,L),top:0,bottom:0}):a.update(c.minSize.width,D))}function a(a){a.isHorizontal()?(a.left=a.options.fullWidth?x:S,a.right=a.options.fullWidth?h-q:S+C,a.top=ua,a.bottom=ua+a.height,ua=a.bottom):(a.left=ra,a.right=ra+a.width,a.top=W,a.bottom=W+D,ra=a.right)}if(f){var e=f.options.layout,k=e?e.padding:null,x=0,q=0,z=e=0;isNaN(k)?(x=k.left||
0,q=k.right||0,e=k.top||0,z=k.bottom||0):z=e=q=x=k;var k=n.where(f.boxes,function(a){return"left"===a.options.position}),t=n.where(f.boxes,function(a){return"right"===a.options.position}),u=n.where(f.boxes,function(a){return"top"===a.options.position}),v=n.where(f.boxes,function(a){return"bottom"===a.options.position}),w=n.where(f.boxes,function(a){return"chartArea"===a.options.position});u.sort(function(a,c){return(c.options.fullWidth?1:0)-(a.options.fullWidth?1:0)});v.sort(function(a,c){return(a.options.fullWidth?
1:0)-(c.options.fullWidth?1:0)});var B=h-x-q,I=c-e-z,G=I/2,E=(h-B/2)/(k.length+t.length),F=(c-G)/(u.length+v.length),C=B,D=I,J=[];n.each(k.concat(t,u,v),function(a){var c=a.isHorizontal();if(c){var d=a.update(a.options.fullWidth?B:C,F);D-=d.height}else d=a.update(E,G),C-=d.width;J.push({horizontal:c,minSize:d,box:a})});var X=0,L=0,M=0,T=0;n.each(u.concat(v),function(a){a.getPadding&&(a=a.getPadding(),X=Math.max(X,a.left),L=Math.max(L,a.right))});n.each(k.concat(t),function(a){a.getPadding&&(a=a.getPadding(),
M=Math.max(M,a.top),T=Math.max(T,a.bottom))});var S=x,Y=q,W=e,U=z;n.each(k.concat(t),d);n.each(k,function(a){S+=a.width});n.each(t,function(a){Y+=a.width});n.each(u.concat(v),d);n.each(u,function(a){W+=a.height});n.each(v,function(a){U+=a.height});n.each(k.concat(t),function(a){var c=n.findNextWhere(J,function(c){return c.box===a}),d={left:0,right:0,top:W,bottom:U};c&&a.update(c.minSize.width,D,d)});S=x;Y=q;W=e;U=z;n.each(k,function(a){S+=a.width});n.each(t,function(a){Y+=a.width});n.each(u,function(a){W+=
a.height});n.each(v,function(a){U+=a.height});var z=Math.max(X-S,0),S=S+z,Y=Y+Math.max(L-Y,0),fa=Math.max(M-W,0),W=W+fa,U=U+Math.max(T-U,0),ca=c-W-U,ga=h-S-Y;if(ga!==C||ca!==D)n.each(k,function(a){a.height=ca}),n.each(t,function(a){a.height=ca}),n.each(u,function(a){a.options.fullWidth||(a.width=ga)}),n.each(v,function(a){a.options.fullWidth||(a.width=ga)}),D=ca,C=ga;var ra=x+z,ua=e+fa;n.each(k.concat(u),a);ra+=C;ua+=D;n.each(t,a);n.each(v,a);f.chartArea={left:S,top:W,right:S+C,bottom:W+D};n.each(w,
function(a){a.left=f.chartArea.left;a.top=f.chartArea.top;a.right=f.chartArea.right;a.bottom=f.chartArea.bottom;a.update(C,D)})}}}}},{}],30:[function(f,v,w){v.exports=function(f){function n(c,d){var a=new f.Legend({ctx:c.chart.ctx,options:d,chart:c});c.legend=a;f.layoutService.addBox(c,a)}var k=f.helpers,h=k.noop;f.defaults.global.legend={display:!0,position:"top",fullWidth:!0,reverse:!1,onClick:function(c,d){var a=d.datasetIndex,e=this.chart,h=e.getDatasetMeta(a);h.hidden=null===h.hidden?!e.data.datasets[a].hidden:
...
fit:function(){var c=this,d=c.options,a=d.labels,d=d.display,e=c.ctx,h=f.defaults.global,n=k.getValueOrDefault,q=n(a.fontSize,h.defaultFontSize),z=n(a.fontStyle,h.defaultFontStyle),h=n(a.fontFamily,h.defaultFontFamily),z=k.fontString(q,z,h),t=c.legendHitBoxes=[],u=c.minSize;(h=c.isHorizontal())?(u.width=c.maxWidth,u.height=d?10:0):(u.width=d?10:0,u.height=c.maxHeight);if(d)if(e.font=z,h){var v=c.lineWidths=[0],w=c.legendItems.length?q+a.padding:0;e.textAlign="left";e.textBaseline="top";k.each(c.legendItems,
function(d,h){var f=(a.usePointStyle?q*Math.SQRT2:a.boxWidth)+q/2+e.measureText(d.text).width;v[v.length-1]+f+a.padding>=c.width&&(w+=q+a.padding,v[v.length]=c.left);t[h]={left:0,top:0,width:f,height:q};v[v.length-1]+=f+a.padding});u.height+=w}else{var d=a.padding,B=c.columnWidths=[],I=a.padding,G=0,E=0,F=q+d;k.each(c.legendItems,function(c,d){var h=(a.usePointStyle?q*Math.SQRT2:a.boxWidth)+q/2+e.measureText(c.text).width;E+F>u.height&&(I+=G+a.padding,B.push(G),E=G=0);G=Math.max(G,h);E+=F;t[d]={left:0,
top:0,width:h,height:q}});I+=G;B.push(G);u.width+=I}c.width=u.width;c.height=u.height},afterFit:h,isHorizontal:function(){return"top"===this.options.position||"bottom"===this.options.position},draw:function(){var c=this,d=c.options,a=d.labels,e=f.defaults.global,h=e.elements.line,n=c.width,q=c.lineWidths;if(d.display){var z=c.ctx,t=k.getValueOrDefault,u=t(a.fontColor,e.defaultFontColor),v=t(a.fontSize,e.defaultFontSize),w=t(a.fontStyle,e.defaultFontStyle),B=t(a.fontFamily,e.defaultFontFamily),w=k.fontString(v,
w,B);z.textAlign="left";z.textBaseline="top";z.lineWidth=.5;z.strokeStyle=u;z.fillStyle=u;z.font=w;var I=a.usePointStyle?v*Math.SQRT2:a.boxWidth,G=c.legendHitBoxes,E=c.isHorizontal();var F=E?c.left+(n-q[0])/2:c.left+a.padding;var C=c.top+a.padding;var D=0;var J=v+a.padding;k.each(c.legendItems,function(k,m){var x=z.measureText(k.text).width,u=I+v/2+x,A=F,w=C;E?A+u>=n&&(w=C+=J,D++,A=F=c.left+(n-q[D])/2):w+J>c.bottom&&(A=F=A+c.columnWidths[D]+a.padding,w=C=c.top+a.padding,D++);var K=A,B=w;if(!(isNaN(I)||
0>=I)){z.save();z.fillStyle=t(k.fillStyle,e.defaultColor);z.lineCap=t(k.lineCap,h.borderCapStyle);z.lineDashOffset=t(k.lineDashOffset,h.borderDashOffset);z.lineJoin=t(k.lineJoin,h.borderJoinStyle);z.lineWidth=t(k.lineWidth,h.borderWidth);z.strokeStyle=t(k.strokeStyle,e.defaultColor);var N=0===t(k.lineWidth,h.borderWidth);z.setLineDash&&z.setLineDash(t(k.lineDash,h.borderDash));if(d.labels&&d.labels.usePointStyle){var N=v*Math.SQRT2/2,L=N/Math.SQRT2;f.canvasHelpers.drawPoint(z,k.pointStyle,N,K+L,B+
L)}else N||z.strokeRect(K,B,I,v),z.fillRect(K,B,I,v);z.restore()}G[m].left=A;G[m].top=w;z.fillText(k.text,I+v/2+A,w);k.hidden&&(z.beginPath(),z.lineWidth=2,z.moveTo(I+v/2+A,w+v/2),z.lineTo(I+v/2+A+x,w+v/2),z.stroke());E?F+=u+a.padding:C+=J})}},handleEvent:function(c){var d=this.options,a="mouseup"===c.type?"click":c.type,e=!1;if("mousemove"===a){if(!d.onHover)return}else if("click"===a){if(!d.onClick)return}else return;var h=c.x,f=c.y;if(h>=this.left&&h<=this.right&&f>=this.top&&f<=this.bottom)for(var k=
this.legendHitBoxes,n=0;n<k.length;++n){var t=k[n];if(h>=t.left&&h<=t.left+t.width&&f>=t.top&&f<=t.top+t.height)if("click"===a){d.onClick.call(this,c["native"],this.legendItems[n]);e=!0;break}else if("mousemove"===a){d.onHover.call(this,c["native"],this.legendItems[n]);e=!0;break}}return e}});f.plugins.register({beforeInit:function(c){var d=c.options.legend;d&&n(c,d)},beforeUpdate:function(c){var d=c.options.legend;d?(d=k.configMerge(f.defaults.global.legend,d),c.legend?c.legend.options=d:n(c,d)):
(f.layoutService.removeBox(c,c.legend),delete c.legend)},afterEvent:function(c,d){var a=c.legend;a&&a.handleEvent(d)}})}},{}],31:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.defaults.global.plugins={};f.plugins={_plugins:[],_cacheId:0,register:function(f){var h=this._plugins;[].concat(f).forEach(function(c){-1===h.indexOf(c)&&h.push(c)});this._cacheId++},unregister:function(f){var h=this._plugins;[].concat(f).forEach(function(c){c=h.indexOf(c);-1!==c&&h.splice(c,1)});this._cacheId++},
...
this.options.ticks;this.ticks=this.ticks.map(c.userCallback||c.callback)},afterTickToLabelConversion:function(){h.callCallback(this.options.afterTickToLabelConversion,[this])},beforeCalculateTickRotation:function(){h.callCallback(this.options.beforeCalculateTickRotation,[this])},calculateTickRotation:function(){var c=this.ctx,d=this.options.ticks,a=k(d);c.font=a.font;var e=d.minRotation||0;if(this.options.display&&this.isHorizontal())for(var f=c=h.longestText(c,a.font,this.ticks,this.longestTextCache),
n,a=this.getPixelForTick(1)-this.getPixelForTick(0)-6;f>a&&e<d.maxRotation;){n=h.toRadians(e);f=Math.cos(n);n=Math.sin(n);if(n*c>this.maxHeight){e--;break}e++;f*=c}this.labelRotation=e},afterCalculateTickRotation:function(){h.callCallback(this.options.afterCalculateTickRotation,[this])},beforeFit:function(){h.callCallback(this.options.beforeFit,[this])},fit:function(){var c=this.minSize={width:0,height:0},d=this.options,a=d.ticks,e=d.scaleLabel,f=d.gridLines,x=d.display,q=this.isHorizontal(),z=k(a),
t=1.5*k(e).size,u=d.gridLines.tickMarkLength;c.width=q?this.isFullWidth()?this.maxWidth-this.margins.left-this.margins.right:this.maxWidth:x&&f.drawTicks?u:0;c.height=q?x&&f.drawTicks?u:0:this.maxHeight;e.display&&x&&(q?c.height+=t:c.width+=t);a.display&&x&&(f=h.longestText(this.ctx,z.font,this.ticks,this.longestTextCache),x=h.numberOfLabelLines(this.ticks),e=.5*z.size,q?(this.longestLabelWidth=f,q=h.toRadians(this.labelRotation),a=Math.cos(q),c.height=Math.min(this.maxHeight,c.height+(Math.sin(q)*
f+z.size*x+e*x)),this.ctx.font=z.font,q=n(this.ctx,this.ticks[0],z.font),z=n(this.ctx,this.ticks[this.ticks.length-1],z.font),0!==this.labelRotation?(this.paddingLeft="bottom"===d.position?a*q+3:a*e+3,this.paddingRight="bottom"===d.position?a*e+3:a*z+3):(this.paddingLeft=q/2+3,this.paddingRight=z/2+3)):(f=a.mirror?0:f+this.options.ticks.padding,c.width+=f,this.paddingTop=z.size/2,this.paddingBottom=z.size/2));this.handleMargins();this.width=c.width;this.height=c.height},handleMargins:function(){this.margins&&
...
c:0},draw:function(c){var d=this,a=d.options;if(a.display){var e=d.ctx,m=f.defaults.global,n=a.ticks,q=a.gridLines,z=a.scaleLabel,t=0!==d.labelRotation,u=n.autoSkip,v=d.isHorizontal();if(n.maxTicksLimit)var w=n.maxTicksLimit;var B=h.getValueOrDefault(n.fontColor,m.defaultFontColor),I=k(n),G=q.drawTicks?q.tickMarkLength:0,E=h.getValueOrDefault(q.borderDash,m.borderDash),F=h.getValueOrDefault(q.borderDashOffset,m.borderDashOffset),m=h.getValueOrDefault(z.fontColor,m.defaultFontColor),C=k(z),D=h.toRadians(d.labelRotation),
J=d.longestLabelWidth*Math.cos(D);e.fillStyle=B;var X=[];if(v){var L=!1;t&&(J/=2);(J+n.autoSkipPadding)*d.ticks.length>d.width-(d.paddingLeft+d.paddingRight)&&(L=1+Math.floor((J+n.autoSkipPadding)*d.ticks.length/(d.width-(d.paddingLeft+d.paddingRight))));if(w&&d.ticks.length>w)for(;!L||d.ticks.length/(L||1)>w;)L||(L=1),L+=1;u||(L=!1)}var M="right"===a.position?d.left:d.right-G,T="right"===a.position?d.left+G:d.right,S="bottom"===a.position?d.top:d.bottom-G,Y="bottom"===a.position?d.top+G:d.bottom;
h.each(d.ticks,function(e,f){if(void 0!==e&&null!==e){var k=d.ticks.length===f+1;if((!(1<L&&0<f%L||0===f%L&&f+L>=d.ticks.length)||k)&&void 0!==e&&null!==e){if(f===("undefined"!==typeof d.zeroLineIndex?d.zeroLineIndex:0)){k=q.zeroLineWidth;var m=q.zeroLineColor}else k=h.getValueAtIndexOrDefault(q.lineWidth,f),m=h.getValueAtIndexOrDefault(q.color,f);var x,z,u,A="middle";if(v){if("bottom"===a.position){A=t?"middle":"top";var w=t?"right":"center";var K=d.top+G}else A=t?"middle":"bottom",w=t?"left":"center",
K=d.bottom-G;var B=d.getPixelForTick(f)+h.aliasPixel(k);var N=d.getPixelForTick(f,q.offsetGridLines)+n.labelOffset;B=x=z=u=B;var I=S;var C=Y;var J=c.top;var W=c.bottom}else N="left"===a.position,K=n.padding,n.mirror?w=N?"left":"right":(w=N?"right":"left",K=G+K),N=N?d.right-K:d.left+K,I=d.getPixelForTick(f),I+=h.aliasPixel(k),K=d.getPixelForTick(f,q.offsetGridLines),B=M,x=T,z=c.left,u=c.right,I=C=J=W=I;X.push({tx1:B,ty1:I,tx2:x,ty2:C,x1:z,y1:J,x2:u,y2:W,labelX:N,labelY:K,glWidth:k,glColor:m,glBorderDash:E,
glBorderDashOffset:F,rotation:-1*D,label:e,textBaseline:A,textAlign:w})}}});h.each(X,function(a){q.display&&(e.save(),e.lineWidth=a.glWidth,e.strokeStyle=a.glColor,e.setLineDash&&(e.setLineDash(a.glBorderDash),e.lineDashOffset=a.glBorderDashOffset),e.beginPath(),q.drawTicks&&(e.moveTo(a.tx1,a.ty1),e.lineTo(a.tx2,a.ty2)),q.drawOnChartArea&&(e.moveTo(a.x1,a.y1),e.lineTo(a.x2,a.y2)),e.stroke(),e.restore());if(n.display){e.save();e.translate(a.labelX,a.labelY);e.rotate(a.rotation);e.font=I.font;e.textBaseline=
a.textBaseline;e.textAlign=a.textAlign;a=a.label;if(h.isArray(a))for(var c=0,d=0;c<a.length;++c)e.fillText(""+a[c],0,d),d+=1.5*I.size;else e.fillText(a,0,0);e.restore()}});z.display&&(B=0,v?(u=d.left+(d.right-d.left)/2,w="bottom"===a.position?d.bottom-C.size/2:d.top+C.size/2):(u=(B="left"===a.position)?d.left+C.size/2:d.right-C.size/2,w=d.top+(d.bottom-d.top)/2,B=B?-.5*Math.PI:.5*Math.PI),e.save(),e.translate(u,w),e.rotate(B),e.textAlign="center",e.textBaseline="middle",e.fillStyle=m,e.font=C.font,
e.fillText(z.labelString,0,0),e.restore());q.drawBorder&&(e.lineWidth=h.getValueAtIndexOrDefault(q.lineWidth,0),e.strokeStyle=h.getValueAtIndexOrDefault(q.color,0),z=d.left,m=d.right,C=d.top,u=d.bottom,w=h.aliasPixel(e.lineWidth),v?(C=u="top"===a.position?d.bottom:d.top,C+=w,u+=w):(z=m="left"===a.position?d.right:d.left,z+=w,m+=w),e.beginPath(),e.moveTo(z,C),e.lineTo(m,u),e.stroke())}}})}},{}],33:[function(f,v,w){v.exports=function(f){var n=f.helpers;f.scaleService={constructors:{},defaults:{},registerScaleType:function(f,
h,c){this.constructors[f]=h;this.defaults[f]=n.clone(c)},getScaleConstructor:function(f){return this.constructors.hasOwnProperty(f)?this.constructors[f]:void 0},getScaleDefaults:function(k){return this.defaults.hasOwnProperty(k)?n.scaleMerge(f.defaults.scale,this.defaults[k]):{}},updateScaleDefaults:function(f,h){var c=this.defaults;c.hasOwnProperty(f)&&(c[f]=n.extend(c[f],h))},addScalesToLayout:function(k){n.each(k.scales,function(h){f.layoutService.addBox(k,h)})}}}},{}],34:[function(f,v,w){v.exports=
function(f){var n=f.helpers;f.Ticks={generators:{linear:function(f,h){var c=[];if(f.stepSize&&0<f.stepSize)var d=f.stepSize;else d=n.niceNum(h.max-h.min,!1),d=n.niceNum(d/(f.maxTicks-1),!0);var a=Math.floor(h.min/d)*d,e=Math.ceil(h.max/d)*d;f.min&&f.max&&f.stepSize&&n.almostWhole((f.max-f.min)/f.stepSize,d/1E3)&&(a=f.min,e=f.max);var k=(e-a)/d,k=n.almostEquals(k,Math.round(k),d/1E3)?Math.round(k):Math.ceil(k);c.push(void 0!==f.min?f.min:a);for(var x=1;x<k;++x)c.push(a+x*d);c.push(void 0!==f.max?f.max:
e);return c},logarithmic:function(f,h){var c=[],d=n.getValueOrDefault,a=d(f.min,Math.pow(10,Math.floor(n.log10(h.min)))),e=Math.floor(n.log10(h.max)),k=Math.ceil(h.max/Math.pow(10,e));if(0===a){var x=Math.floor(n.log10(h.minNotZero));var q=Math.floor(h.minNotZero/Math.pow(10,x));c.push(a);a=q*Math.pow(10,x)}else x=Math.floor(n.log10(a)),q=Math.floor(a/Math.pow(10,x));do c.push(a),++q,10===q&&(q=1,++x),a=q*Math.pow(10,x);while(x<e||x===e&&q<k);d=d(f.max,a);c.push(d);return c}},formatters:{values:function(f){return n.isArray(f)?
...
footerSpacing:a.footerSpacing,footerMarginTop:a.footerMarginTop,caretSize:a.caretSize,cornerRadius:a.cornerRadius,backgroundColor:a.backgroundColor,opacity:0,legendColorBackground:a.multiKeyBackground,displayColors:a.displayColors}}function d(a,c){var d=a._chart.ctx,e=2*c.yPadding,h=0,f=c.body,k=f.reduce(function(a,c){return a+c.before.length+c.lines.length+c.after.length},0),k=k+(c.beforeBody.length+c.afterBody.length),q=c.title.length,n=c.footer.length,x=c.titleFontSize,u=c.bodyFontSize,v=c.footerFontSize,
e=e+q*x+(q?(q-1)*c.titleSpacing:0),e=e+(q?c.titleMarginBottom:0),e=e+k*u+(k?(k-1)*c.bodySpacing:0),e=e+(n?c.footerMarginTop:0),e=e+n*v,e=e+(n?(n-1)*c.footerSpacing:0),w=0,D=function(a){h=Math.max(h,d.measureText(a).width+w)};d.font=m.fontString(x,c._titleFontStyle,c._titleFontFamily);m.each(c.title,D);d.font=m.fontString(u,c._bodyFontStyle,c._bodyFontFamily);m.each(c.beforeBody.concat(c.afterBody),D);w=c.displayColors?u+2:0;m.each(f,function(a){m.each(a.before,D);m.each(a.lines,D);m.each(a.after,
D)});w=0;d.font=m.fontString(v,c._footerFontStyle,c._footerFontFamily);m.each(c.footer,D);h+=2*c.xPadding;return{width:h,height:e}}function a(a,c){var d=a._model,e=a._chart,h=a._chartInstance.chartArea,f="center",k="center";d.y<c.height?k="top":d.y>e.height-c.height&&(k="bottom");var m=(h.left+h.right)/2,n=(h.top+h.bottom)/2;if("center"===k){h=function(a){return a<=m};var q=function(a){return a>m}}else h=function(a){return a<=c.width/2},q=function(a){return a>=e.width-c.width/2};var x=function(a){return a+
c.width>e.width};var u=function(a){return 0>a-c.width};var v=function(a){return a<=n?"top":"bottom"};h(d.x)?(f="left",x(d.x)&&(f="center",k=v(d.y))):q(d.x)&&(f="right",u(d.x)&&(f="center",k=v(d.y)));d=a._options;return{xAlign:d.xAlign?d.xAlign:f,yAlign:d.yAlign?d.yAlign:k}}function e(a,c,d){var e=a.x,h=a.y,f=a.caretPadding,k=d.xAlign;d=d.yAlign;var m=a.caretSize+f;a=a.cornerRadius+f;"right"===k?e-=c.width:"center"===k&&(e-=c.width/2);h="top"===d?h+m:"bottom"===d?h-(c.height+m):h-c.height/2;"center"===
...
arguments),e=[],e=k(e,c),e=k(e,d);return e=k(e,a)},update:function(k){var n=this,x=n._options,t=n._model,u=n._model=c(x),v=n._active,w=n._data,B=n._chartInstance,I={xAlign:t.xAlign,yAlign:t.yAlign},G={x:t.x,y:t.y},E={width:t.width,height:t.height},t={x:t.caretX,y:t.caretY};if(v.length){u.opacity=1;for(var F=[],t=f.Tooltip.positioners[x.position](v,n._eventPosition),E=[],I=0,G=v.length;I<G;++I)E.push(h(v[I]));x.filter&&(E=E.filter(function(a){return x.filter(a,w)}));x.itemSort&&(E=E.sort(function(a,
c){return x.itemSort(a,c,w)}));m.each(E,function(a){F.push(x.callbacks.labelColor.call(n,a,B))});u.title=n.getTitle(E,w);u.beforeBody=n.getBeforeBody(E,w);u.body=n.getBody(E,w);u.afterBody=n.getAfterBody(E,w);u.footer=n.getFooter(E,w);u.x=Math.round(t.x);u.y=Math.round(t.y);u.caretPadding=m.getValueOrDefault(t.padding,2);u.labelColors=F;u.dataPoints=E;E=d(this,u);I=a(this,E);G=e(u,E,I)}else u.opacity=0;u.xAlign=I.xAlign;u.yAlign=I.yAlign;u.x=G.x;u.y=G.y;u.width=E.width;u.height=E.height;u.caretX=
t.x;u.caretY=t.y;n._model=u;k&&x.custom&&x.custom.call(n,u);return n},drawCaret:function(a,c,d){var e=this._view,h=this._chart.ctx;var f=e.caretSize;var k=e.cornerRadius;var m=e.xAlign;var q=e.yAlign;var x=a.x;a=a.y;var u=c.width;c=c.height;"center"===q?("left"===m?(k=x,m=k-f):(k=x+u,m=k+f),x=k,a+=c/2,q=a-f,f=a+f):("left"===m?(k=x+k,m=k+f,x=m+f):"right"===m?(k=x+u-k,m=k-f,x=m-f):(m=x+u/2,k=m-f,x=m+f),"top"===q?(q=a,a=q-f):(q=a+c,a=q+f),f=q);h.fillStyle=n(e.backgroundColor,d);h.beginPath();h.moveTo(k,
q);h.lineTo(m,a);h.lineTo(x,f);h.closePath();h.fill()},drawTitle:function(a,c,d,e){var h=c.title;if(h.length){d.textAlign=c._titleAlign;d.textBaseline="top";var f=c.titleFontSize,k=c.titleSpacing;d.fillStyle=n(c.titleFontColor,e);d.font=m.fontString(f,c._titleFontStyle,c._titleFontFamily);var q;e=0;for(q=h.length;e<q;++e)d.fillText(h[e],a.x,a.y),a.y+=f+k,e+1===h.length&&(a.y+=c.titleMarginBottom-k)}},drawBody:function(a,c,d,e){var h=c.bodyFontSize,f=c.bodySpacing,k=c.body;d.textAlign=c._bodyAlign;
d.textBaseline="top";var q=n(c.bodyFontColor,e);d.fillStyle=q;d.font=m.fontString(h,c._bodyFontStyle,c._bodyFontFamily);var t=0,x=function(c){d.fillText(c,a.x+t,a.y);a.y+=h+f};m.each(c.beforeBody,x);var u=c.displayColors,t=u?h+2:0;m.each(k,function(f,k){m.each(f.before,x);m.each(f.lines,function(f){u&&(d.fillStyle=n(c.legendColorBackground,e),d.fillRect(a.x,a.y,h,h),d.strokeStyle=n(c.labelColors[k].borderColor,e),d.strokeRect(a.x,a.y,h,h),d.fillStyle=n(c.labelColors[k].backgroundColor,e),d.fillRect(a.x+
1,a.y+1,h-2,h-2),d.fillStyle=q);x(f)});m.each(f.after,x)});t=0;m.each(c.afterBody,x);a.y-=f},drawFooter:function(a,c,d,e){var h=c.footer;h.length&&(a.y+=c.footerMarginTop,d.textAlign=c._footerAlign,d.textBaseline="top",d.fillStyle=n(c.footerFontColor,e),d.font=m.fontString(c.footerFontSize,c._footerFontStyle,c._footerFontFamily),m.each(h,function(e){d.fillText(e,a.x,a.y);a.y+=c.footerFontSize+c.footerSpacing}))},drawBackground:function(a,c,d,e,h){d.fillStyle=n(c.backgroundColor,h);m.drawRoundedRectangle(d,
...
h),y:Math.round(e/h)}},nearest:function(a,c){var d=c.x,e=c.y,h=Number.POSITIVE_INFINITY,f;var k=0;for(f=a.length;k<f;++k){var n=a[k];if(n&&n.hasValue()){var q=n.getCenterPoint(),q=m.distanceBetweenPoints(c,q);if(q<h){h=q;var x=n}}}x&&(e=x.tooltipPosition(),d=e.x,e=e.y);return{x:d,y:e}}}}},{}],37:[function(f,v,w){v.exports=function(f){var n=f.helpers,k=f.defaults.global;k.elements.arc={backgroundColor:k.defaultColor,borderColor:"#fff",borderWidth:2};f.elements.Arc=f.Element.extend({inLabelRange:function(h){var c=
this._view;return c?Math.pow(h-c.x,2)<Math.pow(c.radius+c.hoverRadius,2):!1},inRange:function(h,c){var d=this._view;if(d){for(var a=n.getAngleFromPoint(d,{x:h,y:c}),e=a.angle,f=a.distance,a=d.startAngle,k=d.endAngle;k<a;)k+=2*Math.PI;for(;e>k;)e-=2*Math.PI;for(;e<a;)e+=2*Math.PI;d=f>=d.innerRadius&&f<=d.outerRadius;return e>=a&&e<=k&&d}return!1},getCenterPoint:function(){var h=this._view,c=(h.startAngle+h.endAngle)/2,d=(h.innerRadius+h.outerRadius)/2;return{x:h.x+Math.cos(c)*d,y:h.y+Math.sin(c)*d}},
getArea:function(){var h=this._view;return(h.endAngle-h.startAngle)/(2*Math.PI)*Math.PI*(Math.pow(h.outerRadius,2)-Math.pow(h.innerRadius,2))},tooltipPosition:function(){var h=this._view,c=h.startAngle+(h.endAngle-h.startAngle)/2,d=(h.outerRadius-h.innerRadius)/2+h.innerRadius;return{x:h.x+Math.cos(c)*d,y:h.y+Math.sin(c)*d}},draw:function(){var h=this._chart.ctx,c=this._view,d=c.startAngle,a=c.endAngle;h.beginPath();h.arc(c.x,c.y,c.outerRadius,d,a);h.arc(c.x,c.y,c.innerRadius,a,d,!0);h.closePath();
h.strokeStyle=c.borderColor;h.lineWidth=c.borderWidth;h.fillStyle=c.backgroundColor;h.fill();h.lineJoin="bevel";c.borderWidth&&h.stroke()}})}},{}],38:[function(f,v,w){v.exports=function(f){var n=f.helpers,k=f.defaults.global;f.defaults.global.elements.line={tension:.4,backgroundColor:k.defaultColor,borderWidth:3,borderColor:k.defaultColor,borderCapStyle:"butt",borderDash:[],borderDashOffset:0,borderJoinStyle:"miter",capBezierPoints:!0,fill:!0};f.elements.Line=f.Element.extend({draw:function(){function h(a,
c){var d=c._view;!0===c._view.steppedLine?(f.lineTo(d.x,a._view.y),f.lineTo(d.x,d.y)):0===c._view.tension?f.lineTo(d.x,d.y):f.bezierCurveTo(a._view.controlPointNextX,a._view.controlPointNextY,d.controlPointPreviousX,d.controlPointPreviousY,d.x,d.y)}var c=this._view,d=c.spanGaps,a=c.scaleZero,e=this._loop;e||("top"===c.fill?a=c.scaleTop:"bottom"===c.fill&&(a=c.scaleBottom));var f=this._chart.ctx;f.save();var x=this._children.slice(),q=-1;e&&x.length&&x.push(x[0]);var u;if(x.length&&c.fill){f.beginPath();
for(u=0;u<x.length;++u){var t=x[u];var v=n.previousItem(x,u);var w=t._view;0===u?(e?f.moveTo(a.x,a.y):f.moveTo(w.x,a),w.skip||(q=u,f.lineTo(w.x,w.y))):(v=-1===q?v:x[q],w.skip?d||q!==u-1||(e?f.lineTo(a.x,a.y):f.lineTo(v._view.x,a)):(q!==u-1?d&&-1!==q?h(v,t):(e||f.lineTo(w.x,a),f.lineTo(w.x,w.y)):h(v,t),q=u))}e||-1===q||f.lineTo(x[q]._view.x,a);f.fillStyle=c.backgroundColor||k.defaultColor;f.closePath();f.fill()}a=k.elements.line;f.lineCap=c.borderCapStyle||a.borderCapStyle;f.setLineDash&&f.setLineDash(c.borderDash||
a.borderDash);f.lineDashOffset=c.borderDashOffset||a.borderDashOffset;f.lineJoin=c.borderJoinStyle||a.borderJoinStyle;f.lineWidth=c.borderWidth||a.borderWidth;f.strokeStyle=c.borderColor||k.defaultColor;f.beginPath();q=-1;for(u=0;u<x.length;++u)t=x[u],v=n.previousItem(x,u),w=t._view,0===u?w.skip||(f.moveTo(w.x,w.y),q=u):(v=-1===q?v:x[q],w.skip||(q!==u-1&&!d||-1===q?f.moveTo(w.x,w.y):h(v,t),q=u));f.stroke();f.restore()}})}},{}],39:[function(f,v,w){v.exports=function(f){function n(c){var a=this._view;
...
Math.pow(a.radius+a.hitRadius,2):!1},getCenterPoint:function(){var c=this._view;return{x:c.x,y:c.y}},getArea:function(){return Math.PI*Math.pow(this._view.radius,2)},tooltipPosition:function(){var c=this._view;return{x:c.x,y:c.y,padding:c.radius+c.borderWidth}},draw:function(d){var a=this._view,e=this._model,m=this._chart.ctx,n=a.pointStyle,q=a.radius,u=a.x,t=a.y,v=f.helpers.color,w=0;a.skip||(m.strokeStyle=a.borderColor||c,m.lineWidth=k.getValueOrDefault(a.borderWidth,h.elements.point.borderWidth),
m.fillStyle=a.backgroundColor||c,void 0!==d&&(e.x<d.left||1.01*d.right<e.x||e.y<d.top||1.01*d.bottom<e.y)&&(e.x<d.left?w=(u-e.x)/(d.left-e.x):1.01*d.right<e.x?w=(e.x-u)/(e.x-d.right):e.y<d.top?w=(t-e.y)/(d.top-e.y):1.01*d.bottom<e.y&&(w=(e.y-t)/(e.y-d.bottom)),w=Math.round(100*w)/100,m.strokeStyle=v(m.strokeStyle).alpha(w).rgbString(),m.fillStyle=v(m.fillStyle).alpha(w).rgbString()),f.canvasHelpers.drawPoint(m,n,q,u,t))}})}},{}],40:[function(f,v,w){v.exports=function(f){function n(f){var c=f._view;
...
c.base;var e=c.x;var k=c.y-c.height/2;var n=c.y+c.height/2;var q=e>a?1:-1;var u=1;var t=c.borderSkipped||"left"}else a=c.x-c.width/2,e=c.x+c.width/2,k=c.y,n=c.base,q=1,u=n>k?1:-1,t=c.borderSkipped||"bottom";if(d){var v=Math.min(Math.abs(a-e),Math.abs(k-n)),d=d>v?v:d,w=d/2,v=a+("left"!==t?w*q:0);q=e+("right"!==t?-w*q:0);var N=k+("top"!==t?w*u:0);u=n+("bottom"!==t?-w*u:0);v!==q&&(k=N,n=u);N!==u&&(a=v,e=q)}f.beginPath();f.fillStyle=c.backgroundColor;f.strokeStyle=c.borderColor;f.lineWidth=d;c=[[a,n],
[a,k],[e,k],[e,n]];t=["bottom","left","top","right"].indexOf(t,0);-1===t&&(t=0);a=c[(t+0)%4];f.moveTo(a[0],a[1]);for(e=1;4>e;e++)a=c[(t+e)%4],f.lineTo(a[0],a[1]);f.fill();d&&f.stroke()},height:function(){var f=this._view;return f.base-f.y},inRange:function(f,c){var d=!1;this._view&&(d=n(this),d=f>=d.left&&f<=d.right&&c>=d.top&&c<=d.bottom);return d},inLabelRange:function(f,c){if(!this._view)return!1;var d=n(this);return void 0!==this._view.width?f>=d.left&&f<=d.right:c>=d.top&&c<=d.bottom},inXRange:function(f){var c=
n(this);return f>=c.left&&f<=c.right},inYRange:function(f){var c=n(this);return f>=c.top&&f<=c.bottom},getCenterPoint:function(){var f=this._view;if(void 0!==this._view.width){var c=f.x;f=(f.y+f.base)/2}else c=(f.x+f.base)/2,f=f.y;return{x:c,y:f}},getArea:function(){var f=this._view;return f.width*Math.abs(f.y-f.base)},tooltipPosition:function(){var f=this._view;return{x:f.x,y:f.y}}})}},{}],41:[function(f,v,w){v.exports=function(f){function n(a,c){var e=d.getStyle(a,c);return(e=e&&e.match(/(\d+)px/))?
...
f+this.minIndex,null,c)},getValueForPixel:function(f){var c=Math.max(this.ticks.length-(this.options.gridLines.offsetGridLines?0:1),1),d=this.isHorizontal(),c=(d?this.width:this.height)/c;f-=d?this.left:this.top;this.options.gridLines.offsetGridLines&&(f-=c/2);return 0>=f?0:Math.round(f/c)},getBasePixel:function(){return this.bottom}});f.scaleService.registerScaleType("category",k,{position:"bottom"})}},{}],44:[function(f,v,w){v.exports=function(f){var n=f.helpers,k={position:"left",ticks:{callback:f.Ticks.formatters.linear}},
h=f.LinearScaleBase.extend({determineDataLimits:function(){function c(a){return h?a.xAxisID===d.id:a.yAxisID===d.id}var d=this,a=d.options,e=d.chart,f=e.data.datasets,h=d.isHorizontal();d.min=null;d.max=null;var k=a.stacked;void 0===k&&n.each(f,function(a,d){if(!k){var f=e.getDatasetMeta(d);e.isDatasetVisible(d)&&c(f)&&void 0!==f.stack&&(k=!0)}});if(a.stacked||k){var u={};n.each(f,function(f,h){var k=e.getDatasetMeta(h),m=[k.type,void 0===a.stacked&&void 0===k.stack?h:"",k.stack].join(".");void 0===
u[m]&&(u[m]={positiveValues:[],negativeValues:[]});var q=u[m].positiveValues,t=u[m].negativeValues;e.isDatasetVisible(h)&&c(k)&&n.each(f.data,function(c,e){var f=+d.getRightValue(c);isNaN(f)||k.data[e].hidden||(q[e]=q[e]||0,t[e]=t[e]||0,a.relativePoints?q[e]=100:0>f?t[e]+=f:q[e]+=f)})});n.each(u,function(a){var c=a.positiveValues.concat(a.negativeValues);a=n.min(c);c=n.max(c);d.min=null===d.min?a:Math.min(d.min,a);d.max=null===d.max?c:Math.max(d.max,c)})}else n.each(f,function(a,f){var h=e.getDatasetMeta(f);
...
this.max=n.max(c);this.min=n.min(c);h.reverse?(c.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max)},convertTicksToLabels:function(){this.ticksAsNumbers=this.ticks.slice();this.zeroLineIndex=this.ticks.indexOf(0);f.Scale.prototype.convertTicksToLabels.call(this)}})}},{}],46:[function(f,v,w){v.exports=function(f){var n=f.helpers,k={position:"left",ticks:{callback:f.Ticks.formatters.logarithmic}},h=f.Scale.extend({determineDataLimits:function(){function c(a){return u?
a.xAxisID===d.id:a.yAxisID===d.id}var d=this,a=d.options,e=a.ticks,f=d.chart,h=f.data.datasets,k=n.getValueOrDefault,u=d.isHorizontal();d.min=null;d.max=null;d.minNotZero=null;var t=a.stacked;void 0===t&&n.each(h,function(a,d){if(!t){var e=f.getDatasetMeta(d);f.isDatasetVisible(d)&&c(e)&&void 0!==e.stack&&(t=!0)}});if(a.stacked||t){var v={};n.each(h,function(e,h){var k=f.getDatasetMeta(h),m=[k.type,void 0===a.stacked&&void 0===k.stack?h:"",k.stack].join(".");f.isDatasetVisible(h)&&c(k)&&(void 0===
v[m]&&(v[m]=[]),n.each(e.data,function(c,e){var f=v[m],h=+d.getRightValue(c);isNaN(h)||k.data[e].hidden||(f[e]=f[e]||0,f[e]=a.relativePoints?100:f[e]+h)}))});n.each(v,function(a){var c=n.min(a);a=n.max(a);d.min=null===d.min?c:Math.min(d.min,c);d.max=null===d.max?a:Math.max(d.max,a)})}else n.each(h,function(a,e){var h=f.getDatasetMeta(e);f.isDatasetVisible(e)&&c(h)&&n.each(a.data,function(a,c){var e=+d.getRightValue(a);isNaN(e)||h.data[c].hidden||(null===d.min?d.min=e:e<d.min&&(d.min=e),null===d.max?
...
c.options.pointLabels;c=a.getValueOrDefault(d.fontSize,e.defaultFontSize);var f=a.getValueOrDefault(d.fontStyle,e.defaultFontStyle),d=a.getValueOrDefault(d.fontFamily,e.defaultFontFamily),h=a.fontString(c,f,d);return{size:c,style:f,family:d,font:h}}function h(a,c,d,e,f){return a===e||a===f?{start:c-d/2,end:c+d/2}:a<e||a>f?{start:c-d-5,end:c}:{start:c,end:c+d+5}}function c(c){var d=c.ctx,f=a.getValueOrDefault,h=c.options,m=h.angleLines,q=h.pointLabels;d.lineWidth=m.lineWidth;d.strokeStyle=m.color;
var h=c.getDistanceFromCenterForValue(h.reverse?c.min:c.max),u=k(c);d.textBaseline="top";for(var v=n(c)-1;0<=v;v--){if(m.display){var x=c.getPointPosition(v,h);d.beginPath();d.moveTo(c.xCenter,c.yCenter);d.lineTo(x.x,x.y);d.stroke();d.closePath()}var x=c.getPointPosition(v,h+5),w=f(q.fontColor,e.defaultFontColor);d.font=u.font;d.fillStyle=w;var w=c.getIndexAngle(v),w=a.toDegrees(w);var F=0===w||180===w?"center":180>w?"left":"right";d.textAlign=F;F=c._pointLabelSizes[v];var C=x;if(90===w||270===w)C.y-=
F.h/2;else if(270<w||90>w)C.y-=F.h;w=d;F=c.pointLabels[v]||"";var D=u.size;if(a.isArray(F))for(var C=x.y,D=1.5*D,J=0;J<F.length;++J)w.fillText(F[J],x.x,C),C+=D;else w.fillText(F,x.x,x.y)}}function d(c){return a.isNumber(c)?c:0}var a=f.helpers,e=f.defaults.global,m={display:!0,animate:!0,lineArc:!1,position:"chartArea",angleLines:{display:!0,color:"rgba(0, 0, 0, 0.1)",lineWidth:1},ticks:{showLabelBackdrop:!0,backdropColor:"rgba(255,255,255,0.75)",backdropPaddingY:2,backdropPaddingX:2,callback:f.Ticks.formatters.linear},
...
b:0},f={},m;this.ctx.font=c.font;this._pointLabelSizes=[];var u=n(this);for(m=0;m<u;m++){var v=this.getPointPosition(m,d);var x=this.ctx,w=c.size;var E=this.pointLabels[m]||"";E=a.isArray(E)?{w:a.longestText(x,x.font,E),h:E.length*w+1.5*(E.length-1)*w}:{w:x.measureText(E).width,h:w};this._pointLabelSizes[m]=E;var x=this.getIndexAngle(m),F=a.toDegrees(x)%360,w=h(F,v.x,E.w,0,180);v=h(F,v.y,E.h,90,270);w.start<e.l&&(e.l=w.start,f.l=x);w.end>e.r&&(e.r=w.end,f.r=x);v.start<e.t&&(e.t=v.start,f.t=x);v.end>
e.b&&(e.b=v.end,f.b=x)}this.setReductions(d,e,f)}},setReductions:function(a,c,e){var f=c.l/Math.sin(e.l),h=Math.max(c.r-this.width,0)/Math.sin(e.r),k=-c.t/Math.cos(e.t);c=-Math.max(c.b-this.height,0)/Math.cos(e.b);f=d(f);h=d(h);k=d(k);c=d(c);this.drawingArea=Math.min(Math.round(a-(f+h)/2),Math.round(a-(k+c)/2));this.setCenterPoint(f,h,k,c)},setCenterPoint:function(a,c,d,e){d+=this.drawingArea;e=this.height-e-this.drawingArea;this.xCenter=Math.round((a+this.drawingArea+(this.width-c-this.drawingArea))/
...
c)+this.yCenter}},getPointPositionForValue:function(a,c){return this.getPointPosition(a,this.getDistanceFromCenterForValue(c))},getBasePosition:function(){var a=this.min,c=this.max;return this.getPointPositionForValue(0,this.beginAtZero?0:0>a&&0>c?c:0<a&&0<c?a:0)},draw:function(){var d=this,f=d.options,h=f.gridLines,k=f.ticks,m=a.getValueOrDefault;if(f.display){var u=d.ctx,x=m(k.fontSize,e.defaultFontSize),v=m(k.fontStyle,e.defaultFontStyle),w=m(k.fontFamily,e.defaultFontFamily),E=a.fontString(x,
v,w);a.each(d.ticks,function(c,q){if(0<q||f.reverse){var t=d.getDistanceFromCenterForValue(d.ticksAsNumbers[q]),v=d.yCenter-t;if(h.display&&0!==q)a:{var w=d.ctx;w.strokeStyle=a.getValueAtIndexOrDefault(h.color,q-1);w.lineWidth=a.getValueAtIndexOrDefault(h.lineWidth,q-1);if(d.options.lineArc)w.beginPath(),w.arc(d.xCenter,d.yCenter,t,0,2*Math.PI);else{var z=n(d);if(0===z)break a;w.beginPath();var A=d.getPointPosition(0,t);w.moveTo(A.x,A.y);for(var B=1;B<z;B++)A=d.getPointPosition(B,t),w.lineTo(A.x,
A.y)}w.closePath();w.stroke()}k.display&&(t=m(k.fontColor,e.defaultFontColor),u.font=E,k.showLabelBackdrop&&(w=u.measureText(c).width,u.fillStyle=k.backdropColor,u.fillRect(d.xCenter-w/2-k.backdropPaddingX,v-x/2-k.backdropPaddingY,w+2*k.backdropPaddingX,x+2*k.backdropPaddingY)),u.textAlign="center",u.textBaseline="middle",u.fillStyle=t,u.fillText(c,d.xCenter,v))}});f.lineArc||c(d)}}});f.scaleService.registerScaleType("radialLinear",u,m)}},{}],48:[function(f,v,w){var u=f(1),u="function"===typeof u?
...
this.options.time.unit||"day",this.displayFormat=this.options.time.displayFormats[this.tickUnit],this.scaleSizeInUnits=this.lastTick.diff(this.firstTick,this.tickUnit,!0),this.unitScale=k.getValueOrDefault(this.options.time.unitStepSize,1);else{var a=this.isHorizontal()?this.width:this.height,e=this.tickFormatFunction(this.firstTick,0,[]),e=this.ctx.measureText(e).width,m=Math.cos(k.toRadians(this.options.ticks.maxRotation)),n=Math.sin(k.toRadians(this.options.ticks.maxRotation)),c=a/(e*m+c*n);this.tickUnit=
...
shareIn:"self"},pocket:{label:"Pocket",logo:"fa fa-get-pocket",shareUrl:"https://getpocket.com/save?url={url}&title={title}",countUrl:""},messenger:{label:"Share",logo:"fa fa-commenting",shareUrl:"fb-messenger://share?link={url}",countUrl:"",shareIn:"self"}})})(window,jQuery,window.jsSocials);Number.prototype.to_money=function(l,f){var v="\\d(?=(\\d{"+(f||3)+"})+"+(0<l?"\\.":"$")+")";return this.toFixed(Math.max(0,~~l)).replace(new RegExp(v,"g"),"$&.")};var H=H||{};H.stringToJSON=function(l){if("object"==typeof l)return l;if("string"!=typeof l)throw"cannot parse non-json-string";return""==l?l:eval("("+l+")")};
...
H.indo_date=function(l){if("undefined"!==typeof l){var f=l.split("-");l=f[0];var v=f[2],f=H.month(f[1]);return v+" "+f+" "+l}};H.FormatBytes=function(l,f){if(0==l)return"0 Byte";var v=Math.floor(Math.log(l)/Math.log(1E3));return(l/Math.pow(1E3,v)).toPrecision(f+1||3)+" "+"Bytes KB MB GB TB PB EB ZB YB".split(" ")[v]};
...
H.MapToAttr=function(l){if(!l)return"";if("string"==typeof l)return l;var f=" ",v;for(v in l){var w=l[v];null!==w&&void 0!==w&&("trigger"==v?l.disabled||(f+=H.triggerCompleteChangeAttr(l.trigger)):f+=v+'="'+w+'" ')}return f};H.triggerCompleteChangeAttr=function(l){return l?""+(' onblur="'+l+'(event,this)" onkeyup="'+l+'(event,this)" onkeydown="'+l+'(event,this)" onchange="'+l+'(event,this)" '):""};H.OpenNewTab=function(l){console.log(l);l?window.open(l,l):H.growl("info",l)};
H.preview=function(l){if(l.files&&l.files[0]){var f=new FileReader;f.onload=function(f){$("#preview").attr("src",f.target.result)};f.readAsDataURL(l.files[0])}};
H.RealtimeDate=function(){var l=new Date,f="Januari Februari Maret April Mei Juni Juli Agustus September Oktober Nopember Desember".split(" ")[l.getMonth()],v=l.getFullYear(),w=l.getDate(),u="Minggu Senin Selasa Rabu Kamis Jum'at Sabtu".split(" ")[l.getDay()],n=l.getHours(),k=l.getMinutes(),l=l.getSeconds(),f="<i class='fa fa-calendar'></i> "+u+" "+w+" "+f+" "+v+" &sdot; <span class='time'><i class='fa fa-clock-o'></i> "+((10>n?"0":"")+n)+":"+((10>k?"0":"")+k)+":"+((10>l?"0":"")+l)+"</span>";$("span.current-date").html(f)};toastr.options={closeButton:!0,debug:!1,newestOnTop:!1,progressBar:!1,positionClass:"toast-top-right",preventDuplicates:!1,showDuration:"0",hideDuration:"0",timeOut:"0",extendedTimeOut:"0",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"};
function subscriber(){var l={subscriber:$("#subscriber").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"public/subscriber/save",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$("#subscriber").val(""),$('meta[name="csrf-token"]').attr("content",f.csrf_token))})}
function login(){$("#submit, #username, #password").attr("disabled","disabled");var l={username:$("#username").val(),password:$("#password").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"login/process",l,function(f){f=H.stringToJSON(f);H.growl(f.type,H.message(f.message));"success"==f.type?setInterval(function(){window.location=_BASE_URL+"dashboard"},2E3):"token_error"==f.type?window.location.reload(!0):($("#username, #password").val(""),f.can_logged_in?$("#submit, #username, #password").removeAttr("disabled"):
($("#submit, #username, #password").attr("disabled","disabled"),$("#login-info").text("The login page has been blocked for 30 minutes"),$("#login-info").addClass("text-danger")))})}
function lost_password(){var l={email:$("#email").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"lost-password/process",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$("#email").val(""),$('meta[name="csrf-token"]').attr("content",f.csrf_token))})}
function reset_password(){var l={password:$("#password").val(),c_password:$("#c_password").val(),forgot_password_key:$("#forgot_password_key").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"reset-password-process",l,function(f){f=H.stringToJSON(f);$('meta[name="csrf-token"]').attr("content",f.csrf_token);switch(f.message){case "token_error":window.location.reload(!0);break;case "expired":H.growl(f.type,"Tautan untuk mengubah kata sandi Anda sudah kadaluarsa!");break;
case "has_updated":H.growl(f.type,"Kata sandi sudah diperbaharui. Silahkan login untuk mengelola data Anda!");break;case "cannot_updated":H.growl(f.type,"Terjadi kesalahan pada sistem kami. Silahkan hubungi Operator!");break;case "not_active":H.growl(f.type,"Akun Anda sudah dinonaktifkan oleh Operator. Untuk informasi lebih lanjut, silahkan hubungi Operator!");break;case "404":window.location=_BASE_URL;break;default:H.growl(f.type,f.message)}})}
function polling(){var l={answer_id:$("input[name=answer_id]:checked").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};answer_id?$.post(_BASE_URL+"public/pollings/save",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$('meta[name="csrf-token"]').attr("content",f.csrf_token))}):toastr.info("Anda belum memilih jawaban.","Info")}
function contact_us(){var l={comment_author:$("#comment_author").val(),comment_email:$("#comment_email").val(),comment_url:$("#comment_url").val(),comment_content:$("#comment_content").val(),captcha:$("#captcha").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"hubungi-kami/save",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),"success"==f.type&&$('input[type="text"], textarea').val(""),$('meta[name="csrf-token"]').attr("content",
f.csrf_token))})}
function post_comment(){var l={comment_author:$("#comment_author").val(),comment_email:$("#comment_email").val(),comment_url:$("#comment_url").val(),comment_content:$("#comment_content").val(),comment_post_id:$("#comment_post_id").val(),captcha:$("#captcha").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"public/post_comments",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),"success"==f.type&&$('input[type="text"], textarea').val(""),
$('meta[name="csrf-token"]').attr("content",f.csrf_token))})}function preview(l){$.post(_BASE_URL+"public/gallery_photos/preview",{id:l},function(f){0<f.count?$.magnificPopup.open({items:f.items,gallery:{enabled:!0},type:"image"}):H.growl("info","Photo tidak ditemukan !")})}$(document).ready(function(){$("#marquee").length&&$("#marquee").marquee()});function check_options(l){var f=$("#"+(1==l?"first":"second")+"_choice");l=1==l?$("#second_choice"):$("#first_choice");l.val()==f.val()&&l.val("")}
function change_country_field(){"WNA"==$("#citizenship").val()?$(".country").show():$(".country").hide()}function change_kps_number_field(){"true"==$("#kps_receiver").val()?$(".kps_number").show():$(".kps_number").hide()}
function save_registration_form(){var l=new FormData;$("input[type=file]").length&&l.append("file",$("input[type=file]")[0].files[0]);$("#first_choice").length&&l.append("first_choice",$("#first_choice").val());$("#second_choice").length&&l.append("second_choice",$("#second_choice").val());$("#is_transfer").length&&l.append("is_transfer",$("#is_transfer").val());$("#nisn").length&&l.append("nisn",$("#nisn").val());$("#nik").length&&l.append("nik",$("#nik").val());$("#prev_exam_number").length&&l.append("prev_exam_number",
$("#prev_exam_number").val());$("#paud").length&&l.append("paud",$("#paud").val());$("#tk").length&&l.append("tk",$("#tk").val());$("#skhun").length&&l.append("skhun",$("#skhun").val());$("#diploma_number").length&&l.append("diploma_number",$("#diploma_number").val());$("#hobby").length&&l.append("hobby",$("#hobby").val());$("#ambition").length&&l.append("ambition",$("#ambition").val());$("#full_name").length&&l.append("full_name",$("#full_name").val());$("#gender").length&&l.append("gender",$("#gender").val());
$("#birth_place").length&&l.append("birth_place",$("#birth_place").val());$("#birth_date").length&&l.append("birth_date",$("#birth_date").val());$("#religion").length&&l.append("religion",$("#religion").val());$("#special_needs").length&&l.append("special_needs",$("#special_needs").val());$("#street_address").length&&l.append("street_address",$("#street_address").val());$("#rt").length&&l.append("rt",$("#rt").val());$("#rw").length&&l.append("rw",$("#rw").val());$("#sub_village").length&&l.append("sub_village",
$("#sub_village").val());$("#village").length&&l.append("village",$("#village").val());$("#sub_district").length&&l.append("sub_district",$("#sub_district").val());$("#district").length&&l.append("district",$("#district").val());$("#postal_code").length&&l.append("postal_code",$("#postal_code").val());$("#residence").length&&l.append("residence",$("#residence").val());$("#transportation").length&&l.append("transportation",$("#transportation").val());$("#phone").length&&l.append("phone",$("#phone").val());
$("#mobile_phone").length&&l.append("mobile_phone",$("#mobile_phone").val());$("#email").length&&l.append("email",$("#email").val());$("#kps_receiver").length&&l.append("kps_receiver",$("#kps_receiver").val());$("#kps_number").length&&l.append("kps_number",$("#kps_number").val());$("#citizenship").length&&l.append("citizenship",$("#citizenship").val());$("#country").length&&l.append("country",$("#country").val());$("#father_name").length&&l.append("father_name",$("#father_name").val());$("#father_birth_year").length&&
l.append("father_birth_year",$("#father_birth_year").val());$("#father_education").length&&l.append("father_education",$("#father_education").val());$("#father_employment").length&&l.append("father_employment",$("#father_employment").val());$("#father_monthly_income").length&&l.append("father_monthly_income",$("#father_monthly_income").val());$("#father_special_needs").length&&l.append("father_special_needs",$("#father_special_needs").val());$("#mother_name").length&&l.append("mother_name",$("#mother_name").val());
$("#mother_birth_year").length&&l.append("mother_birth_year",$("#mother_birth_year").val());$("#mother_education").length&&l.append("mother_education",$("#mother_education").val());$("#mother_employment").length&&l.append("mother_employment",$("#mother_employment").val());$("#mother_monthly_income").length&&l.append("mother_monthly_income",$("#mother_monthly_income").val());$("#mother_special_needs").length&&l.append("mother_special_needs",$("#mother_special_needs").val());$("#guardian_name").length&&
l.append("guardian_name",$("#guardian_name").val());$("#guardian_birth_year").length&&l.append("guardian_birth_year",$("#guardian_birth_year").val());$("#guardian_education").length&&l.append("guardian_education",$("#guardian_education").val());$("#guardian_employment").length&&l.append("guardian_employment",$("#guardian_employment").val());$("#guardian_monthly_income").length&&l.append("guardian_monthly_income",$("#guardian_monthly_income").val());$("#mileage").length&&l.append("mileage",$("#mileage").val());
$("#traveling_time").length&&l.append("traveling_time",$("#traveling_time").val());$("#height").length&&l.append("height",$("#height").val());$("#weight").length&&l.append("weight",$("#weight").val());$("#sibling_number").length&&l.append("sibling_number",$("#sibling_number").val());l.append("captcha",$("#captcha").val());l.append("declaration",$("#declaration").prop("checked"));l.append("csrf_token",$('meta[name="csrf-token"]').attr("content"));$.ajax({url:_BASE_URL+"public/admission_form/save",
type:"POST",data:l,contentType:!1,processData:!1,success:function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$('meta[name="csrf-token"]').attr("content",f.csrf_token),"success"==f.type&&window.open(_BASE_URL+"media_library/students/"+f.file_name,"_self"))}})}
function print_admission_form(){var l={birth_date:$("#birth_date").val(),registration_number:$("#registration_number").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"public/print_admission_form/process",l,function(f){f=H.stringToJSON(f);console.log(l,f);"token_error"==f.type?window.location.reload(!0):"success"==f.type?window.open(_BASE_URL+"media_library/students/"+f.file_name,"_self"):(H.growl(f.type,f.message),$('meta[name="csrf-token"]').attr("content",f.csrf_token))})}
function selection_results(){var l={birth_date:$("#birth_date").val(),registration_number:$("#registration_number").val(),csrf_token:$('meta[name="csrf-token"]').attr("content")};$.post(_BASE_URL+"public/admission_selection_results/selection_results",l,function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$('meta[name="csrf-token"]').attr("content",f.csrf_token))})};